...
#ifdef VBOX_WITH_SHARED_CLIPBOARD_URI_LIST
#define VBOX_SHARED_CLIPBOARD_HOST_MSG_URI_READ_DATA_HDR      4
#define VBOX_SHARED_CLIPBOARD_HOST_MSG_URI_WRITE_DATA_HDR     5
#define VBOX_SHARED_CLIPBOARD_HOST_MSG_URI_READ_DATA_CHUNK    6
#define VBOX_SHARED_CLIPBOARD_HOST_MSG_URI_WRITE_DATA_CHUNK   7
#define VBOX_SHARED_CLIPBOARD_HOST_MSG_URI_READ_DIR           8
#define VBOX_SHARED_CLIPBOARD_HOST_MSG_URI_WRITE_DIR          9
#define VBOX_SHARED_CLIPBOARD_HOST_MSG_URI_READ_FILE_HDR      10
#define VBOX_SHARED_CLIPBOARD_HOST_MSG_URI_WRITE_FILE_HDR     11
#define VBOX_SHARED_CLIPBOARD_HOST_MSG_URI_READ_FILE_DATA     12
#define VBOX_SHARED_CLIPBOARD_HOST_MSG_URI_WRITE_FILE_DATA    13
#define VBOX_SHARED_CLIPBOARD_HOST_MSG_URI_CANCEL             14
