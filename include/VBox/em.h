...
EMDECL(int)      EMEmulateLockOr(RTRCPTR GCPtrParam1, RTGCUINTREG32 Param2, size_t cbSize, RTGCUINTREG32 *pf);
...
EMDECL(int)      EMEmulateLockBtr(RTRCPTR GCPtrParam1, RTGCUINTREG32 Param2, RTGCUINTREG32 *pf);
