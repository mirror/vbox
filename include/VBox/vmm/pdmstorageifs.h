...
/**
 * Region data forms known to us from various standards.
 */
typedef enum PDMMEDIAREGIONDATAFORM
{
    /** Invalid data form. */
    PDMMEDIAREGIONDATAFORM_INVALID = 0,
    /** Raw data, no standardized format. */
    PDMMEDIAREGIONDATAFORM_RAW,
    /** CD-DA (audio CD), 2352 bytes of data. */
    PDMMEDIAREGIONDATAFORM_CDDA,
    /** CDDA data is pause. */
    PDMMEDIAREGIONDATAFORM_CDDA_PAUSE,
    /** Mode 1 with 2048 bytes sector size. */
    PDMMEDIAREGIONDATAFORM_MODE1_2048,
    /** Mode 1 with 2352 bytes sector size. */
    PDMMEDIAREGIONDATAFORM_MODE1_2352,
    /** Mode 1 with 0 bytes sector size (generated by the drive). */
    PDMMEDIAREGIONDATAFORM_MODE1_0,
    /** XA Mode with 2336 bytes sector size. */
    PDMMEDIAREGIONDATAFORM_XA_2336,
    /** XA Mode with 2352 bytes sector size. */
    PDMMEDIAREGIONDATAFORM_XA_2352,
    /** XA Mode with 0 bytes sector size (generated by the drive). */
    PDMMEDIAREGIONDATAFORM_XA_0,
    /** Mode 2 with 2336 bytes sector size. */
    PDMMEDIAREGIONDATAFORM_MODE2_2336,
    /** Mode 2 with 2352 bytes sector size. */
    PDMMEDIAREGIONDATAFORM_MODE2_2352,
    /** Mode 2 with 0 bytes sector size (generated by the drive). */
    PDMMEDIAREGIONDATAFORM_MODE2_0
} PDMMEDIAREGIONDATAFORM;
/** Pointer to a region data form. */
typedef PDMMEDIAREGIONDATAFORM *PPDMMEDIAREGIONDATAFORM;
