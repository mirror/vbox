...
# define RTFsIosMakerSetPathGroupId                     RT_MANGLER(RTFsIosMakerSetPathGroupId)
# define RTFsIosMakerSetPathMode                        RT_MANGLER(RTFsIosMakerSetPathMode)
# define RTFsIosMakerSetPathOwnerId                     RT_MANGLER(RTFsIosMakerSetPathOwnerId)
