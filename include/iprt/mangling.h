...
# define RTFsExt2VolOpen                                RT_MANGLER(RTFsExt2VolOpen)
...
# define RTLdrOpenVfsChainkLdr                          RT_MANGLER(RTLdrOpenVfsChainkLdr)
...
# define RTCrCipherGetKeyVectorLength                   RT_MANGLER(RTCrCipherGetKeyVectorLength)
