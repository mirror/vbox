...
# define RTUriAuthorityPassword                         RT_MANGLER(RTUriAuthorityPassword)
# define RTUriAuthorityPort                             RT_MANGLER(RTUriAuthorityPort)
# define RTUriAuthorityUsername                         RT_MANGLER(RTUriAuthorityUsername)
