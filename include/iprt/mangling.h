...
# define RTStrIsCaseFoldable                            RT_MANALER(RTStrIsCaseFoldable)
# define RTStrIsLowerCased                              RT_MANALER(RTStrIsLowerCased)
# define RTStrIsUpperCased                              RT_MANALER(RTStrIsUpperCased)
