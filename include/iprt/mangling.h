...
# define RTFilesystemOpen                               RT_MANGLER(RTFilesystemOpen)
# define RTFilesystemRetain                             RT_MANGLER(RTFilesystemRetain)
# define RTFilesystemRelease                            RT_MANGLER(RTFilesystemRelease)
# define RTFilesystemGetFormat                          RT_MANGLER(RTFilesystemGetFormat)
# define RTFilesystemGetBlockSize                       RT_MANGLER(RTFilesystemGetBlockSize)
# define RTFilesystemQueryRangeUse                      RT_MANGLER(RTFilesystemQueryRangeUse)
...
# define RTStrPurgeComplementSet                        RT_MANGLER(RTStrPurgeComplimentSet)
