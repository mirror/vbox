...
# define RTJsonIteratorGetValue                         RT_MANGLER(RTJsonIteratorGetValue)
...
# define RTJsonValueGetArraySizeEx                      RT_MANGLER(RTJsonValueGetArraySizeEx)
# define RTJsonValueGetBooleanByName                    RT_MANGLER(RTJsonValueGetBooleanByName)
# define RTJsonValueGetByIndex                          RT_MANGLER(RTJsonValueGetByIndex)
# define RTJsonValueGetByName                           RT_MANGLER(RTJsonValueGetByName)
# define RTJsonValueGetNumber                           RT_MANGLER(RTJsonValueGetNumber)
# define RTJsonValueGetNumberByName                     RT_MANGLER(RTJsonValueGetNumberByName)
# define RTJsonValueGetString                           RT_MANGLER(RTJsonValueGetString)
# define RTJsonValueGetStringByName                     RT_MANGLER(RTJsonValueGetStringByName)
# define RTJsonValueGetStringEx                         RT_MANGLER(RTJsonValueGetStringEx)
