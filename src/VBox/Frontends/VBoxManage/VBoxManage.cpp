                                 ...
                                 ComSafeArrayOut(IUnknown *, outObjects))
{
    ...
    retMetrics.detachTo(outMetrics);
    retObjects.detachTo(outObjects);
        ...
        *********************************************************************/
        ...
        for (size_t i = 0; i < metricInfo.size(); i++)
        {
            ...
            RTPrintf("%-10ls %-20ls %-4ls %10d %10d %10u %10u\n",
                getObjectName(aVirtualBox, object), metricName.raw(), unit.raw(),
    ...
    else if (!strcmp(argv[0], "query"))
    {
        ...
        *********************************************************************/
        ...
        for (unsigned i = 0; i < retNames.size(); i++)
        {
            ...
            RTPrintf("%-10ls %-20ls ", getObjectName(aVirtualBox, retObjects[i]), metricName.raw());
