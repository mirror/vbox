...
enum RuntimeMenuDevicesActionType
{
    ...
    RuntimeMenuDevicesActionType_USBDevicesSettings    = RT_BIT(5),
    RuntimeMenuDevicesActionType_WebCams               = RT_BIT(6),
    RuntimeMenuDevicesActionType_SharedClipboard       = RT_BIT(7),
    RuntimeMenuDevicesActionType_DragAndDrop           = RT_BIT(8),
    RuntimeMenuDevicesActionType_Network               = RT_BIT(9),
    RuntimeMenuDevicesActionType_NetworkSettings       = RT_BIT(10),
