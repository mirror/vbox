 ...
 * VBoxVMSettingsPortForwardingDlg class implementation
 */
...
VBoxVMSettingsPortForwardingDlg::~VBoxVMSettingsPortForwardingDlg()
{
}

const UIPortForwardingDataList& VBoxVMSettingsPortForwardingDlg::rules() const
{
    return m_pModel->rules();
}

/* Add rule slot: */
void VBoxVMSettingsPortForwardingDlg::sltAddRule()
{
...
/* Copy rule slot: */
void VBoxVMSettingsPortForwardingDlg::sltCopyRule()
{
...
/* Del rule slot: */
void VBoxVMSettingsPortForwardingDlg::sltDelRule()
{
...
void VBoxVMSettingsPortForwardingDlg::sltShowTableContexMenu(const QPoint &pos)
{
...
void VBoxVMSettingsPortForwardingDlg::sltAdjustTable()
{
...
void VBoxVMSettingsPortForwardingDlg::retranslateUi()
{
    /* Set window title: */
...
bool VBoxVMSettingsPortForwardingDlg::eventFilter(QObject *pObj, QEvent *pEvent)
{
    /* Process table: */
...
#include "VBoxVMSettingsPortForwardingDlg.moc"
