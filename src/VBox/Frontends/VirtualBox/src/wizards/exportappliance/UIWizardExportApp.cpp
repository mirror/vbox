...
CVirtualSystemDescriptionForm UIWizardExportApp::vsdLaunchForm()
{
    return m_comVsdLaunchForm;
}

void UIWizardExportApp::setVsdLaunchForm(const CVirtualSystemDescriptionForm &comForm)
{
    m_comVsdLaunchForm = comForm;
}
