...
static const osTypePattern gs_OSTypePattern[] =
{
    ...
    { QRegExp("edgy.*64", Qt::CaseInsensitive), "Ubuntu_64" },
    { QRegExp("edgy", Qt::CaseInsensitive), "Ubuntu" },
    { QRegExp("feisty.*64", Qt::CaseInsensitive), "Ubuntu_64" },
    { QRegExp("feisty", Qt::CaseInsensitive), "Ubuntu" },
    { QRegExp("gutsy.*64", Qt::CaseInsensitive), "Ubuntu_64" },
    { QRegExp("gutsy", Qt::CaseInsensitive), "Ubuntu" },
    { QRegExp("hardy.*64", Qt::CaseInsensitive), "Ubuntu_64" },
    { QRegExp("hardy", Qt::CaseInsensitive), "Ubuntu" },
    { QRegExp("intrepid.*64", Qt::CaseInsensitive), "Ubuntu_64" },
    { QRegExp("intrepid", Qt::CaseInsensitive), "Ubuntu" },
    { QRegExp("jaunty.*64", Qt::CaseInsensitive), "Ubuntu_64" },
    { QRegExp("jaunty", Qt::CaseInsensitive), "Ubuntu" },
    { QRegExp("karmic.*64", Qt::CaseInsensitive), "Ubuntu_64" },
    { QRegExp("karmic", Qt::CaseInsensitive), "Ubuntu" },
    { QRegExp("lucid.*64", Qt::CaseInsensitive), "Ubuntu_64" },
    { QRegExp("lucid", Qt::CaseInsensitive), "Ubuntu" },
    { QRegExp("sarge.*64", Qt::CaseInsensitive), "Debian_64" },
    { QRegExp("sarge", Qt::CaseInsensitive), "Debian" },
    { QRegExp("etch.*64", Qt::CaseInsensitive), "Debian_64" },
    { QRegExp("etch", Qt::CaseInsensitive), "Debian" },
    { QRegExp("lenny.*64", Qt::CaseInsensitive), "Debian_64" },
    { QRegExp("lenny", Qt::CaseInsensitive), "Debian" },
    { QRegExp("sid.*64", Qt::CaseInsensitive), "Debian_64" },
    { QRegExp("sid", Qt::CaseInsensitive), "Debian" },
    { QRegExp("squeeze.*64", Qt::CaseInsensitive), "Debian_64" },
    { QRegExp("squeeze", Qt::CaseInsensitive), "Debian" },
    { QRegExp("moonshine.*64", Qt::CaseInsensitive), "Fedora_64" },
    { QRegExp("moonshine", Qt::CaseInsensitive), "Fedora" },
    { QRegExp("werewolf.*64", Qt::CaseInsensitive), "Fedora_64" },
    { QRegExp("werewolf", Qt::CaseInsensitive), "Fedora" },
    { QRegExp("sulphur.*64", Qt::CaseInsensitive), "Fedora_64" },
    { QRegExp("sulphur", Qt::CaseInsensitive), "Fedora" },
    { QRegExp("cambridge.*64", Qt::CaseInsensitive), "Fedora_64" },
    ...
    { QRegExp("((Li.*2.?6)|(LFS)).*64", Qt::CaseInsensitive), "Linux26_64" },
    { QRegExp("(Li.*2.?6)|(LFS)", Qt::CaseInsensitive), "Linux26" },
