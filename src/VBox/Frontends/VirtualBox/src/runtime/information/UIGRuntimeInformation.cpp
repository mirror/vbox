...
void UIGRuntimeInformation::setItems(const QList<UIVMItem*> &items)
{
    /* Propagate to details-model: */
    m_pDetailsModel->setItems(items);
}

void UIGRuntimeInformation::preparePalette()
{
    /* Setup palette: */
...
void UIGRuntimeInformation::prepareLayout()
{
    /* Setup main-layout: */
...
void UIGRuntimeInformation::prepareModel()
{
    /* Setup details-model: */
...
void UIGRuntimeInformation::prepareConnections()
{
