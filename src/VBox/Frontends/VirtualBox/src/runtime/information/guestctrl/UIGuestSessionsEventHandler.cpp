...
/** @todo r=bird: scm found some malformed flowerbox comments here for this and
 * the subsequent classes.  I think doxygen class documentation would be more
 * appropariate and helpful here.   I've fixed the flowerboxes further down
 * where the class implemention is, since that's correct use of them.
 */
...
/*********************************************************************************************************************************
*   HeaderUIGuestProcess implementation                                                                                          *
*********************************************************************************************************************************/
