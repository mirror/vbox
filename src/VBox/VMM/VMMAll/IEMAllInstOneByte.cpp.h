...
#define IEMOP_BODY_BINARY_rm_r8_LOCKED(a_fnLockedU8) \
            ...
            \
            IEM_MC_MEM_COMMIT_AND_UNMAP_RW(bMapInfoDst); \
            IEM_MC_COMMIT_EFLAGS(EFlags); \
            IEM_MC_ADVANCE_RIP_AND_FINISH(); \
            IEM_MC_END(); \
        } \
...
#define IEMOP_BODY_BINARY_rm_rv_LOCKED(a_fnLockedU16, a_fnLockedU32, a_fnLockedU64) \
            ...
            { \
                ...
                case IEMMODE_32BIT: \
                    ...
                    \
                    IEM_MC_MEM_COMMIT_AND_UNMAP_RW(bUnmapInfo /* CMP,TEST */); \
                    IEM_MC_COMMIT_EFLAGS(EFlags); \
                    IEM_MC_ADVANCE_RIP_AND_FINISH(); \
                    IEM_MC_END(); \
                    break; \
...
FNIEMOP_DEF(iemOp_add_Gv_Ev)
{
    ...
    IEMOP_BODY_BINARY_rv_rm(iemAImpl_add_u16, iemAImpl_add_u32, iemAImpl_add_u64, 1, 0);
}
...
FNIEMOP_DEF(iemOp_or_Gv_Ev)
{
    ...
    IEMOP_VERIFICATION_UNDEFINED_EFLAGS(X86_EFL_AF);
    IEMOP_BODY_BINARY_rv_rm(iemAImpl_or_u16, iemAImpl_or_u32, iemAImpl_or_u64, 1, 0);
}
...
FNIEMOP_DEF(iemOp_adc_Gv_Ev)
{
    ...
    IEMOP_BODY_BINARY_rv_rm(iemAImpl_adc_u16, iemAImpl_adc_u32, iemAImpl_adc_u64, 1, 0);
}
...
FNIEMOP_DEF(iemOp_sbb_Gv_Ev)
{
    ...
    IEMOP_BODY_BINARY_rv_rm(iemAImpl_sbb_u16, iemAImpl_sbb_u32, iemAImpl_sbb_u64, 1, 0);
}
...
FNIEMOP_DEF(iemOp_and_Gv_Ev)
{
    ...
    IEMOP_VERIFICATION_UNDEFINED_EFLAGS(X86_EFL_AF);
    IEMOP_BODY_BINARY_rv_rm(iemAImpl_and_u16, iemAImpl_and_u32, iemAImpl_and_u64, 1, 0);
}
...
FNIEMOP_DEF(iemOp_sub_Gv_Ev)
{
    ...
    IEMOP_BODY_BINARY_rv_rm(iemAImpl_sub_u16, iemAImpl_sub_u32, iemAImpl_sub_u64, 1, 0);
}
...
FNIEMOP_DEF(iemOp_xor_Gv_Ev)
{
    ...
    IEMOP_VERIFICATION_UNDEFINED_EFLAGS(X86_EFL_AF);
    IEMOP_BODY_BINARY_rv_rm(iemAImpl_xor_u16, iemAImpl_xor_u32, iemAImpl_xor_u64, 1, 0);
}
...
FNIEMOP_DEF(iemOp_cmp_Gv_Ev)
{
    ...
    IEMOP_BODY_BINARY_rv_rm(iemAImpl_cmp_u16, iemAImpl_cmp_u32, iemAImpl_cmp_u64, 0, 0);
}
        ...
        { \
            ...
            { \
                case IEMMODE_16BIT: \
                    ...
                    IEM_MC_MEM_MAP_U16_RW(pu16Dst, bUnmapInfo, pVCpu->iem.s.iEffSeg, GCPtrEffDst); \
                    \
                    IEM_MC_ARG_CONST(uint16_t,  u16Src,  (int16_t)(int8_t)u8Imm,    1); \
                    IEM_MC_ARG_LOCAL_EFLAGS(    pEFlags, EFlags,                    2); \
                    IEM_MC_FETCH_EFLAGS(EFlags); \
                    IEM_MC_CALL_VOID_AIMPL_3(a_fnNormalU16, pu16Dst, u16Src, pEFlags); \
                    \
                ...
                case IEMMODE_32BIT: \
                    ...
                    IEM_MC_MEM_MAP_U32_RW(pu32Dst, bUnmapInfo, pVCpu->iem.s.iEffSeg, GCPtrEffDst); \
                    \
                    IEM_MC_ARG_CONST(uint32_t,  u32Src,  (int32_t)(int8_t)u8Imm,    1); \
                    IEM_MC_ARG_LOCAL_EFLAGS(    pEFlags, EFlags,                    2); \
                    IEM_MC_FETCH_EFLAGS(EFlags); \
                    IEM_MC_CALL_VOID_AIMPL_3(a_fnNormalU32, pu32Dst, u32Src, pEFlags); \
                    \
...
FNIEMOP_DEF(iemOp_xchg_Eb_Gb)
{
    ...
    else
    {
         ...
         * We're accessing memory.
         */
#define IEMOP_XCHG_BYTE(a_fnWorker) \
        ...
        {
            IEMOP_XCHG_BYTE(iemAImpl_xchg_u8_locked);
        }
        else
        {
            IEMOP_XCHG_BYTE(iemAImpl_xchg_u8_unlocked);
        }
    }
}
...
FNIEMOP_DEF(iemOp_xchg_Ev_Gv)
{
    ...
    else
    {
         ...
         * We're accessing memory.
         */
#define IEMOP_XCHG_EV_GV(a_fnWorker16, a_fnWorker32, a_fnWorker64) \
            do { \
                switch (pVCpu->iem.s.enmEffOpSize) \
                { \
                    case IEMMODE_16BIT: \
        ...
        if (!(pVCpu->iem.s.fExec & IEM_F_X86_DISREGARD_LOCK))
        {
            IEMOP_XCHG_EV_GV(iemAImpl_xchg_u16_locked, iemAImpl_xchg_u32_locked, iemAImpl_xchg_u64_locked);
        }
        else
        {
            IEMOP_XCHG_EV_GV(iemAImpl_xchg_u16_unlocked, iemAImpl_xchg_u32_unlocked, iemAImpl_xchg_u64_unlocked);
        }
    }
}
...
FNIEMOP_DEF_1(iemOp_fldenv, uint8_t, bRm)
{
    ...
    IEM_MC_CALL_CIMPL_3(IEM_CIMPL_F_FPU, 0, iemCImpl_fldenv, enmEffOpSize, iEffSeg, GCPtrEffSrc);
    IEM_MC_END();
}
...
FNIEMOP_DEF_1(iemOp_fldcw, uint8_t, bRm)
{
    ...
    IEM_MC_CALL_CIMPL_1(IEM_CIMPL_F_FPU, 0, iemCImpl_fldcw, u16Fsw);
    IEM_MC_END();
}
...
FNIEMOP_DEF(iemOp_fninit)
{
    ...
    IEMOP_HLP_DONE_DECODING_NO_LOCK_PREFIX();
    IEM_MC_DEFER_TO_CIMPL_1_RET(IEM_CIMPL_F_FPU, 0, iemCImpl_finit, false /*fCheckXcpts*/);
}
...
FNIEMOP_DEF_1(iemOp_frstor,      uint8_t, bRm)
{
    ...
    IEM_MC_ARG_CONST(IEMMODE,           enmEffOpSize, /*=*/ pVCpu->iem.s.enmEffOpSize,  0);
    IEM_MC_ARG_CONST(uint8_t,           iEffSeg,      /*=*/ pVCpu->iem.s.iEffSeg,       1);
    IEM_MC_CALL_CIMPL_3(IEM_CIMPL_F_FPU, 0, iemCImpl_frstor, enmEffOpSize, iEffSeg, GCPtrEffSrc);
    IEM_MC_END();
}
...
FNIEMOP_DEF_1(iemOp_fnsave,      uint8_t, bRm)
{
    ...
    IEM_MC_ARG_CONST(IEMMODE,           enmEffOpSize, /*=*/ pVCpu->iem.s.enmEffOpSize,  0);
    IEM_MC_ARG_CONST(uint8_t,           iEffSeg,      /*=*/ pVCpu->iem.s.iEffSeg,       1);
    IEM_MC_CALL_CIMPL_3(IEM_CIMPL_F_FPU, 0, iemCImpl_fnsave, enmEffOpSize, iEffSeg, GCPtrEffDst);
    IEM_MC_END();
}
