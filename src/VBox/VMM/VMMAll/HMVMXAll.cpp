...
static const char * const g_apszVmxInstrDiagDesc[kVmxVInstrDiag_Last] =
{
    ...
    /* VMLAUNCH. */
    VMX_INSTR_DIAG_DESC(kVmxVInstrDiag_Vmlaunch_Cpl          , "Cpl"            ),
    VMX_INSTR_DIAG_DESC(kVmxVInstrDiag_Vmlaunch_LongModeCS   , "LongModeCS"     ),
    VMX_INSTR_DIAG_DESC(kVmxVInstrDiag_Vmlaunch_RealOrV86Mode, "RealOrV86Mode"  ),
    VMX_INSTR_DIAG_DESC(kVmxVInstrDiag_Vmlaunch_VmxRoot      , "VmxRoot"        )
    /* kVmxVInstrDiag_Last */
};
