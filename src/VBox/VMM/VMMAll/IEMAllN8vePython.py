...
g_dMcStmtThreaded = {
    ...
    'IEM_MC_SET_RIP_U16_AND_FINISH_THREADED_PC16':               (None, True,  False, ),
    'IEM_MC_SET_RIP_U16_AND_FINISH_THREADED_PC32':               (None, True,  False, ),
    'IEM_MC_SET_RIP_U16_AND_FINISH_THREADED_PC64':               (None, True,  False, ),
    'IEM_MC_SET_RIP_U32_AND_FINISH_THREADED_PC16':               (None, True,  False, ),
    'IEM_MC_SET_RIP_U32_AND_FINISH_THREADED_PC32':               (None, True,  False, ),
    'IEM_MC_SET_RIP_U32_AND_FINISH_THREADED_PC64':               (None, True,  False, ),
    'IEM_MC_SET_RIP_U64_AND_FINISH_THREADED_PC32':               (None, True,  False, ),
    'IEM_MC_SET_RIP_U64_AND_FINISH_THREADED_PC64':               (None, True,  False, ),

    'IEM_MC_SET_RIP_U16_AND_FINISH_THREADED_PC16_WITH_FLAGS':    (None, True,  False, ),
    'IEM_MC_SET_RIP_U16_AND_FINISH_THREADED_PC32_WITH_FLAGS':    (None, True,  False, ),
    'IEM_MC_SET_RIP_U16_AND_FINISH_THREADED_PC64_WITH_FLAGS':    (None, True,  False, ),
    'IEM_MC_SET_RIP_U32_AND_FINISH_THREADED_PC16_WITH_FLAGS':    (None, True,  False, ),
    'IEM_MC_SET_RIP_U32_AND_FINISH_THREADED_PC32_WITH_FLAGS':    (None, True,  False, ),
    'IEM_MC_SET_RIP_U32_AND_FINISH_THREADED_PC64_WITH_FLAGS':    (None, True,  False, ),
    'IEM_MC_SET_RIP_U64_AND_FINISH_THREADED_PC32_WITH_FLAGS':    (None, True,  False, ),
    'IEM_MC_SET_RIP_U64_AND_FINISH_THREADED_PC64_WITH_FLAGS':    (None, True,  False, ),

    'IEM_MC_CALC_RM_EFF_ADDR_THREADED_16':                       (None, False, True,  ),
    'IEM_MC_CALC_RM_EFF_ADDR_THREADED_32':                       (None, False, True,  ),
    'IEM_MC_CALC_RM_EFF_ADDR_THREADED_64_ADDR32':                (None, False, True,  ),
    'IEM_MC_CALC_RM_EFF_ADDR_THREADED_64_FSGS':                  (None, False, True,  ),
    'IEM_MC_CALC_RM_EFF_ADDR_THREADED_64':                       (None, False, True,  ),
    ...
    'IEM_MC_FETCH_MEM_FLAT_U16_DISP':                            (None, True,  True,  ),
    'IEM_MC_FETCH_MEM_FLAT_U16_SX_U32':                          (None, True,  True,  ),
    'IEM_MC_FETCH_MEM_FLAT_U16_SX_U64':                          (None, True,  True,  ),
    'IEM_MC_FETCH_MEM_FLAT_U16':                                 (None, True,  True,  ),
    'IEM_MC_FETCH_MEM_FLAT_U16_ZX_U32':                          (None, True,  True,  ),
    'IEM_MC_FETCH_MEM_FLAT_U16_ZX_U64':                          (None, True,  True,  ),
    ...
    'IEM_MC_FETCH_MEM_FLAT_U32_DISP':                            (None, True,  True,  ),
    'IEM_MC_FETCH_MEM_FLAT_U32_SX_U64':                          (None, True,  True,  ),
    'IEM_MC_FETCH_MEM_FLAT_U32_ZX_U64':                          (None, True,  True,  ),
    'IEM_MC_FETCH_MEM_FLAT_U64':                                 (None, True,  True,  ),
    'IEM_MC_FETCH_MEM_FLAT_U8_SX_U16':                           (None, True,  True,  ),
    'IEM_MC_FETCH_MEM_FLAT_U8_SX_U32':                           (None, True,  True,  ),
    'IEM_MC_FETCH_MEM_FLAT_U8_SX_U64':                           (None, True,  True,  ),
    'IEM_MC_FETCH_MEM_FLAT_U8':                                  (None, True,  True,  ),
    'IEM_MC_FETCH_MEM_FLAT_U8_ZX_U16':                           (None, True,  True,  ),
    'IEM_MC_FETCH_MEM_FLAT_U8_ZX_U32':                           (None, True,  True,  ),
    'IEM_MC_FETCH_MEM_FLAT_U8_ZX_U64':                           (None, True,  True,  ),
    ...
    'IEM_MC_MEM_FLAT_MAP_D80_WO':                                (None, True,  True,  ),
    'IEM_MC_MEM_FLAT_MAP_I16_WO':                                (None, True,  True,  ),
    'IEM_MC_MEM_FLAT_MAP_I32_WO':                                (None, True,  True,  ),
    'IEM_MC_MEM_FLAT_MAP_I64_WO':                                (None, True,  True,  ),
    'IEM_MC_MEM_FLAT_MAP_R32_WO':                                (None, True,  True,  ),
    'IEM_MC_MEM_FLAT_MAP_R64_WO':                                (None, True,  True,  ),
    'IEM_MC_MEM_FLAT_MAP_R80_WO':                                (None, True,  True,  ),
    'IEM_MC_MEM_FLAT_MAP_U8_RO':                                 (None, True,  True,  ),
    'IEM_MC_MEM_FLAT_MAP_U8_RW':                                 (None, True,  True,  ),
    'IEM_MC_MEM_FLAT_MAP_U16_RO':                                (None, True,  True,  ),
    'IEM_MC_MEM_FLAT_MAP_U16_RW':                                (None, True,  True,  ),
    'IEM_MC_MEM_FLAT_MAP_U32_RO':                                (None, True,  True,  ),
    'IEM_MC_MEM_FLAT_MAP_U32_RW':                                (None, True,  True,  ),
    'IEM_MC_MEM_FLAT_MAP_U64_RO':                                (None, True,  True,  ),
    'IEM_MC_MEM_FLAT_MAP_U64_RW':                                (None, True,  True,  ),
    'IEM_MC_MEM_FLAT_MAP_U128_RW':                               (None, True,  True,  ),
    ...
    'IEM_MC_STORE_MEM_FLAT_U16_CONST':                           (None, True,  True,  ),
    'IEM_MC_STORE_MEM_FLAT_U256_ALIGN_AVX':                      (None, True,  False, ),
    'IEM_MC_STORE_MEM_FLAT_U256':                                (None, True,  False, ),
    'IEM_MC_STORE_MEM_FLAT_U32':                                 (None, True,  True,  ),
    'IEM_MC_STORE_MEM_FLAT_U32_CONST':                           (None, True,  True,  ),
    'IEM_MC_STORE_MEM_FLAT_U64':                                 (None, True,  True,  ),
    'IEM_MC_STORE_MEM_FLAT_U64_CONST':                           (None, True,  True,  ),
    'IEM_MC_STORE_MEM_FLAT_U8':                                  (None, True,  True,  ),
