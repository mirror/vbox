...
_pktacc:                                     ; 0xf006a LB 0xc
    db  000h, 000h, 000h, 000h, 000h, 000h, 05dh, 02ch, 016h, 082h, 03dh, 091h
...
_dskacc:                                     ; 0xf0082 LB 0x2e
    ...
    db  060h, 080h, 03bh, 081h, 013h, 090h, 0b9h, 090h, 000h, 000h, 000h, 000h, 000h, 000h, 05fh, 033h
...
section _TEXT progbits vstart=0x1600 align=1 ; size=0x8b25 class=CODE group=AUTO
...
_int13_cdemu:                                ; 0xf42d6 LB 0x434
    ...
    xor dl, dl                                ; 30 d2
    xor cx, cx                                ; 31 c9
    call 09ff0h                               ; e8 76 5b
    xor bx, bx                                ; 31 db
    add ax, si                                ; 01 f0
    adc dx, bx                                ; 11 da
    mov bx, di                                ; 89 fb
    xor cx, cx                                ; 31 c9
    call 09ff0h                               ; e8 69 5b
    mov bx, ax                                ; 89 c3
    mov ax, word [bp-010h]                    ; 8b 46 f0
    dec ax                                    ; 48
    xor cx, cx                                ; 31 c9
...
dequeue_key_:                                ; 0xf5751 LB 0x94
    ...
    add byte [bp+di-066a6h], al               ; 00 83 5a 99
    pop ax                                    ; 58
    loopne 0582bh                             ; e0 58
    sub AL, strict byte 059h                  ; 2c 59
    cmp AL, strict byte 059h                  ; 3c 59
    pop ecx                                   ; 66 59
    outsw                                     ; 6f
    pop cx                                    ; 59
    loopne 05836h                             ; e0 59
    adc word [bp+si+03eh], bx                 ; 11 5a 3e
    pop dx                                    ; 5a
    js short 0583dh                           ; 78 5a
    db  0c6h
    pop dx                                    ; 5a
_int16_function:                             ; 0xf57e5 LB 0x2e7
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push di                                   ; 57
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 05865h                          ; 75 08
    mov AL, strict byte 021h                  ; b0 21
    mov dx, 00080h                            ; ba 80 00
    out DX, AL                                ; ee
    jmp short 05853h                          ; eb ee
    mov dx, strict word 00060h                ; ba 60 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    mov dx, 00097h                            ; ba 97 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01757h                               ; e8 e1 be
    sti                                       ; fb
    mov ax, word [bp+012h]                    ; 8b 46 12
    shr ax, 008h                              ; c1 e8 08
    cmp ax, 000a2h                            ; 3d a2 00
    jnbe near 05a83h                          ; 0f 87 ff 01
    push CS                                   ; 0e
    pop ES                                    ; 07
    mov cx, strict word 0000ch                ; b9 0c 00
    ...
    call 05751h                               ; e8 a9 fe
    test ax, ax                               ; 85 c0
    jne short 058b7h                          ; 75 0b
    push 00621h                               ; 68 21 06
    push strict byte 00007h                   ; 6a 07
    call 01a6bh                               ; e8 b7 c1
    add sp, strict byte 00004h                ; 83 c4 04
    cmp byte [bp-006h], 000h                  ; 80 7e fa 00
    je short 058c3h                           ; 74 06
    cmp byte [bp-008h], 0f0h                  ; 80 7e f8 f0
    je short 058c9h                           ; 74 06
    cmp byte [bp-008h], 0e0h                  ; 80 7e f8 e0
    jne short 058cdh                          ; 75 04
    mov byte [bp-008h], 000h                  ; c6 46 f8 00
    movzx dx, byte [bp-006h]                  ; 0f b6 56 fa
    sal dx, 008h                              ; c1 e2 08
    movzx ax, byte [bp-008h]                  ; 0f b6 46 f8
    ...
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 05751h                               ; e8 5d fe
    test ax, ax                               ; 85 c0
    jne short 058ffh                          ; 75 07
    or word [bp+01ch], strict byte 00040h     ; 83 4e 1c 40
    jmp near 05ac6h                           ; e9 c7 01
    cmp byte [bp-006h], 000h                  ; 80 7e fa 00
    je short 0590bh                           ; 74 06
    cmp byte [bp-008h], 0f0h                  ; 80 7e f8 f0
    je short 05911h                           ; 74 06
    cmp byte [bp-008h], 0e0h                  ; 80 7e f8 e0
    jne short 05915h                          ; 75 04
    mov byte [bp-008h], 000h                  ; c6 46 f8 00
    movzx dx, byte [bp-006h]                  ; 0f b6 56 fa
    sal dx, 008h                              ; c1 e2 08
    movzx ax, byte [bp-008h]                  ; 0f b6 46 f8
    ...
    jmp near 05ac6h                           ; e9 9a 01
    mov dx, strict word 00017h                ; ba 17 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01749h                               ; e8 14 be
    mov dx, word [bp+012h]                    ; 8b 56 12
    mov dl, al                                ; 88 c2
    jmp short 058dah                          ; eb 9e
    mov al, byte [bp+010h]                    ; 8a 46 10
    movzx dx, al                              ; 0f b6 d0
    mov ax, word [bp+010h]                    ; 8b 46 10
    shr ax, 008h                              ; c1 e8 08
    xor ah, ah                                ; 30 e4
    call 05244h                               ; e8 f7 f8
    test ax, ax                               ; 85 c0
    jne short 0595eh                          ; 75 0d
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor al, al                                ; 30 c0
    or AL, strict byte 001h                   ; 0c 01
    mov word [bp+012h], ax                    ; 89 46 12
    jmp near 05ac6h                           ; e9 68 01
    and word [bp+012h], 0ff00h                ; 81 66 12 00 ff
    jmp near 05ac6h                           ; e9 60 01
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor al, al                                ; 30 c0
    or AL, strict byte 030h                   ; 0c 30
    jmp short 05958h                          ; eb e9
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 05996h                          ; 75 0d
    dec bx                                    ; 4b
    test bx, bx                               ; 85 db
    jbe short 05996h                          ; 76 08
    mov dx, 00080h                            ; ba 80 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    jmp short 0597fh                          ; eb e9
    test bx, bx                               ; 85 db
    jbe short 059dah                          ; 76 40
    mov dx, strict word 00060h                ; ba 60 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    cmp ax, 000fah                            ; 3d fa 00
    jne short 059dah                          ; 75 35
    mov bx, strict word 0ffffh                ; bb ff ff
    mov dx, strict word 00064h                ; ba 64 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 059bfh                          ; 75 0d
    dec bx                                    ; 4b
    test bx, bx                               ; 85 db
    jbe short 059bfh                          ; 76 08
    mov dx, 00080h                            ; ba 80 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    jmp short 059a8h                          ; eb e9
    test bx, bx                               ; 85 db
    jbe short 059d1h                          ; 76 0e
    shr cx, 008h                              ; c1 e9 08
    mov dx, strict word 00060h                ; ba 60 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ...
    jnbe short 059a5h                         ; 77 cb
    mov word [bp+00ch], cx                    ; 89 4e 0c
    jmp near 05ac6h                           ; e9 e6 00
    push strict byte 00001h                   ; 6a 01
    mov cx, ss                                ; 8c d1
    lea bx, [bp-008h]                         ; 8d 5e f8
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 05751h                               ; e8 62 fd
    test ax, ax                               ; 85 c0
    jne short 059feh                          ; 75 0b
    push 00621h                               ; 68 21 06
    push strict byte 00007h                   ; 6a 07
    call 01a6bh                               ; e8 70 c0
    add sp, strict byte 00004h                ; 83 c4 04
    cmp byte [bp-006h], 000h                  ; 80 7e fa 00
    je near 058cdh                            ; 0f 84 c7 fe
    cmp byte [bp-008h], 0f0h                  ; 80 7e f8 f0
    je near 058c9h                            ; 0f 84 bb fe
    jmp near 058cdh                           ; e9 bc fe
    or word [bp+01ch], 00200h                 ; 81 4e 1c 00 02
    push strict byte 00000h                   ; 6a 00
    mov cx, ss                                ; 8c d1
    lea bx, [bp-008h]                         ; 8d 5e f8
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 05751h                               ; e8 2c fd
    test ax, ax                               ; 85 c0
    je near 058f8h                            ; 0f 84 cd fe
    cmp byte [bp-006h], 000h                  ; 80 7e fa 00
    je near 05915h                            ; 0f 84 e2 fe
    cmp byte [bp-008h], 0f0h                  ; 80 7e f8 f0
    je near 05911h                            ; 0f 84 d6 fe
    jmp near 05915h                           ; e9 d7 fe
    mov dx, strict word 00017h                ; ba 17 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01749h                               ; e8 02 bd
    mov dx, word [bp+012h]                    ; 8b 56 12
    mov dl, al                                ; 88 c2
    mov word [bp+012h], dx                    ; 89 56 12
    mov dx, strict word 00018h                ; ba 18 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01749h                               ; e8 f1 bc
    mov bh, al                                ; 88 c7
    and bh, 073h                              ; 80 e7 73
    mov dx, 00096h                            ; ba 96 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01749h                               ; e8 e3 bc
    and AL, strict byte 00ch                  ; 24 0c
    or bh, al                                 ; 08 c7
    mov dx, word [bp+012h]                    ; 8b 56 12
    xor dh, dh                                ; 30 f6
    movzx ax, bh                              ; 0f b6 c7
    sal ax, 008h                              ; c1 e0 08
    jmp near 058d8h                           ; e9 60 fe
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor ah, ah                                ; 30 e4
    or ah, 080h                               ; 80 cc 80
    jmp near 05958h                           ; e9 d5 fe
    mov bx, 00db2h                            ; bb b2 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01a2ah                               ; e8 9c bf
    mov ax, word [bp+012h]                    ; 8b 46 12
    shr ax, 008h                              ; c1 e8 08
    push ax                                   ; 50
    push 00645h                               ; 68 45 06
    push strict byte 00004h                   ; 6a 04
    call 01a6bh                               ; e8 ce bf
    add sp, strict byte 00006h                ; 83 c4 06
    mov bx, 00db2h                            ; bb b2 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01a2ah                               ; e8 7f bf
    ...
    push strict byte 00004h                   ; 6a 04
    call 01a6bh                               ; e8 a8 bf
    add sp, strict byte 0000ch                ; 83 c4 0c
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop di                                    ; 5f
    pop bp                                    ; 5d
    retn                                      ; c3
set_geom_lba_:                               ; 0xf5acc LB 0xe5
    push bx                                   ; 53
    push cx                                   ; 51
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov dx, word [bp+00ch]                    ; 8b 56 0c
    mov si, strict word 00020h                ; be 20 00
    call 0a070h                               ; e8 79 45
    test ax, ax                               ; 85 c0
    jne short 05b07h                          ; 75 0c
    test bx, bx                               ; 85 db
    jne short 05b07h                          ; 75 08
    test cx, cx                               ; 85 c9
    jne short 05b07h                          ; 75 04
    test dx, dx                               ; 85 d2
    je short 05b0eh                           ; 74 07
    mov bx, strict word 0ffffh                ; bb ff ff
    mov si, bx                                ; 89 de
    jmp short 05b14h                          ; eb 06
    mov bx, word [bp+00ch]                    ; 8b 5e 0c
    mov si, word [bp+00eh]                    ; 8b 76 0e
    mov word [bp-004h], bx                    ; 89 5e fc
    xor bx, bx                                ; 31 db
    jmp short 05b20h                          ; eb 05
    cmp bx, strict byte 00004h                ; 83 fb 04
    jnl short 05b43h                          ; 7d 23
    mov ax, word [bp-006h]                    ; 8b 46 fa
    cmp si, ax                                ; 39 c6
    jc short 05b31h                           ; 72 0a
    jne short 05b3ah                          ; 75 11
    mov ax, word [bp-004h]                    ; 8b 46 fc
    cmp ax, word [bp-008h]                    ; 3b 46 f8
    jnbe short 05b3ah                         ; 77 09
    ...
    xchg dx, ax                               ; 92
    pop sp                                    ; 5c
    jnc short 05be9h                          ; 73 5e
    mov ax, word [0a15fh]                     ; a1 5f a1
    pop di                                    ; 5f
    mov [bp+07eh], ds                         ; 8c 5e 7e
    pop di                                    ; 5f
    mov ax, word [0a15fh]                     ; a1 5f a1
    pop di                                    ; 5f
    jle short 05bf8h                          ; 7e 5f
    jle short 05bfah                          ; 7e 5f
    mov ax, word [0a15fh]                     ; a1 5f a1
    pop di                                    ; 5f
    add bl, byte [bx+07eh]                    ; 02 5f 7e
    pop di                                    ; 5f
    mov ax, word [0a15fh]                     ; a1 5f a1
    pop di                                    ; 5f
    jle short 05c08h                          ; 7e 5f
    xor bl, byte [bx-05fh]                    ; 32 5f a1
    pop di                                    ; 5f
    mov ax, word [0a15fh]                     ; a1 5f a1
    pop di                                    ; 5f
_int13_harddisk:                             ; 0xf5bb1 LB 0x44e
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    sub sp, strict byte 00010h                ; 83 ec 10
    or byte [bp+01dh], 002h                   ; 80 4e 1d 02
    ...
    mov ax, strict word 00040h                ; b8 40 00
    call 01757h                               ; e8 82 bb
    mov ax, word [bp+00eh]                    ; 8b 46 0e
    xor ah, ah                                ; 30 e4
    cmp ax, 00080h                            ; 3d 80 00
    jc short 05be4h                           ; 72 05
    cmp ax, 00090h                            ; 3d 90 00
    jc short 05c02h                           ; 72 1e
    mov ax, word [bp+00eh]                    ; 8b 46 0e
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    mov ax, word [bp+016h]                    ; 8b 46 16
    ...
    push strict byte 00004h                   ; 6a 04
    call 01a6bh                               ; e8 6f be
    add sp, strict byte 0000ah                ; 83 c4 0a
    jmp near 05fbch                           ; e9 ba 03
    mov ax, word [bp+00eh]                    ; 8b 46 0e
    xor ah, ah                                ; 30 e4
    ...
    jmp short 05bf7h                          ; eb cc
    mov bx, word [bp+016h]                    ; 8b 5e 16
    shr bx, 008h                              ; c1 eb 08
    cmp bx, strict byte 00018h                ; 83 fb 18
    jnbe near 05fa1h                          ; 0f 87 69 03
    add bx, bx                                ; 01 db
    jmp word [cs:bx+05b7fh]                   ; 2e ff a7 7f 5b
    cmp byte [bp-002h], 008h                  ; 80 7e fe 08
    jnc near 05c4eh                           ; 0f 83 07 00
    movzx ax, byte [bp-002h]                  ; 0f b6 46 fe
    call 01e75h                               ; e8 27 c2
    mov byte [bp+017h], 000h                  ; c6 46 17 00
    xor bx, bx                                ; 31 db
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01757h                               ; e8 fa ba
    and byte [bp+01ch], 0feh                  ; 80 66 1c fe
    mov sp, bp                                ; 89 ec
    pop bp                                    ; 5d
    retn                                      ; c3
    ...
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01757h                               ; e8 cc ba
    test cl, cl                               ; 84 c9
    je short 05c52h                           ; 74 c3
    jmp near 05fd8h                           ; e9 46 03
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    mov word [bp-00ch], ax                    ; 89 46 f4
    ...
    mov ax, word [bp-00ch]                    ; 8b 46 f4
    cmp ax, 00080h                            ; 3d 80 00
    jnbe short 05ccdh                         ; 77 04
    test ax, ax                               ; 85 c0
    jne short 05cf0h                          ; 75 23
    mov bx, 00db2h                            ; bb b2 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01a2ah                               ; e8 52 bd
    mov ax, word [bp+016h]                    ; 8b 46 16
    shr ax, 008h                              ; c1 e8 08
    push ax                                   ; 50
    push 00690h                               ; 68 90 06
    ...
    push strict byte 00004h                   ; 6a 04
    call 01a6bh                               ; e8 81 bd
    add sp, strict byte 00008h                ; 83 c4 08
    jmp near 05fbch                           ; e9 cc 02
    movzx ax, byte [bp-002h]                  ; 0f b6 46 fe
    imul ax, ax, strict byte 0001ch           ; 6b c0 1c
    mov es, [bp-004h]                         ; 8e 46 fc
    mov bx, si                                ; 89 f3
    ...
    mov word [bp-00ah], dx                    ; 89 56 f6
    cmp di, ax                                ; 39 c7
    jnc short 05d1dh                          ; 73 0c
    cmp cx, word [bp-008h]                    ; 3b 4e f8
    jbe short 05d1dh                          ; 76 07
    mov ax, word [bp-006h]                    ; 8b 46 fa
    cmp ax, dx                                ; 39 d0
    jbe short 05d4bh                          ; 76 2e
    mov bx, 00db2h                            ; bb b2 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01a2ah                               ; e8 02 bd
    ...
    mov word [bp+016h], bx                    ; 89 5e 16
    test dl, dl                               ; 84 d2
    je near 05c4eh                            ; 0f 84 0a fe
    mov bx, 00db2h                            ; bb b2 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01a2ah                               ; e8 db bb
    movzx ax, dl                              ; 0f b6 c2
    push ax                                   ; 50
    mov ax, word [bp+016h]                    ; 8b 46 16
    shr ax, 008h                              ; c1 e8 08
    ...
    push strict byte 00004h                   ; 6a 04
    call 01a6bh                               ; e8 06 bc
    add sp, strict byte 0000ah                ; 83 c4 0a
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 00ch                               ; 80 cc 0c
    jmp near 05fc4h                           ; e9 51 01
    mov bx, 00db2h                            ; bb b2 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01a2ah                               ; e8 ac bb
    push 0078ch                               ; 68 8c 07
    push strict byte 00004h                   ; 6a 04
    call 01a6bh                               ; e8 e5 bb
    add sp, strict byte 00004h                ; 83 c4 04
    jmp near 05c4eh                           ; e9 c2 fd
    movzx ax, byte [bp-002h]                  ; 0f b6 46 fe
    imul ax, ax, strict byte 0001ch           ; 6b c0 1c
    mov es, [bp-004h]                         ; 8e 46 fc
    mov bx, si                                ; 89 f3
    ...
    and AL, strict byte 0c0h                  ; 24 c0
    cmp AL, strict byte 040h                  ; 3c 40
    jne short 05f27h                          ; 75 03
    jmp near 05c4eh                           ; e9 27 fd
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 0aah                               ; 80 cc aa
    jmp near 05fc4h                           ; e9 92 00
    movzx ax, byte [bp-002h]                  ; 0f b6 46 fe
    imul ax, ax, strict byte 0001ch           ; 6b c0 1c
    mov es, [bp-004h]                         ; 8e 46 fc
    add si, ax                                ; 01 c6
    ...
    xor cx, cx                                ; 31 c9
    call 09ff0h                               ; e8 94 40
    mov bx, word [bp-006h]                    ; 8b 5e fa
    xor cx, cx                                ; 31 c9
    call 09ff0h                               ; e8 8c 40
    mov word [bp-010h], ax                    ; 89 46 f0
    mov word [bp-00eh], dx                    ; 89 56 f2
    mov word [bp+014h], dx                    ; 89 56 14
    mov word [bp+012h], ax                    ; 89 46 12
    ...
    or ah, 003h                               ; 80 cc 03
    mov word [bp+016h], ax                    ; 89 46 16
    jmp near 05c52h                           ; e9 d4 fc
    mov bx, 00db2h                            ; bb b2 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01a2ah                               ; e8 a1 ba
    mov ax, word [bp+016h]                    ; 8b 46 16
    shr ax, 008h                              ; c1 e8 08
    push ax                                   ; 50
    push 00690h                               ; 68 90 06
    ...
    push strict byte 00004h                   ; 6a 04
    call 01a6bh                               ; e8 d0 ba
    add sp, strict byte 00008h                ; 83 c4 08
    jmp near 05c4eh                           ; e9 ad fc
    mov bx, 00db2h                            ; bb b2 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01a2ah                               ; e8 7e ba
    mov ax, word [bp+016h]                    ; 8b 46 16
    shr ax, 008h                              ; c1 e8 08
    push ax                                   ; 50
    push 00690h                               ; 68 90 06
    push 007d9h                               ; 68 d9 07
    jmp near 05ce5h                           ; e9 29 fd
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 001h                               ; 80 cc 01
    mov word [bp+016h], ax                    ; 89 46 16
    ...
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01757h                               ; e8 7f b7
    or byte [bp+01ch], 001h                   ; 80 4e 1c 01
    jmp near 05c61h                           ; e9 82 fc
    popfw                                     ; 9d
    pushaw                                    ; 60
    mov CH, strict byte 060h                  ; b5 60
    mov CH, strict byte 060h                  ; b5 60
    mov CH, strict byte 060h                  ; b5 60
    mov word [si+00ah], sp                    ; 89 64 0a
    bound si, [di+01060h]                     ; 62 b5 60 10
    bound cx, [bx+di-0279ch]                  ; 62 89 64 d8
    fsub dword [fs:si-028h]                   ; 64 d8 64 d8
    fsub dword [fs:si-060h]                   ; 64 d8 64 a0
    fsub dword [fs:si-028h]                   ; 64 d8 64 d8
    db  064h
_int13_harddisk_ext:                         ; 0xf5fff LB 0x4f4
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    sub sp, strict byte 00026h                ; 83 ec 26
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01765h                               ; e8 57 b7
    mov word [bp-014h], ax                    ; 89 46 ec
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01765h                               ; e8 4b b7
    mov word [bp-008h], 00122h                ; c7 46 f8 22 01
    mov word [bp-006h], ax                    ; 89 46 fa
    xor bx, bx                                ; 31 db
    mov dx, 0008eh                            ; ba 8e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01757h                               ; e8 2a b7
    mov ax, word [bp+00eh]                    ; 8b 46 0e
    xor ah, ah                                ; 30 e4
    cmp ax, 00080h                            ; 3d 80 00
    jc short 0603ch                           ; 72 05
    cmp ax, 00090h                            ; 3d 90 00
    jc short 0605ah                           ; 72 1e
    mov ax, word [bp+00eh]                    ; 8b 46 0e
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    mov ax, word [bp+016h]                    ; 8b 46 16
    ...
    push 0069fh                               ; 68 9f 06
    push strict byte 00004h                   ; 6a 04
    call 01a6bh                               ; e8 17 ba
    add sp, strict byte 0000ah                ; 83 c4 0a
    jmp near 064b6h                           ; e9 5c 04
    mov ax, word [bp+00eh]                    ; 8b 46 0e
    xor ah, ah                                ; 30 e4
    ...
    push 00807h                               ; 68 07 08
    push 006cah                               ; 68 ca 06
    jmp short 0604fh                          ; eb ce
    mov bx, word [bp+016h]                    ; 8b 5e 16
    shr bx, 008h                              ; c1 eb 08
    sub bx, strict byte 00041h                ; 83 eb 41
    cmp bx, strict byte 0000fh                ; 83 fb 0f
    jnbe near 064d8h                          ; 0f 87 47 04
    add bx, bx                                ; 01 db
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    jmp word [cs:bx+05fdfh]                   ; 2e ff a7 df 5f
    ...
    jnbe short 0612fh                         ; 77 22
    jne short 06152h                          ; 75 43
    mov si, word [bp-00eh]                    ; 8b 76 f2
    cmp si, word [es:di+03ah]                 ; 26 3b 75 3a
    jnbe short 0612fh                         ; 77 17
    mov si, word [bp-00eh]                    ; 8b 76 f2
    cmp si, word [es:di+03ah]                 ; 26 3b 75 3a
    jne short 06152h                          ; 75 31
    cmp cx, word [es:di+038h]                 ; 26 3b 4d 38
    jnbe short 0612fh                         ; 77 08
    jne short 06152h                          ; 75 29
    cmp dx, word [es:di+036h]                 ; 26 3b 55 36
    jc short 06152h                           ; 72 23
    mov bx, 00db2h                            ; bb b2 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01a2ah                               ; e8 f0 b8
    mov ax, word [bp+016h]                    ; 8b 46 16
    shr ax, 008h                              ; c1 e8 08
    push ax                                   ; 50
    push 00807h                               ; 68 07 08
    ...
    push strict byte 00004h                   ; 6a 04
    call 01a6bh                               ; e8 1f b9
    add sp, strict byte 00008h                ; 83 c4 08
    jmp near 064b6h                           ; e9 64 03
    mov di, word [bp+016h]                    ; 8b 7e 16
    shr di, 008h                              ; c1 ef 08
    cmp di, strict byte 00044h                ; 83 ff 44
    je near 06489h                            ; 0f 84 2a 03
    cmp di, strict byte 00047h                ; 83 ff 47
    je near 06489h                            ; 0f 84 23 03
    ...
    mov word [es:bx+002h], ax                 ; 26 89 47 02
    test dl, dl                               ; 84 d2
    je near 06489h                            ; 0f 84 a8 02
    mov bx, 00db2h                            ; bb b2 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01a2ah                               ; e8 3e b8
    movzx ax, dl                              ; 0f b6 c2
    push ax                                   ; 50
    push di                                   ; 57
    push 00807h                               ; 68 07 08
    push 0076bh                               ; 68 6b 07
    push strict byte 00004h                   ; 6a 04
    call 01a6bh                               ; e8 6f b8
    add sp, strict byte 0000ah                ; 83 c4 0a
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 00ch                               ; 80 cc 0c
    jmp near 064beh                           ; e9 b4 02
    or ah, 0b2h                               ; 80 cc b2
    jmp near 064beh                           ; e9 ae 02
    ...
    mov word [bp-010h], ax                    ; 89 46 f0
    cmp ax, strict word 0001ah                ; 3d 1a 00
    jc near 064b6h                            ; 0f 82 89 02
    jc near 062cch                            ; 0f 82 9b 00
    ...
    test al, al                               ; 84 c0
    jne short 0632bh                          ; 75 04
    xor bx, bx                                ; 31 db
    jmp short 0632eh                          ; eb 03
    ...
    or bx, cx                                 ; 09 cb
    cmp AL, strict byte 003h                  ; 3c 03
    jne short 0634fh                          ; 75 05
    mov ax, strict word 00003h                ; b8 03 00
    jmp short 06351h                          ; eb 02
    xor ax, ax                                ; 31 c0
    or bx, ax                                 ; 09 c3
    mov ax, word [bp-01eh]                    ; 8b 46 e2
    les si, [bp-008h]                         ; c4 76 f8
    ...
    xor bl, bl                                ; 30 db
    xor bh, bh                                ; 30 ff
    jmp short 063b4h                          ; eb 05
    cmp bh, 00fh                              ; 80 ff 0f
    jnc short 063c7h                          ; 73 13
    movzx dx, bh                              ; 0f b6 d7
    add dx, 00356h                            ; 81 c2 56 03
    mov ax, word [bp-014h]                    ; 8b 46 ec
    call 01749h                               ; e8 88 b3
    add bl, al                                ; 00 c3
    db  0feh, 0c7h
    ; inc bh                                    ; fe c7
    jmp short 063afh                          ; eb e8
    neg bl                                    ; f6 db
    les si, [bp-008h]                         ; c4 76 f8
    mov byte [es:si+00243h], bl               ; 26 88 9c 43 02
    cmp word [bp-010h], strict byte 00042h    ; 83 7e f0 42
    jc near 06489h                            ; 0f 82 b0 00
    movzx ax, byte [bp-004h]                  ; 0f b6 46 fc
    cwd                                       ; 99
    db  02bh, 0c2h
    ; sub ax, dx                                ; 2b c2
    ...
    jnc short 06480h                          ; 73 12
    movzx dx, bh                              ; 0f b6 d7
    add dx, word [bp+00ah]                    ; 03 56 0a
    mov ax, word [bp+004h]                    ; 8b 46 04
    call 01749h                               ; e8 cf b2
    add bl, al                                ; 00 c3
    db  0feh, 0c7h
    ; inc bh                                    ; fe c7
    jmp short 06469h                          ; eb e9
    neg bl                                    ; f6 db
    mov es, [bp-00ah]                         ; 8e 46 f6
    ...
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01757h                               ; e8 bf b2
    and byte [bp+01ch], 0feh                  ; 80 66 1c fe
    mov sp, bp                                ; 89 ec
    pop bp                                    ; 5d
    retn                                      ; c3
    cmp ax, strict word 00006h                ; 3d 06 00
    je short 06489h                           ; 74 e4
    cmp ax, strict word 00001h                ; 3d 01 00
    jc short 064b6h                           ; 72 0c
    jbe short 06489h                          ; 76 dd
    cmp ax, strict word 00003h                ; 3d 03 00
    jc short 064b6h                           ; 72 05
    cmp ax, strict word 00004h                ; 3d 04 00
    jbe short 06489h                          ; 76 d3
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 001h                               ; 80 cc 01
    mov word [bp+016h], ax                    ; 89 46 16
    ...
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01757h                               ; e8 85 b2
    or byte [bp+01ch], 001h                   ; 80 4e 1c 01
    jmp short 0649ch                          ; eb c4
    mov bx, 00db2h                            ; bb b2 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01a2ah                               ; e8 47 b5
    mov ax, word [bp+016h]                    ; 8b 46 16
    shr ax, 008h                              ; c1 e8 08
    push ax                                   ; 50
    push 00807h                               ; 68 07 08
    push 007d9h                               ; 68 d9 07
    jmp near 06147h                           ; e9 54 fc
_int14_function:                             ; 0xf64f3 LB 0x15a
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    sti                                       ; fb
    ...
    add dx, dx                                ; 01 d2
    mov ax, strict word 00040h                ; b8 40 00
    call 01765h                               ; e8 62 b2
    mov si, ax                                ; 89 c6
    mov bx, ax                                ; 89 c3
    mov dx, word [bp+00eh]                    ; 8b 56 0e
    add dx, strict byte 0007ch                ; 83 c2 7c
    mov ax, strict word 00040h                ; b8 40 00
    call 01749h                               ; e8 36 b2
    mov cl, al                                ; 88 c1
    cmp word [bp+00eh], strict byte 00004h    ; 83 7e 0e 04
    jnc near 06643h                           ; 0f 83 26 01
    test si, si                               ; 85 f6
    jbe near 06643h                           ; 0f 86 20 01
    mov al, byte [bp+013h]                    ; 8a 46 13
    cmp AL, strict byte 001h                  ; 3c 01
    jc short 0653bh                           ; 72 11
    jbe short 06594h                          ; 76 68
    cmp AL, strict byte 003h                  ; 3c 03
    je near 0662ch                            ; 0f 84 fa 00
    cmp AL, strict byte 002h                  ; 3c 02
    je near 065e2h                            ; 0f 84 aa 00
    jmp near 0663dh                           ; e9 02 01
    test al, al                               ; 84 c0
    jne near 0663dh                           ; 0f 85 fc 00
    ...
    jmp near 0661eh                           ; e9 8a 00
    mov dx, strict word 0006ch                ; ba 6c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01765h                               ; e8 c8 b1
    mov si, ax                                ; 89 c6
    lea dx, [bx+005h]                         ; 8d 57 05
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ...
    je short 065c4h                           ; 74 17
    test cl, cl                               ; 84 c9
    je short 065c4h                           ; 74 13
    mov dx, strict word 0006ch                ; ba 6c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01765h                               ; e8 ab b1
    cmp ax, si                                ; 39 f0
    je short 0659fh                           ; 74 e1
    mov si, ax                                ; 89 c6
    db  0feh, 0c9h
    ; dec cl                                    ; fe c9
    jmp short 0659fh                          ; eb db
    test cl, cl                               ; 84 c9
    je short 065ceh                           ; 74 06
    mov al, byte [bp+012h]                    ; 8a 46 12
    mov dx, bx                                ; 89 da
    out DX, AL                                ; ee
    lea dx, [bx+005h]                         ; 8d 57 05
    ...
    mov byte [bp+013h], al                    ; 88 46 13
    test cl, cl                               ; 84 c9
    jne short 0661eh                          ; 75 43
    or AL, strict byte 080h                   ; 0c 80
    mov byte [bp+013h], al                    ; 88 46 13
    jmp short 0661eh                          ; eb 3c
    mov dx, strict word 0006ch                ; ba 6c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01765h                               ; e8 7a b1
    mov si, ax                                ; 89 c6
    lea dx, [bx+005h]                         ; 8d 57 05
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 0660eh                          ; 75 17
    test cl, cl                               ; 84 c9
    je short 0660eh                           ; 74 13
    mov dx, strict word 0006ch                ; ba 6c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01765h                               ; e8 61 b1
    cmp ax, si                                ; 39 f0
    je short 065edh                           ; 74 e5
    mov si, ax                                ; 89 c6
    db  0feh, 0c9h
    ; dec cl                                    ; fe c9
    jmp short 065edh                          ; eb df
    test cl, cl                               ; 84 c9
    je short 06624h                           ; 74 12
    mov byte [bp+013h], 000h                  ; c6 46 13 00
    mov dx, bx                                ; 89 da
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ...
    mov byte [bp+012h], al                    ; 88 46 12
    and byte [bp+01ch], 0feh                  ; 80 66 1c fe
    jmp short 06647h                          ; eb 23
    lea dx, [bx+005h]                         ; 8d 57 05
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    jmp short 065ddh                          ; eb b1
    lea dx, [si+005h]                         ; 8d 54 05
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    jmp short 0661bh                          ; eb de
    or byte [bp+01ch], 001h                   ; 80 4e 1c 01
    jmp short 06647h                          ; eb 04
    or byte [bp+01ch], 001h                   ; 80 4e 1c 01
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
timer_wait_:                                 ; 0xf664d LB 0x43
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    jne short 0667ah                          ; 75 05
    cmp cx, strict byte 0ffffh                ; 83 f9 ff
    je short 06689h                           ; 74 0f
    mov dx, strict word 00061h                ; ba 61 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    jne short 0667ah                          ; 75 f3
    jmp short 0666ah                          ; eb e1
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop cx                                    ; 59
    pop bx                                    ; 5b
    pop bp                                    ; 5d
    retn                                      ; c3
set_enable_a20_:                             ; 0xf6690 LB 0x2c
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
set_e820_range_:                             ; 0xf66bc LB 0x89
    push si                                   ; 56
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    mov es, ax                                ; 8e c0
    ...
    db  049h, 06ah, 082h, 067h, 095h, 067h, 02ah, 068h, 030h, 068h, 035h, 068h, 03ah, 068h, 0dch, 068h
    db  006h, 069h, 023h, 068h, 023h, 068h, 0d3h, 069h, 0fbh, 069h, 00eh, 06ah, 01dh, 06ah, 02ah, 068h
    db  024h, 06ah
_int15_function:                             ; 0xf6745 LB 0x336
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    jnbe near 06a49h                          ; 0f 87 f2 02
    push CS                                   ; 0e
    pop ES                                    ; 07
    mov cx, strict word 00011h                ; b9 11 00
    mov di, 06713h                            ; bf 13 67
    repne scasb                               ; f2 ae
    sal cx, 1                                 ; d1 e1
    mov di, cx                                ; 89 cf
    mov si, word [cs:di+06723h]               ; 2e 8b b5 23 67
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor ah, ah                                ; 30 e4
    ...
    jne near 06a49h                           ; 0f 85 bb 02
    or byte [bp+018h], 001h                   ; 80 4e 18 01
    jmp near 069f2h                           ; e9 5d 02
    mov dx, ax                                ; 89 c2
    cmp ax, strict word 00001h                ; 3d 01 00
    jc short 067aah                           ; 72 0e
    jbe short 067beh                          ; 76 20
    cmp ax, strict word 00003h                ; 3d 03 00
    je short 067ebh                           ; 74 48
    cmp ax, strict word 00002h                ; 3d 02 00
    je short 067ceh                           ; 74 26
    jmp short 067f8h                          ; eb 4e
    test ax, ax                               ; 85 c0
    jne short 067f8h                          ; 75 4a
    xor ax, ax                                ; 31 c0
    call 06690h                               ; e8 dd fe
    and byte [bp+018h], 0feh                  ; 80 66 18 fe
    mov byte [bp+013h], 000h                  ; c6 46 13 00
    jmp near 06823h                           ; e9 65 00
    mov ax, strict word 00001h                ; b8 01 00
    call 06690h                               ; e8 cc fe
    and byte [bp+018h], 0feh                  ; 80 66 18 fe
    mov byte [bp+013h], dh                    ; 88 76 13
    jmp near 06823h                           ; e9 55 00
    mov dx, 00092h                            ; ba 92 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    jmp near 06823h                           ; e9 38 00
    and byte [bp+018h], 0feh                  ; 80 66 18 fe
    mov byte [bp+013h], ah                    ; 88 66 13
    mov word [bp+00ch], ax                    ; 89 46 0c
    jmp near 06823h                           ; e9 2b 00
    mov bx, 00db2h                            ; bb b2 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01a2ah                               ; e8 27 b2
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    push 00840h                               ; 68 40 08
    push strict byte 00004h                   ; 6a 04
    call 01a6bh                               ; e8 5a b2
    add sp, strict byte 00006h                ; 83 c4 06
    or byte [bp+018h], 001h                   ; 80 4e 18 01
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor ah, ah                                ; 30 e4
    ...
    retn                                      ; c3
    mov word [bp+018h], bx                    ; 89 5e 18
    jmp near 068d6h                           ; e9 a6 00
    mov word [bp+018h], bx                    ; 89 5e 18
    jmp short 06823h                          ; eb ee
    mov word [bp+018h], cx                    ; 89 4e 18
    jmp short 06820h                          ; eb e6
    test byte [bp+012h], 0ffh                 ; f6 46 12 ff
    jne short 068ach                          ; 75 6c
    mov dx, 000a0h                            ; ba a0 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01749h                               ; e8 00 af
    test AL, strict byte 001h                 ; a8 01
    jne near 069e9h                           ; 0f 85 9a 01
    mov bx, strict word 00001h                ; bb 01 00
    mov dx, 000a0h                            ; ba a0 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01757h                               ; e8 fc ae
    mov bx, word [bp+014h]                    ; 8b 5e 14
    mov dx, 00098h                            ; ba 98 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01773h                               ; e8 0c af
    mov bx, word [bp+00ch]                    ; 8b 5e 0c
    mov dx, 0009ah                            ; ba 9a 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01773h                               ; e8 00 af
    mov bx, word [bp+00eh]                    ; 8b 5e 0e
    mov dx, 0009ch                            ; ba 9c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01773h                               ; e8 f4 ae
    mov bx, word [bp+010h]                    ; 8b 5e 10
    mov dx, 0009eh                            ; ba 9e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01773h                               ; e8 e8 ae
    and byte [bp+018h], 0feh                  ; 80 66 18 fe
    mov dx, 000a1h                            ; ba a1 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ...
    out DX, AL                                ; ee
    mov ax, strict word 0000bh                ; b8 0b 00
    call 017a5h                               ; e8 07 af
    or AL, strict byte 040h                   ; 0c 40
    movzx dx, al                              ; 0f b6 d0
    mov ax, strict word 0000bh                ; b8 0b 00
    call 017c2h                               ; e8 19 af
    jmp near 06823h                           ; e9 77 ff
    cmp ax, strict word 00001h                ; 3d 01 00
    jne short 068cah                          ; 75 19
    xor bx, bx                                ; 31 db
    mov dx, 000a0h                            ; ba a0 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01757h                               ; e8 9b ae
    and byte [bp+018h], 0feh                  ; 80 66 18 fe
    mov ax, strict word 0000bh                ; b8 0b 00
    call 017a5h                               ; e8 df ae
    and AL, strict byte 0bfh                  ; 24 bf
    jmp short 068a0h                          ; eb d6
    mov word [bp+018h], bx                    ; 89 5e 18
    mov ax, dx                                ; 89 d0
    xor ah, dh                                ; 30 f4
    xor dl, dl                                ; 30 d2
    ...
    push cx                                   ; 51
    retf                                      ; cb
    jmp near 06823h                           ; e9 50 fe
    mov bx, 00db2h                            ; bb b2 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01a2ah                               ; e8 4c b0
    push 00880h                               ; 68 80 08
    push strict byte 00004h                   ; 6a 04
    call 01a6bh                               ; e8 85 b0
    add sp, strict byte 00004h                ; 83 c4 04
    or byte [bp+018h], 001h                   ; 80 4e 18 01
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor ah, ah                                ; 30 e4
    or ah, 086h                               ; 80 cc 86
    mov word [bp+012h], ax                    ; 89 46 12
    jmp near 06823h                           ; e9 28 fe
    mov word [bp+018h], cx                    ; 89 4e 18
    mov word [bp+012h], ax                    ; 89 46 12
    mov word [bp+00ch], 0e6f5h                ; c7 46 0c f5 e6
    mov word [bp+014h], 0f000h                ; c7 46 14 00 f0
    jmp near 06823h                           ; e9 15 fe
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01765h                               ; e8 4e ad
    mov word [bp+014h], ax                    ; 89 46 14
    jmp near 068ffh                           ; e9 e2 fe
    push 008afh                               ; 68 af 08
    push strict byte 00008h                   ; 6a 08
    jmp short 069e3h                          ; eb bf
    test byte [bp+012h], 0ffh                 ; f6 46 12 ff
    jne short 06a49h                          ; 75 1f
    mov word [bp+012h], ax                    ; 89 46 12
    mov ax, word [bp+00ch]                    ; 8b 46 0c
    xor ah, ah                                ; 30 e4
    cmp ax, strict word 00001h                ; 3d 01 00
    jc short 06a42h                           ; 72 0b
    cmp ax, strict word 00003h                ; 3d 03 00
    jnbe short 06a42h                         ; 77 06
    mov word [bp+018h], cx                    ; 89 4e 18
    jmp near 06823h                           ; e9 e1 fd
    or byte [bp+018h], 001h                   ; 80 4e 18 01
    jmp near 06823h                           ; e9 da fd
    mov bx, 00db2h                            ; bb b2 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01a2ah                               ; e8 d6 af
    push word [bp+00ch]                       ; ff 76 0c
    push word [bp+012h]                       ; ff 76 12
    push 008c6h                               ; 68 c6 08
    push strict byte 00004h                   ; 6a 04
    call 01a6bh                               ; e8 09 b0
    add sp, strict byte 00008h                ; 83 c4 08
    jmp short 069e9h                          ; eb 82
    hlt                                       ; f4
    imul dx, word [0396ch], strict byte 0006ch ; 6b 16 6c 39 6c
    pop bx                                    ; 5b
    insb                                      ; 6c
    jnp short 06addh                          ; 7b 6c
    call far 0e26ch:0be6ch                    ; 9a 6c be 6c e2
    insb                                      ; 6c
    and word [di+04dh], bp                    ; 21 6d 4d
    insw                                      ; 6d
_int15_function32:                           ; 0xf6a7b LB 0x396
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    sub sp, strict byte 00008h                ; 83 ec 08
    ...
    jc short 06b6dh                           ; 72 06
    jne short 06b9ah                          ; 75 31
    test bx, bx                               ; 85 db
    jnbe short 06b9ah                         ; 77 2d
    mov ax, strict word 00031h                ; b8 31 00
    call 017a5h                               ; e8 32 ac
    movzx bx, al                              ; 0f b6 d8
    xor dx, dx                                ; 31 d2
    mov cx, strict word 00008h                ; b9 08 00
    sal bx, 1                                 ; d1 e3
    ...
    call 017a5h                               ; e8 d4 ab
    mov byte [bp-004h], al                    ; 88 46 fc
    mov byte [bp-006h], al                    ; 88 46 fa
    mov ax, word [bp+014h]                    ; 8b 46 14
    cmp ax, strict word 00009h                ; 3d 09 00
    jnbe near 06de1h                          ; 0f 87 00 02
    mov si, ax                                ; 89 c6
    add si, ax                                ; 01 c6
    mov ax, bx                                ; 89 d8
    add ax, strict word 00000h                ; 05 00 00
    ...
    jmp word [cs:si+06a67h]                   ; 2e ff a4 67 6a
    push strict byte 00001h                   ; 6a 01
    ...
    xor bx, bx                                ; 31 db
    xor cx, cx                                ; 31 c9
    call 066bch                               ; e8 86 f9
    cmp byte [bp-004h], 000h                  ; 80 7e fc 00
    jne short 06d43h                          ; 75 07
    mov ax, word [bp-008h]                    ; 8b 46 f8
    test ax, ax                               ; 85 c0
    je short 06d45h                           ; 74 02
    jmp short 06d05h                          ; eb c0
    mov word [bp+014h], ax                    ; 89 46 14
    mov word [bp+016h], ax                    ; 89 46 16
    jmp short 06d7eh                          ; eb 31
    cmp byte [bp-004h], 000h                  ; 80 7e fc 00
    jne short 06d59h                          ; 75 06
    cmp word [bp-008h], strict byte 00000h    ; 83 7e f8 00
    je short 06d7eh                           ; 74 25
    push strict byte 00001h                   ; 6a 01
    mov al, byte [bp-006h]                    ; 8a 46 fa
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    ...
    jmp short 06e0bh                          ; eb 77
    mov word [bp+028h], bx                    ; 89 5e 28
    mov ax, strict word 00031h                ; b8 31 00
    call 017a5h                               ; e8 08 aa
    xor ah, ah                                ; 30 e4
    mov dx, ax                                ; 89 c2
    sal dx, 008h                              ; c1 e2 08
    mov ax, strict word 00030h                ; b8 30 00
    call 017a5h                               ; e8 fb a9
    xor ah, ah                                ; 30 e4
    or dx, ax                                 ; 09 c2
    mov word [bp+01ch], dx                    ; 89 56 1c
    cmp dx, 03c00h                            ; 81 fa 00 3c
    jbe short 06dbch                          ; 76 05
    mov word [bp+01ch], 03c00h                ; c7 46 1c 00 3c
    mov ax, strict word 00035h                ; b8 35 00
    call 017a5h                               ; e8 e3 a9
    xor ah, ah                                ; 30 e4
    mov dx, ax                                ; 89 c2
    sal dx, 008h                              ; c1 e2 08
    mov ax, strict word 00034h                ; b8 34 00
    call 017a5h                               ; e8 d6 a9
    xor ah, ah                                ; 30 e4
    or dx, ax                                 ; 09 c2
    mov word [bp+018h], dx                    ; 89 56 18
    mov ax, word [bp+01ch]                    ; 8b 46 1c
    ...
    mov word [bp+014h], dx                    ; 89 56 14
    jmp short 06e0bh                          ; eb 2a
    mov bx, 00db2h                            ; bb b2 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01a2ah                               ; e8 3e ac
    push word [bp+014h]                       ; ff 76 14
    push word [bp+020h]                       ; ff 76 20
    push 008c6h                               ; 68 c6 08
    push strict byte 00004h                   ; 6a 04
    call 01a6bh                               ; e8 71 ac
    add sp, strict byte 00008h                ; 83 c4 08
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
_int15_blkmove:                              ; 0xf6e11 LB 0x1ab
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    call 01773h                               ; e8 26 a9
    mov dx, word [bp+00ah]                    ; 8b 56 0a
    add dx, strict byte 0000ah                ; 83 c2 0a
    mov ax, word [bp+006h]                    ; 8b 46 06
    mov bx, cx                                ; 89 cb
    call 01773h                               ; e8 18 a9
    movzx bx, byte [bp-006h]                  ; 0f b6 5e fa
    mov dx, word [bp+00ah]                    ; 8b 56 0a
    add dx, strict byte 0000ch                ; 83 c2 0c
    mov ax, word [bp+006h]                    ; 8b 46 06
    call 01757h                               ; e8 ec a8
    mov dx, word [bp+00ah]                    ; 8b 56 0a
    add dx, strict byte 0000dh                ; 83 c2 0d
    mov ax, word [bp+006h]                    ; 8b 46 06
    mov bx, 00093h                            ; bb 93 00
    call 01757h                               ; e8 dd a8
    mov dx, word [bp+00ah]                    ; 8b 56 0a
    add dx, strict byte 0000eh                ; 83 c2 0e
    mov ax, word [bp+006h]                    ; 8b 46 06
    xor bx, bx                                ; 31 db
    call 01773h                               ; e8 eb a8
    mov dx, word [bp+00ah]                    ; 8b 56 0a
    add dx, strict byte 00020h                ; 83 c2 20
    mov ax, word [bp+006h]                    ; 8b 46 06
    mov bx, strict word 0ffffh                ; bb ff ff
    call 01773h                               ; e8 dc a8
    mov dx, word [bp+00ah]                    ; 8b 56 0a
    add dx, strict byte 00022h                ; 83 c2 22
    mov ax, word [bp+006h]                    ; 8b 46 06
    xor bx, bx                                ; 31 db
    call 01773h                               ; e8 ce a8
    mov dx, word [bp+00ah]                    ; 8b 56 0a
    add dx, strict byte 00024h                ; 83 c2 24
    mov ax, word [bp+006h]                    ; 8b 46 06
    mov bx, strict word 0000fh                ; bb 0f 00
    call 01757h                               ; e8 a3 a8
    mov dx, word [bp+00ah]                    ; 8b 56 0a
    add dx, strict byte 00025h                ; 83 c2 25
    mov ax, word [bp+006h]                    ; 8b 46 06
    mov bx, 0009bh                            ; bb 9b 00
    call 01757h                               ; e8 94 a8
    mov dx, word [bp+00ah]                    ; 8b 56 0a
    add dx, strict byte 00026h                ; 83 c2 26
    mov ax, word [bp+006h]                    ; 8b 46 06
    xor bx, bx                                ; 31 db
    call 01773h                               ; e8 a2 a8
    mov ax, ss                                ; 8c d0
    mov cx, ax                                ; 89 c1
    sal cx, 004h                              ; c1 e1 04
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
_inv_op_handler:                             ; 0xf6fbc LB 0x195
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    jne short 06fd2h                          ; 75 06
    inc word [bp+018h]                        ; ff 46 18
    jmp near 0714ah                           ; e9 78 01
    cmp word [es:bx], 0050fh                  ; 26 81 3f 0f 05
    jne near 07146h                           ; 0f 85 6b 01
    mov si, 00800h                            ; be 00 08
    xor ax, ax                                ; 31 c0
    mov word [bp-006h], ax                    ; 89 46 fa
    mov word [bp-008h], ax                    ; 89 46 f8
    ...
    loop 0702bh                               ; e2 fa
    cmp bx, dx                                ; 39 d3
    jne short 07039h                          ; 75 04
    cmp di, ax                                ; 39 c7
    je short 0703eh                           ; 74 05
    ...
    loop 07053h                               ; e2 fa
    cmp di, dx                                ; 39 d7
    jne short 07061h                          ; 75 04
    cmp bx, ax                                ; 39 c3
    je short 07065h                           ; 74 04
    ...
    je near 07103h                            ; 0f 84 02 00
    mov es, ax                                ; 8e c0
    test cx, strict word 00002h               ; f7 c1 02 00
    je near 0712bh                            ; 0f 84 20 00
    ...
    iret                                      ; cf
    jmp short 0714ah                          ; eb 04
    sti                                       ; fb
    hlt                                       ; f4
    jmp short 07147h                          ; eb fd
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
init_rtc_:                                   ; 0xf7151 LB 0x28
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push dx                                   ; 52
    mov dx, strict word 00026h                ; ba 26 00
    mov ax, strict word 0000ah                ; b8 0a 00
    call 017c2h                               ; e8 64 a6
    mov dx, strict word 00002h                ; ba 02 00
    mov ax, strict word 0000bh                ; b8 0b 00
    call 017c2h                               ; e8 5b a6
    mov ax, strict word 0000ch                ; b8 0c 00
    call 017a5h                               ; e8 38 a6
    mov ax, strict word 0000dh                ; b8 0d 00
    call 017a5h                               ; e8 32 a6
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop dx                                    ; 5a
    pop bp                                    ; 5d
    retn                                      ; c3
rtc_updating_:                               ; 0xf7179 LB 0x21
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push dx                                   ; 52
    mov dx, 061a8h                            ; ba a8 61
    dec dx                                    ; 4a
    je short 07191h                           ; 74 0e
    mov ax, strict word 0000ah                ; b8 0a 00
    call 017a5h                               ; e8 1c a6
    test AL, strict byte 080h                 ; a8 80
    jne short 07180h                          ; 75 f3
    xor ax, ax                                ; 31 c0
    jmp short 07194h                          ; eb 03
    mov ax, strict word 00001h                ; b8 01 00
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop dx                                    ; 5a
    pop bp                                    ; 5d
    retn                                      ; c3
_int70_function:                             ; 0xf719a LB 0xbe
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push ax                                   ; 50
    mov ax, strict word 0000bh                ; b8 0b 00
    call 017a5h                               ; e8 00 a6
    mov dl, al                                ; 88 c2
    mov byte [bp-004h], al                    ; 88 46 fc
    mov ax, strict word 0000ch                ; b8 0c 00
    call 017a5h                               ; e8 f5 a5
    mov dh, al                                ; 88 c6
    test dl, 060h                             ; f6 c2 60
    je near 0723fh                            ; 0f 84 86 00
    test AL, strict byte 020h                 ; a8 20
    je short 071c1h                           ; 74 04
    sti                                       ; fb
    int 04ah                                  ; cd 4a
    cli                                       ; fa
    test dh, 040h                             ; f6 c6 40
    je near 0723fh                            ; 0f 84 77 00
    mov dx, 000a0h                            ; ba a0 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01749h                               ; e8 78 a5
    test al, al                               ; 84 c0
    je short 0723fh                           ; 74 6a
    mov dx, 0009ch                            ; ba 9c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01781h                               ; e8 a3 a5
    test dx, dx                               ; 85 d2
    jne short 0722bh                          ; 75 49
    cmp ax, 003d1h                            ; 3d d1 03
    jnc short 0722bh                          ; 73 44
    mov dx, 00098h                            ; ba 98 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01765h                               ; e8 75 a5
    mov si, ax                                ; 89 c6
    mov dx, 0009ah                            ; ba 9a 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01765h                               ; e8 6a a5
    mov cx, ax                                ; 89 c1
    xor bx, bx                                ; 31 db
    mov dx, 000a0h                            ; ba a0 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01757h                               ; e8 4f a5
    mov al, byte [bp-004h]                    ; 8a 46 fc
    and AL, strict byte 037h                  ; 24 37
    movzx dx, al                              ; 0f b6 d0
    mov ax, strict word 0000bh                ; b8 0b 00
    call 017c2h                               ; e8 ac a5
    mov dx, cx                                ; 89 ca
    mov ax, si                                ; 89 f0
    call 01749h                               ; e8 2c a5
    or AL, strict byte 080h                   ; 0c 80
    movzx bx, al                              ; 0f b6 d8
    mov dx, cx                                ; 89 ca
    mov ax, si                                ; 89 f0
    call 01757h                               ; e8 2e a5
    jmp short 0723fh                          ; eb 14
    mov bx, ax                                ; 89 c3
    ...
    mov dx, 0009ch                            ; ba 9c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01793h                               ; e8 54 a5
    call 0e030h                               ; e8 ee 6d
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
    outsw                                     ; 6f
    jc short 071e3h                           ; 72 98
    jc short 0720ah                           ; 72 bd
    jc short 0723eh                           ; 72 ef
    jc short 0728fh                           ; 72 3e
    jnc short 072c9h                          ; 73 76
    jnc short 0720eh                          ; 73 b9
    jnc short 07267h                          ; 73 10
    db  074h
_int1a_function:                             ; 0xf7258 LB 0x1c8
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    sti                                       ; fb
    mov al, byte [bp+013h]                    ; 8a 46 13
    cmp AL, strict byte 007h                  ; 3c 07
    jnbe near 07294h                          ; 0f 87 2f 00
    movzx bx, al                              ; 0f b6 d8
    add bx, bx                                ; 01 db
    jmp word [cs:bx+07248h]                   ; 2e ff a7 48 72
    cli                                       ; fa
    ...
    sti                                       ; fb
    mov byte [bp+013h], 000h                  ; c6 46 13 00
    jmp short 07294h                          ; eb d7
    call 07179h                               ; e8 b9 fe
    test ax, ax                               ; 85 c0
    je short 072c6h                           ; 74 02
    jmp short 07294h                          ; eb ce
    xor ax, ax                                ; 31 c0
    call 017a5h                               ; e8 da a4
    mov byte [bp+00fh], al                    ; 88 46 0f
    mov ax, strict word 00002h                ; b8 02 00
    call 017a5h                               ; e8 d1 a4
    mov byte [bp+010h], al                    ; 88 46 10
    mov ax, strict word 00004h                ; b8 04 00
    call 017a5h                               ; e8 c8 a4
    mov bl, al                                ; 88 c3
    mov byte [bp+011h], al                    ; 88 46 11
    mov ax, strict word 0000bh                ; b8 0b 00
    call 017a5h                               ; e8 bd a4
    and AL, strict byte 001h                  ; 24 01
    mov byte [bp+00eh], al                    ; 88 46 0e
    jmp short 07334h                          ; eb 45
    call 07179h                               ; e8 87 fe
    test ax, ax                               ; 85 c0
    je short 072f9h                           ; 74 03
    call 07151h                               ; e8 58 fe
    movzx dx, byte [bp+00fh]                  ; 0f b6 56 0f
    xor ax, ax                                ; 31 c0
    call 017c2h                               ; e8 c0 a4
    movzx dx, byte [bp+010h]                  ; 0f b6 56 10
    mov ax, strict word 00002h                ; b8 02 00
    call 017c2h                               ; e8 b6 a4
    movzx dx, byte [bp+011h]                  ; 0f b6 56 11
    mov ax, strict word 00004h                ; b8 04 00
    call 017c2h                               ; e8 ac a4
    mov ax, strict word 0000bh                ; b8 0b 00
    call 017a5h                               ; e8 89 a4
    mov bl, al                                ; 88 c3
    ...
    movzx dx, bl                              ; 0f b6 d3
    mov ax, strict word 0000bh                ; b8 0b 00
    call 017c2h                               ; e8 8e a4
    mov byte [bp+013h], 000h                  ; c6 46 13 00
    mov byte [bp+012h], bl                    ; 88 5e 12
    jmp near 07294h                           ; e9 56 ff
    mov byte [bp+013h], 000h                  ; c6 46 13 00
    call 07179h                               ; e8 34 fe
    test ax, ax                               ; 85 c0
    je short 0734ch                           ; 74 03
    jmp near 07294h                           ; e9 48 ff
    mov ax, strict word 00009h                ; b8 09 00
    call 017a5h                               ; e8 53 a4
    mov byte [bp+010h], al                    ; 88 46 10
    mov ax, strict word 00008h                ; b8 08 00
    call 017a5h                               ; e8 4a a4
    mov byte [bp+00fh], al                    ; 88 46 0f
    mov ax, strict word 00007h                ; b8 07 00
    call 017a5h                               ; e8 41 a4
    mov byte [bp+00eh], al                    ; 88 46 0e
    mov ax, strict word 00032h                ; b8 32 00
    call 017a5h                               ; e8 38 a4
    mov byte [bp+011h], al                    ; 88 46 11
    mov byte [bp+012h], al                    ; 88 46 12
    jmp near 07294h                           ; e9 1e ff
    call 07179h                               ; e8 00 fe
    test ax, ax                               ; 85 c0
    je short 07383h                           ; 74 06
    call 07151h                               ; e8 d1 fd
    jmp near 07294h                           ; e9 11 ff
    movzx dx, byte [bp+010h]                  ; 0f b6 56 10
    mov ax, strict word 00009h                ; b8 09 00
    call 017c2h                               ; e8 35 a4
    movzx dx, byte [bp+00fh]                  ; 0f b6 56 0f
    mov ax, strict word 00008h                ; b8 08 00
    call 017c2h                               ; e8 2b a4
    movzx dx, byte [bp+00eh]                  ; 0f b6 56 0e
    mov ax, strict word 00007h                ; b8 07 00
    call 017c2h                               ; e8 21 a4
    movzx dx, byte [bp+011h]                  ; 0f b6 56 11
    mov ax, strict word 00032h                ; b8 32 00
    call 017c2h                               ; e8 17 a4
    mov ax, strict word 0000bh                ; b8 0b 00
    call 017a5h                               ; e8 f4 a3
    mov bl, al                                ; 88 c3
    and bl, 07fh                              ; 80 e3 7f
    jmp near 0732bh                           ; e9 72 ff
    mov ax, strict word 0000bh                ; b8 0b 00
    call 017a5h                               ; e8 e6 a3
    mov bl, al                                ; 88 c3
    mov word [bp+012h], strict word 00000h    ; c7 46 12 00 00
    test AL, strict byte 020h                 ; a8 20
    je short 073cdh                           ; 74 03
    jmp near 07294h                           ; e9 c7 fe
    call 07179h                               ; e8 a9 fd
    test ax, ax                               ; 85 c0
    je short 073d7h                           ; 74 03
    call 07151h                               ; e8 7a fd
    movzx dx, byte [bp+00fh]                  ; 0f b6 56 0f
    mov ax, strict word 00001h                ; b8 01 00
    call 017c2h                               ; e8 e1 a3
    movzx dx, byte [bp+010h]                  ; 0f b6 56 10
    mov ax, strict word 00003h                ; b8 03 00
    call 017c2h                               ; e8 d7 a3
    movzx dx, byte [bp+011h]                  ; 0f b6 56 11
    mov ax, strict word 00005h                ; b8 05 00
    call 017c2h                               ; e8 cd a3
    mov dx, 000a1h                            ; ba a1 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    jmp near 07294h                           ; e9 84 fe
    mov ax, strict word 0000bh                ; b8 0b 00
    call 017a5h                               ; e8 8f a3
    mov bl, al                                ; 88 c3
    and AL, strict byte 057h                  ; 24 57
    movzx dx, al                              ; 0f b6 d0
    jmp near 0732eh                           ; e9 0e ff
send_to_mouse_ctrl_:                         ; 0xf7420 LB 0x34
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push dx                                   ; 52
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 002h                 ; a8 02
    je short 0743fh                           ; 74 0e
    push 00900h                               ; 68 00 09
    push 0117ah                               ; 68 7a 11
    push strict byte 00007h                   ; 6a 07
    call 01a6bh                               ; e8 2f a6
    add sp, strict byte 00006h                ; 83 c4 06
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
get_mouse_data_:                             ; 0xf7454 LB 0x5c
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    je short 07496h                           ; 74 27
    test cx, cx                               ; 85 c9
    je short 07496h                           ; 74 23
    mov dx, strict word 00061h                ; ba 61 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    movzx ax, byte [bp-006h]                  ; 0f b6 46 fa
    cmp dx, ax                                ; 39 c2
    je short 0747eh                           ; 74 eb
    dec cx                                    ; 49
    jmp short 07461h                          ; eb cb
    test cx, cx                               ; 85 c9
    jne short 0749eh                          ; 75 04
    mov AL, strict byte 001h                  ; b0 01
    jmp short 074a9h                          ; eb 0b
    mov dx, strict word 00060h                ; ba 60 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
set_kbd_command_byte_:                       ; 0xf74b0 LB 0x32
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push dx                                   ; 52
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 002h                 ; a8 02
    je short 074cfh                           ; 74 0e
    push 0090ah                               ; 68 0a 09
    push 0117ah                               ; 68 7a 11
    push strict byte 00007h                   ; 6a 07
    call 01a6bh                               ; e8 9f a5
    add sp, strict byte 00006h                ; 83 c4 06
    mov AL, strict byte 060h                  ; b0 60
    mov dx, strict word 00064h                ; ba 64 00
    out DX, AL                                ; ee
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
_int74_function:                             ; 0xf74e2 LB 0xca
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    sub sp, strict byte 00008h                ; 83 ec 08
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01765h                               ; e8 74 a2
    mov cx, ax                                ; 89 c1
    mov word [bp+004h], strict word 00000h    ; c7 46 04 00 00
    mov dx, strict word 00064h                ; ba 64 00
    in AL, DX                                 ; ec
    ...
    mov dx, strict word 00026h                ; ba 26 00
    mov ax, cx                                ; 89 c8
    call 01749h                               ; e8 33 a2
    mov byte [bp-006h], al                    ; 88 46 fa
    mov dx, strict word 00027h                ; ba 27 00
    mov ax, cx                                ; 89 c8
    call 01749h                               ; e8 28 a2
    mov byte [bp-008h], al                    ; 88 46 f8
    test AL, strict byte 080h                 ; a8 80
    je short 07598h                           ; 74 70
    mov al, byte [bp-008h]                    ; 8a 46 f8
    and AL, strict byte 007h                  ; 24 07
    mov byte [bp-002h], al                    ; 88 46 fe
    mov al, byte [bp-006h]                    ; 8a 46 fa
    ...
    je short 0758ch                           ; 74 0a
    mov word [bp+004h], strict word 00001h    ; c7 46 04 01 00
    jmp short 0758ch                          ; eb 03
    inc byte [bp-006h]                        ; fe 46 fa
    movzx bx, byte [bp-006h]                  ; 0f b6 5e fa
    mov dx, strict word 00026h                ; ba 26 00
    mov ax, cx                                ; 89 c8
    call 01757h                               ; e8 bf a1
    mov sp, bp                                ; 89 ec
    pop bp                                    ; 5d
    retn                                      ; c3
    db  0f0h, 075h, 066h, 076h, 0e9h, 076h, 07ah, 077h, 0e8h, 077h, 03ch, 076h, 010h, 078h, 0d5h, 078h
_int15_function_mouse:                       ; 0xf75ac LB 0x38b
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    sub sp, strict byte 00006h                ; 83 ec 06
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01765h                               ; e8 a9 a1
    mov cx, ax                                ; 89 c1
    cmp byte [bp+012h], 007h                  ; 80 7e 12 07
    jbe short 075cfh                          ; 76 0b
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 001h                  ; c6 46 13 01
    jmp near 07931h                           ; e9 62 03
    mov ax, strict word 00065h                ; b8 65 00
    call 074b0h                               ; e8 db fe
    and word [bp+018h], strict byte 0fffeh    ; 83 66 18 fe
    mov byte [bp+013h], 000h                  ; c6 46 13 00
    mov al, byte [bp+012h]                    ; 8a 46 12
    cmp AL, strict byte 007h                  ; 3c 07
    jnbe near 07918h                          ; 0f 87 32 03
    movzx si, al                              ; 0f b6 f0
    add si, si                                ; 01 f6
    jmp word [cs:si+0759ch]                   ; 2e ff a4 9c 75
    cmp byte [bp+00dh], 001h                  ; 80 7e 0d 01
    jnbe near 07923h                          ; 0f 87 2b 03
    mov dx, strict word 00027h                ; ba 27 00
    mov ax, cx                                ; 89 c8
    call 01749h                               ; e8 49 a1
    test AL, strict byte 080h                 ; a8 80
    jne short 0760fh                          ; 75 0b
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 005h                  ; c6 46 13 05
    jmp near 0792bh                           ; e9 1c 03
    cmp byte [bp+00dh], 000h                  ; 80 7e 0d 00
    db  00fh, 094h, 0c0h
    ; sete al                                   ; 0f 94 c0
    add AL, strict byte 0f4h                  ; 04 f4
    xor ah, ah                                ; 30 e4
    call 07420h                               ; e8 03 fe
    test al, al                               ; 84 c0
    jne near 078b1h                           ; 0f 85 8e 02
    mov dx, ss                                ; 8c d2
    lea ax, [bp-008h]                         ; 8d 46 f8
    call 07454h                               ; e8 29 fe
    test al, al                               ; 84 c0
    je near 0792bh                            ; 0f 84 fa 02
    cmp byte [bp-008h], 0fah                  ; 80 7e f8 fa
    jne near 078b1h                           ; 0f 85 78 02
    jmp near 0792bh                           ; e9 ef 02
    mov al, byte [bp+00dh]                    ; 8a 46 0d
    cmp AL, strict byte 001h                  ; 3c 01
    jc short 07647h                           ; 72 04
    cmp AL, strict byte 008h                  ; 3c 08
    jbe short 0764ah                          ; 76 03
    jmp near 077ddh                           ; e9 93 01
    mov dx, strict word 00027h                ; ba 27 00
    mov ax, cx                                ; 89 c8
    call 01749h                               ; e8 f7 a0
    ...
    mov dx, strict word 00027h                ; ba 27 00
    mov ax, cx                                ; 89 c8
    call 01757h                               ; e8 f1 a0
    mov dx, strict word 00026h                ; ba 26 00
    mov ax, cx                                ; 89 c8
    call 01749h                               ; e8 db a0
    and AL, strict byte 0f8h                  ; 24 f8
    movzx bx, al                              ; 0f b6 d8
    mov dx, strict word 00026h                ; ba 26 00
    mov ax, cx                                ; 89 c8
    call 01757h                               ; e8 dc a0
    mov ax, 000ffh                            ; b8 ff 00
    call 07420h                               ; e8 9f fd
    test al, al                               ; 84 c0
    jne near 078b1h                           ; 0f 85 2a 02
    mov dx, ss                                ; 8c d2
    lea ax, [bp-004h]                         ; 8d 46 fc
    call 07454h                               ; e8 c5 fd
    mov cl, al                                ; 88 c1
    cmp byte [bp-004h], 0feh                  ; 80 7e fc fe
    jne short 076a2h                          ; 75 0b
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 004h                  ; c6 46 13 04
    jmp near 0792bh                           ; e9 89 02
    cmp byte [bp-004h], 0fah                  ; 80 7e fc fa
    je short 076b8h                           ; 74 10
    movzx ax, byte [bp-004h]                  ; 0f b6 46 fc
    push ax                                   ; 50
    push 00915h                               ; 68 15 09
    push strict byte 00007h                   ; 6a 07
    call 01a6bh                               ; e8 b6 a3
    add sp, strict byte 00006h                ; 83 c4 06
    test cl, cl                               ; 84 c9
    jne near 078b1h                           ; 0f 85 f3 01
    mov dx, ss                                ; 8c d2
    lea ax, [bp-008h]                         ; 8d 46 f8
    call 07454h                               ; e8 8e fd
    test al, al                               ; 84 c0
    jne near 078b1h                           ; 0f 85 e5 01
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 07454h                               ; e8 80 fd
    test al, al                               ; 84 c0
    jne near 078b1h                           ; 0f 85 d7 01
    mov al, byte [bp-008h]                    ; 8a 46 f8
    mov byte [bp+00ch], al                    ; 88 46 0c
    mov al, byte [bp-006h]                    ; 8a 46 fa
    mov byte [bp+00dh], al                    ; 88 46 0d
    jmp near 0792bh                           ; e9 42 02
    mov al, byte [bp+00dh]                    ; 8a 46 0d
    cmp AL, strict byte 003h                  ; 3c 03
    jc short 07700h                           ; 72 10
    jbe short 0771eh                          ; 76 2c
    cmp AL, strict byte 006h                  ; 3c 06
    je short 07730h                           ; 74 3a
    cmp AL, strict byte 005h                  ; 3c 05
    je short 0772ah                           ; 74 30
    cmp AL, strict byte 004h                  ; 3c 04
    je short 07724h                           ; 74 26
    jmp short 07736h                          ; eb 36
    cmp AL, strict byte 002h                  ; 3c 02
    je short 07718h                           ; 74 14
    cmp AL, strict byte 001h                  ; 3c 01
    je short 07712h                           ; 74 0a
    test al, al                               ; 84 c0
    jne short 07736h                          ; 75 2a
    mov byte [bp-008h], 00ah                  ; c6 46 f8 0a
    jmp short 0773ah                          ; eb 28
    mov byte [bp-008h], 014h                  ; c6 46 f8 14
    jmp short 0773ah                          ; eb 22
    mov byte [bp-008h], 028h                  ; c6 46 f8 28
    jmp short 0773ah                          ; eb 1c
    mov byte [bp-008h], 03ch                  ; c6 46 f8 3c
    jmp short 0773ah                          ; eb 16
    mov byte [bp-008h], 050h                  ; c6 46 f8 50
    jmp short 0773ah                          ; eb 10
    mov byte [bp-008h], 064h                  ; c6 46 f8 64
    jmp short 0773ah                          ; eb 0a
    mov byte [bp-008h], 0c8h                  ; c6 46 f8 c8
    jmp short 0773ah                          ; eb 04
    mov byte [bp-008h], 000h                  ; c6 46 f8 00
    cmp byte [bp-008h], 000h                  ; 80 7e f8 00
    jbe short 0776fh                          ; 76 2f
    mov ax, 000f3h                            ; b8 f3 00
    call 07420h                               ; e8 da fc
    test al, al                               ; 84 c0
    jne short 07764h                          ; 75 1a
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 07454h                               ; e8 02 fd
    movzx ax, byte [bp-008h]                  ; 0f b6 46 f8
    call 07420h                               ; e8 c7 fc
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 07454h                               ; e8 f3 fc
    jmp near 0792bh                           ; e9 c7 01
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 003h                  ; c6 46 13 03
    jmp near 0792bh                           ; e9 bc 01
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 002h                  ; c6 46 13 02
    jmp near 0792bh                           ; e9 b1 01
    cmp byte [bp+00dh], 004h                  ; 80 7e 0d 04
    jnc short 077ddh                          ; 73 5d
    mov ax, 000e8h                            ; b8 e8 00
    call 07420h                               ; e8 9a fc
    test al, al                               ; 84 c0
    jne short 077d2h                          ; 75 48
    mov dx, ss                                ; 8c d2
    lea ax, [bp-008h]                         ; 8d 46 f8
    call 07454h                               ; e8 c2 fc
    cmp byte [bp-008h], 0fah                  ; 80 7e f8 fa
    je short 077a8h                           ; 74 10
    movzx ax, byte [bp-008h]                  ; 0f b6 46 f8
    push ax                                   ; 50
    push 00940h                               ; 68 40 09
    push strict byte 00007h                   ; 6a 07
    call 01a6bh                               ; e8 c6 a2
    add sp, strict byte 00006h                ; 83 c4 06
    movzx ax, byte [bp+00dh]                  ; 0f b6 46 0d
    call 07420h                               ; e8 71 fc
    mov dx, ss                                ; 8c d2
    lea ax, [bp-008h]                         ; 8d 46 f8
    call 07454h                               ; e8 9d fc
    cmp byte [bp-008h], 0fah                  ; 80 7e f8 fa
    je near 0792bh                            ; 0f 84 6c 01
    movzx ax, byte [bp-008h]                  ; 0f b6 46 f8
    push ax                                   ; 50
    push 00940h                               ; 68 40 09
    push strict byte 00007h                   ; 6a 07
    call 01a6bh                               ; e8 9f a2
    add sp, strict byte 00006h                ; 83 c4 06
    jmp near 0792bh                           ; e9 59 01
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 003h                  ; c6 46 13 03
    jmp near 0792bh                           ; e9 4e 01
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 002h                  ; c6 46 13 02
    jmp near 0792bh                           ; e9 43 01
    mov ax, 000f2h                            ; b8 f2 00
    call 07420h                               ; e8 32 fc
    test al, al                               ; 84 c0
    jne short 07805h                          ; 75 13
    mov dx, ss                                ; 8c d2
    lea ax, [bp-008h]                         ; 8d 46 f8
    call 07454h                               ; e8 5a fc
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 07454h                               ; e8 52 fc
    jmp near 076e0h                           ; e9 db fe
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 003h                  ; c6 46 13 03
    jmp near 0792bh                           ; e9 1b 01
    mov al, byte [bp+00dh]                    ; 8a 46 0d
    test al, al                               ; 84 c0
    jbe short 0781eh                          ; 76 07
    cmp AL, strict byte 002h                  ; 3c 02
    jbe short 07887h                          ; 76 6c
    jmp near 078bbh                           ; e9 9d 00
    mov ax, 000e9h                            ; b8 e9 00
    call 07420h                               ; e8 fc fb
    test al, al                               ; 84 c0
    jne near 078b1h                           ; 0f 85 87 00
    mov dx, ss                                ; 8c d2
    lea ax, [bp-008h]                         ; 8d 46 f8
    call 07454h                               ; e8 22 fc
    mov cl, al                                ; 88 c1
    cmp byte [bp-008h], 0fah                  ; 80 7e f8 fa
    je short 0784ah                           ; 74 10
    movzx ax, byte [bp-008h]                  ; 0f b6 46 f8
    push ax                                   ; 50
    push 00940h                               ; 68 40 09
    push strict byte 00007h                   ; 6a 07
    call 01a6bh                               ; e8 24 a2
    add sp, strict byte 00006h                ; 83 c4 06
    test cl, cl                               ; 84 c9
    jne short 078b1h                          ; 75 63
    mov dx, ss                                ; 8c d2
    lea ax, [bp-008h]                         ; 8d 46 f8
    call 07454h                               ; e8 fe fb
    test al, al                               ; 84 c0
    jne short 078b1h                          ; 75 57
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 07454h                               ; e8 f2 fb
    test al, al                               ; 84 c0
    jne short 078b1h                          ; 75 4b
    mov dx, ss                                ; 8c d2
    lea ax, [bp-004h]                         ; 8d 46 fc
    call 07454h                               ; e8 e6 fb
    test al, al                               ; 84 c0
    jne short 078b1h                          ; 75 3f
    mov al, byte [bp-008h]                    ; 8a 46 f8
    mov byte [bp+00ch], al                    ; 88 46 0c
    mov al, byte [bp-006h]                    ; 8a 46 fa
    mov byte [bp+010h], al                    ; 88 46 10
    mov al, byte [bp-004h]                    ; 8a 46 fc
    mov byte [bp+00eh], al                    ; 88 46 0e
    jmp near 0792bh                           ; e9 a4 00
    cmp AL, strict byte 001h                  ; 3c 01
    jne short 07890h                          ; 75 05
    mov ax, 000e6h                            ; b8 e6 00
    jmp short 07893h                          ; eb 03
    mov ax, 000e7h                            ; b8 e7 00
    call 07420h                               ; e8 8a fb
    mov cl, al                                ; 88 c1
    test cl, cl                               ; 84 c9
    jne short 078abh                          ; 75 0f
    mov dx, ss                                ; 8c d2
    lea ax, [bp-008h]                         ; 8d 46 f8
    call 07454h                               ; e8 b0 fb
    cmp byte [bp-008h], 0fah                  ; 80 7e f8 fa
    db  00fh, 095h, 0c1h
    ; setne cl                                  ; 0f 95 c1
    test cl, cl                               ; 84 c9
    je near 0792bh                            ; 0f 84 7a 00
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 003h                  ; c6 46 13 03
    jmp short 0792bh                          ; eb 70
    movzx ax, byte [bp+00dh]                  ; 0f b6 46 0d
    push ax                                   ; 50
    push 0096ch                               ; 68 6c 09
    push strict byte 00007h                   ; 6a 07
    call 01a6bh                               ; e8 a3 a1
    add sp, strict byte 00006h                ; 83 c4 06
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 001h                  ; c6 46 13 01
    jmp short 0792bh                          ; eb 56
    mov si, word [bp+00ch]                    ; 8b 76 0c
    mov bx, si                                ; 89 f3
    mov dx, strict word 00022h                ; ba 22 00
    mov ax, cx                                ; 89 c8
    call 01773h                               ; e8 91 9e
    mov bx, word [bp+014h]                    ; 8b 5e 14
    mov dx, strict word 00024h                ; ba 24 00
    mov ax, cx                                ; 89 c8
    call 01773h                               ; e8 86 9e
    mov dx, strict word 00027h                ; ba 27 00
    mov ax, cx                                ; 89 c8
    call 01749h                               ; e8 54 9e
    mov ah, al                                ; 88 c4
    test si, si                               ; 85 f6
    jne short 07909h                          ; 75 0e
    cmp word [bp+014h], strict byte 00000h    ; 83 7e 14 00
    jne short 07909h                          ; 75 08
    test AL, strict byte 080h                 ; a8 80
    je short 0790bh                           ; 74 06
    and AL, strict byte 07fh                  ; 24 7f
    jmp short 0790bh                          ; eb 02
    or AL, strict byte 080h                   ; 0c 80
    movzx bx, al                              ; 0f b6 d8
    mov dx, strict word 00027h                ; ba 27 00
    mov ax, cx                                ; 89 c8
    call 01757h                               ; e8 41 9e
    jmp short 0792bh                          ; eb 13
    push 00986h                               ; 68 86 09
    push strict byte 00007h                   ; 6a 07
    call 01a6bh                               ; e8 4b a1
    add sp, strict byte 00004h                ; 83 c4 04
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 001h                  ; c6 46 13 01
    mov ax, strict word 00047h                ; b8 47 00
    call 074b0h                               ; e8 7f fb
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
_int17_function:                             ; 0xf7937 LB 0xb3
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push ax                                   ; 50
    ...
    add dx, strict byte 00008h                ; 83 c2 08
    mov ax, strict word 00040h                ; b8 40 00
    call 01765h                               ; e8 1a 9e
    mov bx, ax                                ; 89 c3
    mov si, ax                                ; 89 c6
    cmp byte [bp+013h], 003h                  ; 80 7e 13 03
    jnc near 079e0h                           ; 0f 83 89 00
    mov ax, word [bp+00eh]                    ; 8b 46 0e
    cmp ax, strict word 00003h                ; 3d 03 00
    jnc near 079e0h                           ; 0f 83 7f 00
    test bx, bx                               ; 85 db
    jbe near 079e0h                           ; 0f 86 79 00
    mov dx, ax                                ; 89 c2
    add dx, strict byte 00078h                ; 83 c2 78
    mov ax, strict word 00040h                ; b8 40 00
    call 01749h                               ; e8 d7 9d
    movzx cx, al                              ; 0f b6 c8
    sal cx, 008h                              ; c1 e1 08
    cmp byte [bp+013h], 000h                  ; 80 7e 13 00
    jne short 079abh                          ; 75 2d
    mov al, byte [bp+012h]                    ; 8a 46 12
    mov dx, bx                                ; 89 da
    out DX, AL                                ; ee
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 040h                 ; a8 40
    je short 079abh                           ; 74 07
    test cx, cx                               ; 85 c9
    je short 079abh                           ; 74 03
    dec cx                                    ; 49
    jmp short 0799ah                          ; eb ef
    cmp byte [bp+013h], 001h                  ; 80 7e 13 01
    jne short 079c7h                          ; 75 16
    lea dx, [si+002h]                         ; 8d 54 02
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    mov byte [bp+013h], al                    ; 88 46 13
    test cx, cx                               ; 85 c9
    jne short 079dah                          ; 75 04
    or byte [bp+013h], 001h                   ; 80 4e 13 01
    and byte [bp+01ch], 0feh                  ; 80 66 1c fe
    jmp short 079e4h                          ; eb 04
    or byte [bp+01ch], 001h                   ; 80 4e 1c 01
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
wait_:                                       ; 0xf79ea LB 0xb2
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    xor ax, ax                                ; 31 c0
    call 01781h                               ; e8 74 9d
    mov word [bp-00eh], ax                    ; 89 46 f2
    mov bx, dx                                ; 89 d3
    hlt                                       ; f4
    mov dx, 0046ch                            ; ba 6c 04
    xor ax, ax                                ; 31 c0
    call 01781h                               ; e8 66 9d
    mov word [bp-012h], ax                    ; 89 46 ee
    mov di, dx                                ; 89 d7
    cmp dx, bx                                ; 39 da
    jnbe short 07a2bh                         ; 77 07
    jne short 07a32h                          ; 75 0c
    cmp ax, word [bp-00eh]                    ; 3b 46 f2
    jbe short 07a32h                          ; 76 07
    sub ax, word [bp-00eh]                    ; 2b 46 f2
    sbb dx, bx                                ; 19 da
    jmp short 07a3dh                          ; eb 0b
    cmp dx, bx                                ; 39 da
    jc short 07a3dh                           ; 72 07
    jne short 07a41h                          ; 75 09
    cmp ax, word [bp-00eh]                    ; 3b 46 f2
    jnc short 07a41h                          ; 73 04
    sub si, ax                                ; 29 c6
    sbb cx, dx                                ; 19 d1
    mov ax, word [bp-012h]                    ; 8b 46 ee
    mov word [bp-00eh], ax                    ; 89 46 f2
    ...
    int 016h                                  ; cd 16
    je near 07a57h                            ; 0f 84 05 00
    mov AL, strict byte 001h                  ; b0 01
    jmp near 07a59h                           ; e9 02 00
    db  032h, 0c0h
    ; xor al, al                                ; 32 c0
    test al, al                               ; 84 c0
    je short 07a81h                           ; 74 24
    db  033h, 0c0h
    ; xor ax, ax                                ; 33 c0
    int 016h                                  ; cd 16
    xchg ah, al                               ; 86 c4
    ...
    push strict byte 00004h                   ; 6a 04
    call 01a6bh                               ; e8 f7 9f
    add sp, strict byte 00006h                ; 83 c4 06
    cmp byte [bp-00ch], 000h                  ; 80 7e f4 00
    je short 07a81h                           ; 74 04
    mov al, dl                                ; 88 d0
    jmp short 07a93h                          ; eb 12
    test cx, cx                               ; 85 c9
    jnle short 07a12h                         ; 7f 8d
    jne short 07a8bh                          ; 75 04
    test si, si                               ; 85 f6
    jnbe short 07a12h                         ; 77 87
    mov ax, word [bp-010h]                    ; 8b 46 f0
    push ax                                   ; 50
    popfw                                     ; 9d
    mov al, byte [bp-00ah]                    ; 8a 46 f6
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
read_logo_byte_:                             ; 0xf7a9c LB 0x16
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push dx                                   ; 52
    xor ah, ah                                ; 30 e4
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
read_logo_word_:                             ; 0xf7ab2 LB 0x14
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push dx                                   ; 52
    xor ah, ah                                ; 30 e4
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
print_detected_harddisks_:                   ; 0xf7ac6 LB 0x130
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01765h                               ; e8 8c 9c
    mov si, ax                                ; 89 c6
    mov byte [bp-00ch], 000h                  ; c6 46 f4 00
    xor cl, cl                                ; 30 c9
    xor ch, ch                                ; 30 ed
    mov dx, 00304h                            ; ba 04 03
    call 01749h                               ; e8 60 9c
    mov byte [bp-00eh], al                    ; 88 46 f2
    xor bl, bl                                ; 30 db
    cmp bl, byte [bp-00eh]                    ; 3a 5e f2
    jnc near 07bc8h                           ; 0f 83 d3 00
    movzx dx, bl                              ; 0f b6 d3
    add dx, 00305h                            ; 81 c2 05 03
    mov ax, si                                ; 89 f0
    call 01749h                               ; e8 48 9c
    mov bh, al                                ; 88 c7
    cmp AL, strict byte 00ch                  ; 3c 0c
    jc short 07b2bh                           ; 72 24
    test cl, cl                               ; 84 c9
    jne short 07b18h                          ; 75 0d
    push 009b9h                               ; 68 b9 09
    push strict byte 00002h                   ; 6a 02
    call 01a6bh                               ; e8 58 9f
    add sp, strict byte 00004h                ; 83 c4 04
    mov CL, strict byte 001h                  ; b1 01
    movzx ax, bl                              ; 0f b6 c3
    inc ax                                    ; 40
    ...
    push strict byte 00002h                   ; 6a 02
    call 01a6bh                               ; e8 46 9f
    add sp, strict byte 00006h                ; 83 c4 06
    jmp near 07bc3h                           ; e9 98 00
    cmp AL, strict byte 008h                  ; 3c 08
    jc short 07b42h                           ; 72 13
    test ch, ch                               ; 84 ed
    jne short 07b40h                          ; 75 0d
    push 009e1h                               ; 68 e1 09
    push strict byte 00002h                   ; 6a 02
    call 01a6bh                               ; e8 30 9f
    add sp, strict byte 00004h                ; 83 c4 04
    mov CH, strict byte 001h                  ; b5 01
    jmp short 07b18h                          ; eb d6
    cmp AL, strict byte 004h                  ; 3c 04
    jnc short 07b5dh                          ; 73 17
    cmp byte [bp-00ch], 000h                  ; 80 7e f4 00
    jne short 07b5dh                          ; 75 11
    push 009f6h                               ; 68 f6 09
    push strict byte 00002h                   ; 6a 02
    call 01a6bh                               ; e8 17 9f
    add sp, strict byte 00004h                ; 83 c4 04
    mov byte [bp-00ch], 001h                  ; c6 46 f4 01
    jmp short 07b73h                          ; eb 16
    cmp bh, 004h                              ; 80 ff 04
    jc short 07b73h                           ; 72 11
    test cl, cl                               ; 84 c9
    jne short 07b73h                          ; 75 0d
    push 00a08h                               ; 68 08 0a
    push strict byte 00002h                   ; 6a 02
    call 01a6bh                               ; e8 fd 9e
    add sp, strict byte 00004h                ; 83 c4 04
    mov CL, strict byte 001h                  ; b1 01
    movzx ax, bl                              ; 0f b6 c3
    inc ax                                    ; 40
    ...
    push strict byte 00002h                   ; 6a 02
    call 01a6bh                               ; e8 eb 9e
    add sp, strict byte 00006h                ; 83 c4 06
    cmp bh, 004h                              ; 80 ff 04
    jc short 07b8bh                           ; 72 03
    ...
    sar ax, 1                                 ; d1 f8
    test ax, ax                               ; 85 c0
    je short 07b9ch                           ; 74 05
    push 00a26h                               ; 68 26 0a
    jmp short 07b9fh                          ; eb 03
    push 00a31h                               ; 68 31 0a
    push strict byte 00002h                   ; 6a 02
    call 01a6bh                               ; e8 c7 9e
    add sp, strict byte 00004h                ; 83 c4 04
    movzx ax, bh                              ; 0f b6 c7
    ...
    idiv di                                   ; f7 ff
    test dx, dx                               ; 85 d2
    je short 07bb9h                           ; 74 05
    push 00a3ah                               ; 68 3a 0a
    jmp short 07bbch                          ; eb 03
    push 00a40h                               ; 68 40 0a
    push di                                   ; 57
    call 01a6bh                               ; e8 ab 9e
    add sp, strict byte 00004h                ; 83 c4 04
    db  0feh, 0c3h
    ; inc bl                                    ; fe c3
    jmp near 07aeeh                           ; e9 26 ff
    cmp byte [bp-00ch], 000h                  ; 80 7e f4 00
    jne short 07be1h                          ; 75 13
    test cl, cl                               ; 84 c9
    jne short 07be1h                          ; 75 0f
    test ch, ch                               ; 84 ed
    jne short 07be1h                          ; 75 0b
    push 00a47h                               ; 68 47 0a
    push strict byte 00002h                   ; 6a 02
    call 01a6bh                               ; e8 8d 9e
    add sp, strict byte 00004h                ; 83 c4 04
    push 00a5bh                               ; 68 5b 0a
    push strict byte 00002h                   ; 6a 02
    call 01a6bh                               ; e8 82 9e
    add sp, strict byte 00004h                ; 83 c4 04
    lea sp, [bp-00ah]                         ; 8d 66 f6
    pop di                                    ; 5f
    pop si                                    ; 5e
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
get_boot_drive_:                             ; 0xf7bf6 LB 0x28
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push dx                                   ; 52
    ...
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01765h                               ; e8 5f 9b
    mov dx, 00304h                            ; ba 04 03
    call 01749h                               ; e8 3d 9b
    sub bl, 002h                              ; 80 eb 02
    cmp bl, al                                ; 38 c3
    jc short 07c15h                           ; 72 02
...
show_logo_:                                  ; 0xf7c1e LB 0x231
    ...
    out strict byte 040h, AL                  ; e6 40
    movzx ax, dl                              ; 0f b6 c2
    call 07ab2h                               ; e8 68 fe
    cmp ax, 066bbh                            ; 3d bb 66
    jne near 07d2fh                           ; 0f 85 de 00
    push SS                                   ; 16
    pop ES                                    ; 07
    ...
    jne near 07d2fh                           ; 0f 85 ca 00
    mov al, dl                                ; 88 d0
    add AL, strict byte 004h                  ; 04 04
    xor ah, ah                                ; 30 e4
    call 07a9ch                               ; e8 2e fe
    mov ch, al                                ; 88 c5
    mov byte [bp-00ch], al                    ; 88 46 f4
    mov al, dl                                ; 88 d0
    add AL, strict byte 005h                  ; 04 05
    xor ah, ah                                ; 30 e4
    call 07a9ch                               ; e8 20 fe
    mov dh, al                                ; 88 c6
    mov byte [bp-010h], al                    ; 88 46 f0
    mov al, dl                                ; 88 d0
    add AL, strict byte 002h                  ; 04 02
    xor ah, ah                                ; 30 e4
    call 07ab2h                               ; e8 28 fe
    mov bx, ax                                ; 89 c3
    mov word [bp-014h], ax                    ; 89 46 ec
    mov al, dl                                ; 88 d0
    add AL, strict byte 006h                  ; 04 06
    xor ah, ah                                ; 30 e4
    call 07a9ch                               ; e8 04 fe
    mov byte [bp-012h], al                    ; 88 46 ee
    test ch, ch                               ; 84 ed
    jne short 07ca9h                          ; 75 0a
    test dh, dh                               ; 84 f6
    jne short 07ca9h                          ; 75 06
    test bx, bx                               ; 85 db
    je near 07d2fh                            ; 0f 84 86 00
    mov bx, 00142h                            ; bb 42 01
    mov ax, 04f02h                            ; b8 02 4f
    int 010h                                  ; cd 10
    cmp byte [bp-00ch], 000h                  ; 80 7e f4 00
    je short 07cdah                           ; 74 23
    xor bx, bx                                ; 31 db
    jmp short 07cc1h                          ; eb 06
    inc bx                                    ; 43
    cmp bx, strict byte 00010h                ; 83 fb 10
    jnbe short 07ce1h                         ; 77 20
    mov ax, bx                                ; 89 d8
    or ah, 002h                               ; 80 cc 02
    mov dx, 003b8h                            ; ba b8 03
    out DX, ax                                ; ef
    xor dx, dx                                ; 31 d2
    mov ax, strict word 00001h                ; b8 01 00
    call 079eah                               ; e8 18 fd
    cmp AL, strict byte 086h                  ; 3c 86
    jne short 07cbbh                          ; 75 e5
    mov CL, strict byte 001h                  ; b1 01
    jmp short 07ce1h                          ; eb 07
    mov ax, 00210h                            ; b8 10 02
    mov dx, 003b8h                            ; ba b8 03
    out DX, ax                                ; ef
    test cl, cl                               ; 84 c9
    jne short 07cf7h                          ; 75 12
    mov ax, word [bp-014h]                    ; 8b 46 ec
    shr ax, 004h                              ; c1 e8 04
    mov dx, strict word 00001h                ; ba 01 00
    call 079eah                               ; e8 f9 fc
    cmp AL, strict byte 086h                  ; 3c 86
    jne short 07cf7h                          ; 75 02
    mov CL, strict byte 001h                  ; b1 01
    cmp byte [bp-010h], 000h                  ; 80 7e f0 00
    je short 07d24h                           ; 74 27
    test cl, cl                               ; 84 c9
    jne short 07d24h                          ; 75 23
    mov bx, strict word 00010h                ; bb 10 00
    jmp short 07d0bh                          ; eb 05
    dec bx                                    ; 4b
    test bx, bx                               ; 85 db
    jbe short 07d2fh                          ; 76 24
    mov ax, bx                                ; 89 d8
    or ah, 002h                               ; 80 cc 02
    mov dx, 003b8h                            ; ba b8 03
    out DX, ax                                ; ef
    xor dx, dx                                ; 31 d2
    mov ax, strict word 00001h                ; b8 01 00
    call 079eah                               ; e8 ce fc
    cmp AL, strict byte 086h                  ; 3c 86
    jne short 07d06h                          ; 75 e6
    mov CL, strict byte 001h                  ; b1 01
    jmp short 07d2fh                          ; eb 0b
    test cl, cl                               ; 84 c9
    jne short 07d2fh                          ; 75 07
    ...
    mov dx, 0037dh                            ; ba 7d 03
    mov ax, si                                ; 89 f0
    call 01757h                               ; e8 1e 9a
    mov AL, strict byte 003h                  ; b0 03
    mov AH, strict byte 000h                  ; b4 00
    int 010h                                  ; cd 10
    cmp byte [bp-012h], 000h                  ; 80 7e ee 00
    je near 07e30h                            ; 0f 84 e9 00
    cmp byte [bp-00ch], 000h                  ; 80 7e f4 00
    jne short 07d7dh                          ; 75 30
    cmp byte [bp-010h], 000h                  ; 80 7e f0 00
    jne short 07d7dh                          ; 75 2a
    cmp word [bp-014h], strict byte 00000h    ; 83 7e ec 00
    jne short 07d7dh                          ; 75 24
    cmp byte [bp-012h], 002h                  ; 80 7e ee 02
    jne short 07d6ah                          ; 75 0b
    push 00a5dh                               ; 68 5d 0a
    push strict byte 00002h                   ; 6a 02
    call 01a6bh                               ; e8 04 9d
    add sp, strict byte 00004h                ; 83 c4 04
    test cl, cl                               ; 84 c9
    jne short 07d7dh                          ; 75 0f
    mov dx, strict word 00001h                ; ba 01 00
    mov ax, 000c0h                            ; b8 c0 00
    call 079eah                               ; e8 73 fc
    cmp AL, strict byte 086h                  ; 3c 86
    jne short 07d7dh                          ; 75 02
    mov CL, strict byte 001h                  ; b1 01
    test cl, cl                               ; 84 c9
    je near 07e30h                            ; 0f 84 ad 00
    mov byte [bp-00eh], 000h                  ; c6 46 f2 00
    mov ax, 00100h                            ; b8 00 01
    ...
    push strict byte 00002h                   ; 6a 02
    call 01a6bh                               ; e8 bf 9c
    add sp, strict byte 00004h                ; 83 c4 04
    call 07ac6h                               ; e8 14 fd
    push 00ac3h                               ; 68 c3 0a
    push strict byte 00002h                   ; 6a 02
    call 01a6bh                               ; e8 b1 9c
    add sp, strict byte 00004h                ; 83 c4 04
    mov dx, strict word 00001h                ; ba 01 00
    mov ax, strict word 00040h                ; b8 40 00
    call 079eah                               ; e8 24 fc
    mov bl, al                                ; 88 c3
    test al, al                               ; 84 c0
    je short 07dbdh                           ; 74 f1
    cmp AL, strict byte 030h                  ; 3c 30
    je short 07e1eh                           ; 74 4e
    cmp bl, 002h                              ; 80 fb 02
    jc short 07df7h                           ; 72 22
    cmp bl, 009h                              ; 80 fb 09
    jnbe short 07df7h                         ; 77 1d
    movzx ax, bl                              ; 0f b6 c3
    call 07bf6h                               ; e8 16 fe
    cmp AL, strict byte 0ffh                  ; 3c ff
    jne short 07de6h                          ; 75 02
    jmp short 07dbdh                          ; eb d7
    movzx bx, al                              ; 0f b6 d8
    mov dx, 0037ch                            ; ba 7c 03
    mov ax, si                                ; 89 f0
    call 01757h                               ; e8 66 99
    mov byte [bp-00eh], 002h                  ; c6 46 f2 02
    jmp short 07e1eh                          ; eb 27
    cmp bl, 02eh                              ; 80 fb 2e
    je short 07e0ch                           ; 74 10
    cmp bl, 026h                              ; 80 fb 26
    je short 07e12h                           ; 74 11
    cmp bl, 021h                              ; 80 fb 21
    jne short 07e18h                          ; 75 12
    mov byte [bp-00eh], 001h                  ; c6 46 f2 01
    jmp short 07e1eh                          ; eb 12
    mov byte [bp-00eh], 003h                  ; c6 46 f2 03
    jmp short 07e1eh                          ; eb 0c
    mov byte [bp-00eh], 004h                  ; c6 46 f2 04
    jmp short 07e1eh                          ; eb 06
    cmp byte [bp-00eh], 000h                  ; 80 7e f2 00
    je short 07dbdh                           ; 74 9f
    movzx bx, byte [bp-00eh]                  ; 0f b6 5e f2
    mov dx, 0037dh                            ; ba 7d 03
    mov ax, si                                ; 89 f0
    call 01757h                               ; e8 2d 99
    mov AL, strict byte 003h                  ; b0 03
    mov AH, strict byte 000h                  ; b4 00
    int 010h                                  ; cd 10
    mov AL, strict byte 034h                  ; b0 34
...
delay_boot_:                                 ; 0xf7e4f LB 0x67
    ...
    push strict byte 00002h                   ; 6a 02
    call 01a6bh                               ; e8 fc 9b
    add sp, strict byte 00006h                ; 83 c4 06
    mov bx, dx                                ; 89 d3
    test bx, bx                               ; 85 db
    jbe short 07e8fh                          ; 76 17
    push bx                                   ; 53
    push 00b2bh                               ; 68 2b 0b
    push strict byte 00002h                   ; 6a 02
    call 01a6bh                               ; e8 ea 9b
    add sp, strict byte 00006h                ; 83 c4 06
    xor dx, dx                                ; 31 d2
    mov ax, strict word 00040h                ; b8 40 00
    call 079eah                               ; e8 5e fb
    dec bx                                    ; 4b
    jmp short 07e74h                          ; eb e5
    push 00a5bh                               ; 68 5b 0a
    push strict byte 00002h                   ; 6a 02
    call 01a6bh                               ; e8 d4 9b
    add sp, strict byte 00004h                ; 83 c4 04
    mov AL, strict byte 034h                  ; b0 34
    out strict byte 043h, AL                  ; e6 43
    db  033h, 0c0h
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
scsi_cmd_data_in_:                           ; 0xf7eb6 LB 0xd5
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 07ecch                          ; 75 f7
    cmp byte [bp+004h], 010h                  ; 80 7e 04 10
    jne short 07edfh                          ; 75 04
    xor ax, ax                                ; 31 c0
    jmp short 07ee3h                          ; eb 04
    movzx ax, byte [bp+004h]                  ; 0f b6 46 04
    mov di, ax                                ; 89 c7
    mov ax, bx                                ; 89 d8
    mov dx, word [bp+00ch]                    ; 8b 56 0c
    ...
    pop bp                                    ; 5d
    retn 0000ah                               ; c2 0a 00
scsi_cmd_data_out_:                          ; 0xf7f8b LB 0xd5
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    cmp byte [bp+004h], 010h                  ; 80 7e 04 10
    jne short 07fb4h                          ; 75 04
    xor ax, ax                                ; 31 c0
    jmp short 07fb8h                          ; eb 04
    movzx ax, byte [bp+004h]                  ; 0f b6 46 04
    mov si, ax                                ; 89 c6
    mov ax, bx                                ; 89 d8
    mov dx, word [bp+00ch]                    ; 8b 56 0c
    ...
    cmp word [bp+00ch], strict byte 00000h    ; 83 7e 0c 00
    jne short 08017h                          ; 75 06
    cmp bx, 08000h                            ; 81 fb 00 80
    jbe short 08032h                          ; 76 1b
    mov cx, 08000h                            ; b9 00 80
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 0803ah                          ; 75 f7
    test AL, strict byte 002h                 ; a8 02
    je short 08055h                           ; 74 0e
    ...
    pop bp                                    ; 5d
    retn 0000ah                               ; c2 0a 00
@scsi_read_sectors:                          ; 0xf8060 LB 0xdb
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov byte [bp-006h], al                    ; 88 46 fa
    cmp AL, strict byte 004h                  ; 3c 04
    jbe short 0808eh                          ; 76 13
    movzx ax, byte [bp-006h]                  ; 0f b6 46 fa
    push ax                                   ; 50
    push 00b30h                               ; 68 30 0b
    push 00b42h                               ; 68 42 0b
    push strict byte 00007h                   ; 6a 07
    call 01a6bh                               ; e8 e0 99
    add sp, strict byte 00008h                ; 83 c4 08
    mov es, [bp+006h]                         ; 8e 46 06
    mov di, word [es:si+00eh]                 ; 26 8b 7c 0e
    ...
    call 07eb6h                               ; e8 a2 fd
    mov ah, al                                ; 88 c4
    test al, al                               ; 84 c0
    jne short 0812fh                          ; 75 15
    mov es, [bp+006h]                         ; 8e 46 06
    ...
    pop bp                                    ; 5d
    retn 00004h                               ; c2 04 00
@scsi_write_sectors:                         ; 0xf813b LB 0xdb
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov byte [bp-006h], al                    ; 88 46 fa
    cmp AL, strict byte 004h                  ; 3c 04
    jbe short 08169h                          ; 76 13
    movzx ax, byte [bp-006h]                  ; 0f b6 46 fa
    push ax                                   ; 50
    push 00b61h                               ; 68 61 0b
    push 00b42h                               ; 68 42 0b
    push strict byte 00007h                   ; 6a 07
    call 01a6bh                               ; e8 05 99
    add sp, strict byte 00008h                ; 83 c4 08
    mov es, [bp+006h]                         ; 8e 46 06
    mov di, word [es:si+00eh]                 ; 26 8b 7c 0e
    ...
    mov cx, ss                                ; 8c d1
    lea bx, [bp-01ah]                         ; 8d 5e e6
    call 07f8bh                               ; e8 9c fd
    mov ah, al                                ; 88 c4
    test al, al                               ; 84 c0
    jne short 0820ah                          ; 75 15
    mov es, [bp+006h]                         ; 8e 46 06
    mov word [es:si+018h], di                 ; 26 89 7c 18
    mov dx, word [bp-00ah]                    ; 8b 56 f6
    mov word [es:si+01ah], dx                 ; 26 89 54 1a
    ...
    pop bp                                    ; 5d
    retn 00004h                               ; c2 04 00
scsi_cmd_packet_:                            ; 0xf8216 LB 0x166
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01765h                               ; e8 33 95
    mov si, 00122h                            ; be 22 01
    mov word [bp-00eh], ax                    ; 89 46 f2
    cmp byte [bp+00ah], 002h                  ; 80 7e 0a 02
    jne short 0825dh                          ; 75 1f
    mov bx, 00db2h                            ; bb b2 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01a2ah                               ; e8 e1 97
    push 00b74h                               ; 68 74 0b
    push 00b84h                               ; 68 84 0b
    push strict byte 00004h                   ; 6a 04
    call 01a6bh                               ; e8 17 98
    add sp, strict byte 00006h                ; 83 c4 06
    mov dx, strict word 00001h                ; ba 01 00
    jmp near 08371h                           ; e9 14 01
    ...
    out DX, AL                                ; ee
    inc cx                                    ; 41
    jmp short 082d6h                          ; eb ea
    mov dx, bx                                ; 89 da
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 082ech                          ; 75 f7
    test AL, strict byte 002h                 ; a8 02
    je short 08307h                           ; 74 0e
    lea dx, [bx+003h]                         ; 8d 57 03
    xor al, al                                ; 30 c0
    out DX, AL                                ; ee
    in AL, DX                                 ; ec
    ...
    ; sub ah, ah                                ; 2a e4
    mov dx, strict word 00003h                ; ba 03 00
    jmp short 08371h                          ; eb 6a
    mov ax, word [bp+004h]                    ; 8b 46 04
    test ax, ax                               ; 85 c0
    je short 08316h                           ; 74 08
    lea dx, [bx+001h]                         ; 8d 57 01
    mov cx, ax                                ; 89 c1
    in AL, DX                                 ; ec
    loop 08313h                               ; e2 fd
    ...
    cmp word [bp+008h], strict byte 00000h    ; 83 7e 08 00
    jne short 08337h                          ; 75 07
    cmp word [bp+006h], 08000h                ; 81 7e 06 00 80
    jbe short 08354h                          ; 76 1d
    mov dx, ax                                ; 89 c2
    mov cx, 08000h                            ; b9 00 80
    les di, [bp+00ch]                         ; c4 7e 0c
    rep insb                                  ; f3 6c
    ...
    pop bp                                    ; 5d
    retn 0000ch                               ; c2 0c 00
scsi_enumerate_attached_devices_:            ; 0xf837c LB 0x482
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    call 07eb6h                               ; e8 dc fa
    test al, al                               ; 84 c0
    je short 083ech                           ; 74 0e
    push 00ba4h                               ; 68 a4 0b
    push 00bddh                               ; 68 dd 0b
    push strict byte 00007h                   ; 6a 07
    call 01a6bh                               ; e8 82 96
    add sp, strict byte 00006h                ; 83 c4 06
    ...
    je short 08478h                           ; 74 20
    mov bx, 00db2h                            ; bb b2 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01a2ah                               ; e8 c7 95
    push dx                                   ; 52
    push word [bp-024h]                       ; ff 76 dc
    push word [bp-01eh]                       ; ff 76 e2
    push 00bfch                               ; 68 fc 0b
    push strict byte 00004h                   ; 6a 04
    call 01a6bh                               ; e8 f9 95
    add sp, strict byte 0000ah                ; 83 c4 0a
    jmp near 08777h                           ; e9 ff 02
    mov al, byte [bp-00ch]                    ; 8a 46 f4
    cmp AL, strict byte 001h                  ; 3c 01
    jc short 0848bh                           ; 72 0c
    jbe short 08493h                          ; 76 12
    cmp AL, strict byte 003h                  ; 3c 03
    je short 0849bh                           ; 74 16
    cmp AL, strict byte 002h                  ; 3c 02
    je short 08497h                           ; 74 0e
    jmp short 084e4h                          ; eb 59
    test al, al                               ; 84 c0
    jne short 084e4h                          ; 75 55
    mov BL, strict byte 090h                  ; b3 90
    jmp short 0849dh                          ; eb 0a
    mov BL, strict byte 098h                  ; b3 98
    jmp short 0849dh                          ; eb 06
    mov BL, strict byte 0a0h                  ; b3 a0
    jmp short 0849dh                          ; eb 02
    mov BL, strict byte 0a8h                  ; b3 a8
    mov al, bl                                ; 88 d8
    add AL, strict byte 007h                  ; 04 07
    movzx cx, al                              ; 0f b6 c8
    mov ax, cx                                ; 89 c8
    call 017a5h                               ; e8 fc 92
    test al, al                               ; 84 c0
    je short 084e4h                           ; 74 37
    mov al, bl                                ; 88 d8
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    xor ah, ah                                ; 30 e4
    call 017a5h                               ; e8 ef 92
    movzx dx, al                              ; 0f b6 d0
    sal dx, 008h                              ; c1 e2 08
    movzx ax, bl                              ; 0f b6 c3
    ...
    mov ax, word [bp-010h]                    ; 8b 46 f0
    test ax, ax                               ; 85 c0
    jnbe short 0851fh                         ; 77 16
    jne near 08592h                           ; 0f 85 85 00
    cmp word [bp-030h], strict byte 00000h    ; 83 7e d0 00
    jnbe short 0851fh                         ; 77 0c
    jne near 08592h                           ; 0f 85 7b 00
    ...
    mov dx, strict word 00075h                ; ba 75 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01749h                               ; e8 7c 90
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    movzx bx, al                              ; 0f b6 d8
    mov dx, strict word 00075h                ; ba 75 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01757h                               ; e8 7c 90
    inc byte [bp-00ch]                        ; fe 46 f4
    jmp near 0876ch                           ; e9 8b 00
    mov bx, 00db2h                            ; bb b2 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01a2ah                               ; e8 3e 93
    push word [bp-01eh]                       ; ff 76 e2
    movzx ax, byte [bp-00ch]                  ; 0f b6 46 f4
    push ax                                   ; 50
    push 00c58h                               ; 68 58 0c
    push strict byte 00004h                   ; 6a 04
    call 01a6bh                               ; e8 6f 93
    add sp, strict byte 00008h                ; 83 c4 08
    mov al, byte [bp-00ch]                    ; 8a 46 f4
    add AL, strict byte 008h                  ; 04 08
    mov byte [bp-00eh], al                    ; 88 46 f2
    ...
    lea bx, [bp-046h]                         ; 8d 5e ba
    mov ax, word [bp-00248h]                  ; 8b 86 b8 fd
    call 07eb6h                               ; e8 05 f7
    test al, al                               ; 84 c0
    je short 087c3h                           ; 74 0e
    push 00ba4h                               ; 68 a4 0b
    push 00bc4h                               ; 68 c4 0b
    push strict byte 00007h                   ; 6a 07
    call 01a6bh                               ; e8 ab 92
    add sp, strict byte 00006h                ; 83 c4 06
    mov es, [bp-02eh]                         ; 8e 46 d2
    mov al, byte [es:di+0022ch]               ; 26 8a 85 2c 02
    mov byte [bp-00ch], al                    ; 88 46 f4
    test byte [bp-00246h], 0e0h               ; f6 86 ba fd e0
    jne short 087deh                          ; 75 09
    test byte [bp-00246h], 01fh               ; f6 86 ba fd 1f
    je near 083a0h                            ; 0f 84 c2 fb
    test byte [bp-00246h], 0e0h               ; f6 86 ba fd e0
    jne short 0876ch                          ; 75 87
    mov al, byte [bp-00246h]                  ; 8a 86 ba fd
    and AL, strict byte 01fh                  ; 24 1f
    cmp AL, strict byte 005h                  ; 3c 05
    je near 086e1h                            ; 0f 84 f0 fe
    jmp near 0876ch                           ; e9 78 ff
    lea sp, [bp-00ah]                         ; 8d 66 f6
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop dx                                    ; 5a
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
_scsi_init:                                  ; 0xf87fe LB 0x66
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01765h                               ; e8 5b 8f
    ...
    ; sub ah, ah                                ; 2a e4
    cmp AL, strict byte 055h                  ; 3c 55
    jne short 08860h                          ; 75 0c
    xor al, al                                ; 30 c0
    mov dx, 0043bh                            ; ba 3b 04
    out DX, AL                                ; ee
    mov ax, 00438h                            ; b8 38 04
    call 0837ch                               ; e8 1c fb
    mov sp, bp                                ; 89 ec
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_ctrl_extract_bits_:                     ; 0xf8864 LB 0x1b
    push si                                   ; 56
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    mov si, bx                                ; 89 de
    ...
    pop si                                    ; 5e
    retn 00002h                               ; c2 02 00
ahci_addr_to_phys_:                          ; 0xf887f LB 0x1e
    push bx                                   ; 53
    push cx                                   ; 51
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    ...
    pop bx                                    ; 5b
    retn                                      ; c3
ahci_port_cmd_sync_:                         ; 0xf889d LB 0x14b
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push si                                   ; 56
    ...
    xchg dx, ax                               ; 92
    test dh, 040h                             ; f6 c6 40
    jne short 08976h                          ; 75 04
    test AL, strict byte 001h                 ; a8 01
    je short 0897ah                           ; 74 04
    mov AL, strict byte 001h                  ; b0 01
    jmp short 0897ch                          ; eb 02
    xor al, al                                ; 30 c0
    test al, al                               ; 84 c0
    je short 0894ah                           ; 74 ca
    movzx di, byte [bp-008h]                  ; 0f b6 7e f8
    sal di, 007h                              ; c1 e7 07
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_cmd_data_:                              ; 0xf89e8 LB 0x262
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push si                                   ; 56
    ...
    mov dx, cx                                ; 89 ca
    call 09fb8h                               ; e8 87 13
    mov es, cx                                ; 8e c1
    mov al, byte [es:bx+003h]                 ; 26 8a 47 03
    test al, al                               ; 84 c0
    je short 08c40h                           ; 74 05
    mov ax, strict word 00004h                ; b8 04 00
    jmp short 08c42h                          ; eb 02
    xor ah, ah                                ; 30 e4
    lea sp, [bp-006h]                         ; 8d 66 fa
    pop di                                    ; 5f
    pop si                                    ; 5e
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_port_deinit_current_:                   ; 0xf8c4a LB 0x17f
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    je short 08cceh                           ; 74 04
    mov AL, strict byte 001h                  ; b0 01
    jmp short 08cd0h                          ; eb 02
    xor al, al                                ; 30 c0
    cmp AL, strict byte 001h                  ; 3c 01
    je short 08ca2h                           ; 74 ce
    mov cx, strict word 00020h                ; b9 20 00
    xor bx, bx                                ; 31 db
    mov ax, di                                ; 89 f8
    mov dx, word [bp-00ch]                    ; 8b 56 f4
    call 0a090h                               ; e8 af 13
    lea ax, [di+00080h]                       ; 8d 85 80 00
    mov cx, strict word 00040h                ; b9 40 00
    xor bx, bx                                ; 31 db
    mov dx, word [bp-00ch]                    ; 8b 56 f4
    call 0a090h                               ; e8 a0 13
    lea ax, [di+00200h]                       ; 8d 85 00 02
    mov cx, strict word 00060h                ; b9 60 00
    xor bx, bx                                ; 31 db
    mov dx, word [bp-00ch]                    ; 8b 56 f4
    call 0a090h                               ; e8 91 13
    movzx ax, byte [bp-00ah]                  ; 0f b6 46 f6
    sal ax, 007h                              ; c1 e0 07
    mov word [bp-00eh], ax                    ; 89 46 f2
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_port_init_:                             ; 0xf8dc9 LB 0x24a
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push si                                   ; 56
    ...
    xchg dx, ax                               ; 92
    test ax, 0c011h                           ; a9 11 c0
    je short 08e4ch                           ; 74 04
    mov AL, strict byte 001h                  ; b0 01
    jmp short 08e4eh                          ; eb 02
    xor al, al                                ; 30 c0
    cmp AL, strict byte 001h                  ; 3c 01
    je short 08e18h                           ; 74 c6
    mov cx, strict word 00020h                ; b9 20 00
    xor bx, bx                                ; 31 db
    mov ax, si                                ; 89 f0
    mov dx, word [bp-00ah]                    ; 8b 56 f6
    call 0a090h                               ; e8 31 12
    lea ax, [si+00080h]                       ; 8d 84 80 00
    mov cx, strict word 00040h                ; b9 40 00
    xor bx, bx                                ; 31 db
    mov dx, word [bp-00ah]                    ; 8b 56 f6
    call 0a090h                               ; e8 22 12
    lea di, [si+00200h]                       ; 8d bc 00 02
    mov cx, strict word 00060h                ; b9 60 00
    xor bx, bx                                ; 31 db
    mov ax, di                                ; 89 f8
    mov dx, word [bp-00ah]                    ; 8b 56 f6
    call 0a090h                               ; e8 11 12
    movzx bx, byte [bp-008h]                  ; 0f b6 5e f8
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
@ahci_read_sectors:                          ; 0xf9013 LB 0xa6
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    jbe short 09038h                          ; 76 0f
    push di                                   ; 57
    push 00c74h                               ; 68 74 0c
    push 00c86h                               ; 68 86 0c
    push strict byte 00007h                   ; 6a 07
    call 01a6bh                               ; e8 36 8a
    add sp, strict byte 00008h                ; 83 c4 08
    xor bx, bx                                ; 31 db
    les si, [bp+004h]                         ; c4 76 04
    ...
    xor ax, ax                                ; 31 c0
    call 08dc9h                               ; e8 65 fd
    mov bx, strict word 00025h                ; bb 25 00
    mov ax, si                                ; 89 f0
    mov dx, word [bp+006h]                    ; 8b 56 06
    call 089e8h                               ; e8 79 f9
    mov word [bp-006h], ax                    ; 89 46 fa
    mov es, [bp+006h]                         ; 8e 46 06
    mov bx, si                                ; 89 f3
    mov ax, word [es:bx+00eh]                 ; 26 8b 47 0e
    ...
    pop bp                                    ; 5d
    retn 00004h                               ; c2 04 00
@ahci_write_sectors:                         ; 0xf90b9 LB 0x84
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    cmp dx, strict byte 00004h                ; 83 fa 04
    jbe short 090e2h                          ; 76 0f
    push dx                                   ; 52
    push 00ca5h                               ; 68 a5 0c
    push 00c86h                               ; 68 86 0c
    push strict byte 00007h                   ; 6a 07
    call 01a6bh                               ; e8 8c 89
    add sp, strict byte 00008h                ; 83 c4 08
    xor bx, bx                                ; 31 db
    mov es, cx                                ; 8e c1
    ...
    mov dx, word [es:si+00232h]               ; 26 8b 94 32 02
    xor ax, ax                                ; 31 c0
    call 08dc9h                               ; e8 bd fc
    mov bx, strict word 00035h                ; bb 35 00
    mov ax, si                                ; 89 f0
    mov dx, cx                                ; 89 ca
    call 089e8h                               ; e8 d2 f8
    mov dx, ax                                ; 89 c2
    mov es, cx                                ; 8e c1
    ...
    pop bp                                    ; 5d
    retn 00004h                               ; c2 04 00
ahci_cmd_packet_:                            ; 0xf913d LB 0x183
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01765h                               ; e8 0d 86
    mov si, 00122h                            ; be 22 01
    mov word [bp-008h], ax                    ; 89 46 f8
    cmp byte [bp+00ah], 002h                  ; 80 7e 0a 02
    jne short 09183h                          ; 75 1f
    mov bx, 00db2h                            ; bb b2 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01a2ah                               ; e8 bb 88
    push 00cb8h                               ; 68 b8 0c
    push 00cc8h                               ; 68 c8 0c
    push strict byte 00004h                   ; 6a 04
    call 01a6bh                               ; e8 f1 88
    add sp, strict byte 00006h                ; 83 c4 06
    mov ax, strict word 00001h                ; b8 01 00
    jmp near 092b7h                           ; e9 34 01
    test byte [bp+004h], 001h                 ; f6 46 04 01
    jne short 0917dh                          ; 75 f4
    mov ax, word [bp+006h]                    ; 8b 46 06
    ...
    jne short 092b5h                          ; 75 05
    mov ax, strict word 00004h                ; b8 04 00
    jmp short 092b7h                          ; eb 02
    xor ax, ax                                ; 31 c0
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn 0000ch                               ; c2 0c 00
ahci_port_detect_device_:                    ; 0xf92c0 LB 0x4b1
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push si                                   ; 56
    ...
    mov bx, di                                ; 89 fb
    call 08dc9h                               ; e8 ef fa
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01765h                               ; e8 82 84
    ...
    mov bx, strict word 0000fh                ; bb 0f 00
    xor cx, cx                                ; 31 c9
    call 08864h                               ; e8 d7 f4
    test ax, ax                               ; 85 c0
    je near 09769h                            ; 0f 84 d6 03
    movzx ax, byte [bp-00ah]                  ; 0f b6 46 f6
    sal ax, 007h                              ; c1 e0 07
    mov word [bp-018h], ax                    ; 89 46 e8
    add ax, 00128h                            ; 05 28 01
    ...
    mov bx, strict word 0000fh                ; bb 0f 00
    xor cx, cx                                ; 31 c9
    call 08864h                               ; e8 8b f4
    cmp ax, strict word 00001h                ; 3d 01 00
    je short 09393h                           ; 74 b5
    push strict byte 00000h                   ; 6a 00
    mov bx, strict word 0000fh                ; bb 0f 00
    xor cx, cx                                ; 31 c9
    mov ax, di                                ; 89 f8
    mov dx, word [bp-022h]                    ; 8b 56 de
    call 08864h                               ; e8 77 f4
    cmp ax, strict word 00003h                ; 3d 03 00
    jne near 09769h                           ; 0f 85 75 03
    mov ax, word [bp-018h]                    ; 8b 46 e8
    ...
    test dx, dx                               ; 85 d2
    jne near 096bfh                           ; 0f 85 0d 02
    cmp di, 00101h                            ; 81 ff 01 01
    jne near 096bfh                           ; 0f 85 05 02
    les bx, [bp-010h]                         ; c4 5e f0
    ...
    jne short 09547h                          ; 75 1e
    cmp dx, strict byte 0ffffh                ; 83 fa ff
    jne short 09547h                          ; 75 19
    ...
    mov al, byte [bp-008h]                    ; 8a 46 f8
    cmp AL, strict byte 001h                  ; 3c 01
    jc short 095c0h                           ; 72 0c
    jbe short 095c8h                          ; 76 12
    cmp AL, strict byte 003h                  ; 3c 03
    je short 095d0h                           ; 74 16
    cmp AL, strict byte 002h                  ; 3c 02
    je short 095cch                           ; 74 0e
    jmp short 09619h                          ; eb 59
    test al, al                               ; 84 c0
    jne short 09619h                          ; 75 55
    mov DL, strict byte 040h                  ; b2 40
    jmp short 095d2h                          ; eb 0a
    mov DL, strict byte 048h                  ; b2 48
    jmp short 095d2h                          ; eb 06
    mov DL, strict byte 050h                  ; b2 50
    jmp short 095d2h                          ; eb 02
    mov DL, strict byte 058h                  ; b2 58
    mov al, dl                                ; 88 d0
    add AL, strict byte 007h                  ; 04 07
    movzx bx, al                              ; 0f b6 d8
    mov ax, bx                                ; 89 d8
    call 017a5h                               ; e8 c7 81
    test al, al                               ; 84 c0
    je short 09619h                           ; 74 37
    mov al, dl                                ; 88 d0
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    xor ah, ah                                ; 30 e4
    call 017a5h                               ; e8 ba 81
    xor ah, ah                                ; 30 e4
    mov si, ax                                ; 89 c6
    ...
    add AL, strict byte 002h                  ; 04 02
    xor ah, ah                                ; 30 e4
    call 017a5h                               ; e8 9d 81
    xor ah, ah                                ; 30 e4
    mov word [bp-02ah], ax                    ; 89 46 d6
    mov ax, bx                                ; 89 d8
    call 017a5h                               ; e8 93 81
    xor ah, ah                                ; 30 e4
    mov word [bp-026h], ax                    ; 89 46 da
    jmp short 09629h                          ; eb 10
    push dword [bp-016h]                      ; 66 ff 76 ea
    push di                                   ; 57
    push word [bp-01ah]                       ; ff 76 e6
    mov dx, ss                                ; 8c d2
    lea ax, [bp-02ah]                         ; 8d 46 d6
    call 05acch                               ; e8 a3 c4
    mov bx, 00db2h                            ; bb b2 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01a2ah                               ; e8 f6 83
    push dword [bp-016h]                      ; 66 ff 76 ea
    push di                                   ; 57
    push word [bp-01ah]                       ; ff 76 e6
    mov ax, word [bp-026h]                    ; 8b 46 da
    ...
    mov dx, strict word 00075h                ; ba 75 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01749h                               ; e8 9b 80
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    movzx bx, al                              ; 0f b6 d8
    mov dx, strict word 00075h                ; ba 75 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01757h                               ; e8 9b 80
    jmp near 0975bh                           ; e9 9c 00
    cmp dx, 0eb14h                            ; 81 fa 14 eb
    jne near 0975bh                           ; 0f 85 94 00
    cmp di, 00101h                            ; 81 ff 01 01
    jne near 0975bh                           ; 0f 85 8c 00
    les bx, [bp-010h]                         ; c4 5e f0
    db  066h, 026h, 0c7h, 047h, 004h, 000h, 000h, 000h, 000h
    ; mov dword [es:bx+004h], strict dword 000000000h ; 66 26 c7 47 04 00 00 00 00
    db  066h, 026h, 0c7h, 007h, 000h, 000h, 000h, 000h
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_mem_alloc_:                             ; 0xf9771 LB 0x43
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    xor ax, ax                                ; 31 c0
    call 01765h                               ; e8 e4 7f
    test ax, ax                               ; 85 c0
    je short 097aah                           ; 74 25
    dec ax                                    ; 48
    mov bx, ax                                ; 89 c3
    xor dx, dx                                ; 31 d2
    mov cx, strict word 0000ah                ; b9 0a 00
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_hba_init_:                              ; 0xf97b4 LB 0x166
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    shr eax, 010h                             ; 66 c1 e8 10
    xchg dx, ax                               ; 92
    call 09771h                               ; e8 83 ff
    mov word [bp-010h], ax                    ; 89 46 f0
    test ax, ax                               ; 85 c0
    je near 098f9h                            ; 0f 84 02 01
    mov ax, word [bp-010h]                    ; 8b 46 f0
    mov es, di                                ; 8e c7
    ...
    xor cx, cx                                ; 31 c9
    call 08864h                               ; e8 d1 ef
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    mov byte [bp-00eh], al                    ; 88 46 f2
    mov byte [bp-00ch], 000h                  ; c6 46 f4 00
    jmp short 098beh                          ; eb 20
    xor al, al                                ; 30 c0
    test al, al                               ; 84 c0
    je short 098b5h                           ; 74 11
    movzx bx, byte [bp-00ch]                  ; 0f b6 5e f4
    xor ax, ax                                ; 31 c0
    mov dx, word [bp-010h]                    ; 8b 56 f0
    call 092c0h                               ; e8 10 fa
    dec byte [bp-00eh]                        ; fe 4e f2
    je short 098f7h                           ; 74 42
    inc byte [bp-00ch]                        ; fe 46 f4
    cmp byte [bp-00ch], 020h                  ; 80 7e f4 20
    jnc short 098f7h                          ; 73 39
    movzx cx, byte [bp-00ch]                  ; 0f b6 4e f4
    mov bx, strict word 00001h                ; bb 01 00
    xor di, di                                ; 31 ff
    jcxz 098cfh                               ; e3 06
    ...
    xchg dx, ax                               ; 92
    test dx, di                               ; 85 fa
    jne short 098f3h                          ; 75 04
    test ax, bx                               ; 85 d8
    je short 0989eh                           ; 74 ab
    mov AL, strict byte 001h                  ; b0 01
    jmp short 098a0h                          ; eb a9
    xor ax, ax                                ; 31 c0
    lea sp, [bp-00ah]                         ; 8d 66 f6
    pop di                                    ; 5f
    pop si                                    ; 5e
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
    db  00bh, 005h, 004h, 003h, 002h, 001h, 000h, 0eah, 099h, 0c8h, 099h, 0ceh, 099h, 0d4h, 099h, 0dah
    db  099h, 0e0h, 099h, 0e6h, 099h, 0eah, 099h
_ahci_init:                                  ; 0xf991a LB 0x116
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov dx, strict word 00001h                ; ba 01 00
    call 09e50h                               ; e8 25 05
    mov bx, ax                                ; 89 c3
    cmp ax, strict word 0ffffh                ; 3d ff ff
    je near 09a29h                            ; 0f 84 f5 00
    xor al, al                                ; 30 c0
    shr ax, 008h                              ; c1 e8 08
    mov byte [bp-00ah], al                    ; 88 46 f6
    mov byte [bp-008h], bl                    ; 88 5e f8
    ...
    xor ah, ah                                ; 30 e4
    mov bx, strict word 00034h                ; bb 34 00
    call 09e7bh                               ; e8 31 05
    mov cl, al                                ; 88 c1
    test cl, cl                               ; 84 c9
    je short 09973h                           ; 74 23
    movzx bx, cl                              ; 0f b6 d9
    movzx di, byte [bp-008h]                  ; 0f b6 7e f8
    movzx si, byte [bp-00ah]                  ; 0f b6 76 f6
    mov dx, di                                ; 89 fa
    mov ax, si                                ; 89 f0
    call 09e7bh                               ; e8 19 05
    cmp AL, strict byte 012h                  ; 3c 12
    je short 09973h                           ; 74 0d
    mov al, cl                                ; 88 c8
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    movzx bx, al                              ; 0f b6 d8
    mov dx, di                                ; 89 fa
    mov ax, si                                ; 89 f0
    jmp short 09947h                          ; eb d4
    test cl, cl                               ; 84 c9
    je near 09a29h                            ; 0f 84 b0 00
    ...
    mov dx, si                                ; 89 f2
    mov ax, di                                ; 89 f8
    call 09e7bh                               ; e8 ed 04
    cmp AL, strict byte 010h                  ; 3c 10
    jne near 09a29h                           ; 0f 85 95 00
    mov byte [bp-006h], 000h                  ; c6 46 fa 00
    mov al, cl                                ; 88 c8
    add AL, strict byte 002h                  ; 04 02
    movzx bx, al                              ; 0f b6 d8
    ...
    mov al, byte [bp-006h]                    ; 8a 46 fa
    test al, al                               ; 84 c0
    je short 09a29h                           ; 74 30
    movzx bx, al                              ; 0f b6 d8
    movzx di, byte [bp-008h]                  ; 0f b6 7e f8
    movzx si, byte [bp-00ah]                  ; 0f b6 76 f6
    mov dx, di                                ; 89 fa
    mov ax, si                                ; 89 f0
    call 09ec1h                               ; e8 b6 04
    test AL, strict byte 001h                 ; a8 01
    je short 09a29h                           ; 74 1a
    and AL, strict byte 0f0h                  ; 24 f0
    add ax, cx                                ; 01 c8
    mov word [bp-00ch], ax                    ; 89 46 f4
    ...
    mov dx, di                                ; 89 fa
    mov ax, si                                ; 89 f0
    call 09ee8h                               ; e8 c5 04
    mov ax, word [bp-00ch]                    ; 8b 46 f4
    call 097b4h                               ; e8 8b fd
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop bp                                    ; 5d
...
apm_out_str_:                                ; 0xf9a30 LB 0x39
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
    mov [bp+si-064a8h], ds                    ; 8c 9a 58 9b
    sahf                                      ; 9e
    call far 09b58h:09ab9h                    ; 9a b9 9a 58 9b
    in AL, strict byte 09ah                   ; e4 9a
    pop ax                                    ; 58
    wait                                      ; 9b
    jmp near 0c7f6h                           ; e9 9a 2d
    wait                                      ; 9b
    sub ax, 02d9bh                            ; 2d 9b 2d
    wait                                      ; 9b
    sub byte [bp+di-064d3h], bl               ; 28 9b 2d 9b
    sub ax, 0219bh                            ; 2d 9b 21
    wait                                      ; 9b
_apm_function:                               ; 0xf9a69 LB 0xf5
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    and byte [bp+018h], 0feh                  ; 80 66 18 fe
    ...
    jmp near 09b58h                           ; e9 74 00
    sti                                       ; fb
    hlt                                       ; f4
    jmp near 09b58h                           ; e9 6f 00
    cmp word [bp+010h], strict byte 00003h    ; 83 7e 10 03
    je short 09b0eh                           ; 74 1f
    cmp word [bp+010h], strict byte 00002h    ; 83 7e 10 02
    je short 09b06h                           ; 74 11
    cmp word [bp+010h], strict byte 00001h    ; 83 7e 10 01
    jne short 09b16h                          ; 75 1b
    mov dx, 0040fh                            ; ba 0f 04
    mov ax, 00d22h                            ; b8 22 0d
    call 09a30h                               ; e8 2c ff
    jmp short 09b58h                          ; eb 52
    mov dx, 0040fh                            ; ba 0f 04
    mov ax, 00d2ah                            ; b8 2a 0d
    jmp short 09b01h                          ; eb f3
    mov dx, 0040fh                            ; ba 0f 04
    mov ax, 00d32h                            ; b8 32 0d
    jmp short 09b01h                          ; eb eb
    or ah, 00ah                               ; 80 cc 0a
    mov word [bp+012h], ax                    ; 89 46 12
    mov word [bp+018h], dx                    ; 89 56 18
    jmp short 09b58h                          ; eb 37
    mov word [bp+012h], 00102h                ; c7 46 12 02 01
    jmp short 09b58h                          ; eb 30
    or ah, 080h                               ; 80 cc 80
    jmp short 09b19h                          ; eb ec
    mov bx, 00db2h                            ; bb b2 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01a2ah                               ; e8 f2 7e
    push word [bp+00ch]                       ; ff 76 0c
    push word [bp+012h]                       ; ff 76 12
    push 00d3bh                               ; 68 3b 0d
    push strict byte 00004h                   ; 6a 04
    call 01a6bh                               ; e8 25 7f
    add sp, strict byte 00008h                ; 83 c4 08
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor ah, ah                                ; 30 e4
    or ah, 00ch                               ; 80 cc 0c
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci16_select_reg_:                           ; 0xf9b5e LB 0x24
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci16_find_device_:                          ; 0xf9b82 LB 0xf7
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    jne short 09bcah                          ; 75 2d
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, bx                                ; 89 d8
    call 09b5eh                               ; e8 b9 ff
    ...
    mov byte [bp-006h], al                    ; 88 46 fa
    cmp AL, strict byte 0ffh                  ; 3c ff
    jne short 09bb8h                          ; 75 06
    add bx, strict byte 00008h                ; 83 c3 08
    jmp near 09c4bh                           ; e9 93 00
    test byte [bp-006h], 080h                 ; f6 46 fa 80
    je short 09bc5h                           ; 74 07
    mov word [bp-00ah], strict word 00001h    ; c7 46 f6 01 00
    jmp short 09bcah                          ; eb 05
    mov word [bp-00ah], strict word 00008h    ; c7 46 f6 08 00
    mov al, byte [bp-006h]                    ; 8a 46 fa
    and AL, strict byte 007h                  ; 24 07
    cmp AL, strict byte 001h                  ; 3c 01
    jne short 09bf2h                          ; 75 1f
    mov ax, bx                                ; 89 d8
    shr ax, 008h                              ; c1 e8 08
    test ax, ax                               ; 85 c0
    jne short 09bf2h                          ; 75 16
    mov dx, strict word 0001ah                ; ba 1a 00
    mov ax, bx                                ; 89 d8
    call 09b5eh                               ; e8 7a ff
    mov dx, 00cfeh                            ; ba fe 0c
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    cmp al, byte [bp-008h]                    ; 3a 46 f8
    jbe short 09bf2h                          ; 76 03
    mov byte [bp-008h], al                    ; 88 46 f8
    test di, di                               ; 85 ff
    je short 09bfbh                           ; 74 05
    mov dx, strict word 00008h                ; ba 08 00
    jmp short 09bfdh                          ; eb 02
    xor dx, dx                                ; 31 d2
    mov ax, bx                                ; 89 d8
    call 09b5eh                               ; e8 5c ff
    ...
    pop bx                                    ; 5b
    popfw                                     ; 9d
    jne short 09c0eh                          ; 75 9d
    mov byte [di-06263h], bl                  ; 88 9d 9d 9d
    mov AL, strict byte 09dh                  ; b0 9d
    retn                                      ; c3
    popfw                                     ; 9d
_pci16_function:                             ; 0xf9c79 LB 0x1d7
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    xor ah, ah                                ; 30 e4
    cmp bx, strict byte 00003h                ; 83 fb 03
    jc short 09cb2h                           ; 72 1a
    jbe short 09d0ah                          ; 76 70
    cmp bx, strict byte 0000eh                ; 83 fb 0e
    je near 09dd7h                            ; 0f 84 36 01
    cmp bx, strict byte 00008h                ; 83 fb 08
    jc near 09e1ch                            ; 0f 82 74 01
    cmp bx, strict byte 0000dh                ; 83 fb 0d
    jbe near 09d2fh                           ; 0f 86 80 00
    jmp near 09e1ch                           ; e9 6a 01
    cmp bx, strict byte 00002h                ; 83 fb 02
    je short 09cdah                           ; 74 23
    cmp bx, strict byte 00001h                ; 83 fb 01
    jne near 09e1ch                           ; 0f 85 5e 01
    ...
    jmp near 09e49h                           ; e9 6f 01
    cmp word [bp+018h], strict byte 0ffffh    ; 83 7e 18 ff
    jne short 09ce6h                          ; 75 06
    or ah, 083h                               ; 80 cc 83
    jmp near 09e42h                           ; e9 5c 01
    mov bx, word [bp+008h]                    ; 8b 5e 08
    mov dx, word [bp+01ch]                    ; 8b 56 1c
    mov ax, word [bp+018h]                    ; 8b 46 18
    xor cx, cx                                ; 31 c9
    call 09b82h                               ; e8 8e fe
    cmp ax, strict word 0ffffh                ; 3d ff ff
    jne short 09d04h                          ; 75 0b
    mov ax, word [bp+020h]                    ; 8b 46 20
    xor ah, ah                                ; 30 e4
    or ah, 086h                               ; 80 cc 86
    jmp near 09e42h                           ; e9 3e 01
    mov word [bp+014h], ax                    ; 89 46 14
    jmp near 09e49h                           ; e9 3f 01
    mov bx, word [bp+008h]                    ; 8b 5e 08
    mov ax, word [bp+01ch]                    ; 8b 46 1c
    mov dx, word [bp+01eh]                    ; 8b 56 1e
    mov cx, strict word 00001h                ; b9 01 00
    call 09b82h                               ; e8 69 fe
    cmp ax, strict word 0ffffh                ; 3d ff ff
    jne short 09d29h                          ; 75 0b
    mov ax, word [bp+020h]                    ; 8b 46 20
    xor ah, ah                                ; 30 e4
    or ah, 086h                               ; 80 cc 86
    jmp near 09e42h                           ; e9 19 01
    mov word [bp+014h], ax                    ; 89 46 14
    jmp near 09e49h                           ; e9 1a 01
    cmp word [bp+004h], 00100h                ; 81 7e 04 00 01
    jc short 09d3ch                           ; 72 06
    or ah, 087h                               ; 80 cc 87
    jmp near 09e42h                           ; e9 06 01
    mov dx, word [bp+004h]                    ; 8b 56 04
    mov ax, word [bp+014h]                    ; 8b 46 14
    call 09b5eh                               ; e8 19 fe
    mov bx, word [bp+020h]                    ; 8b 5e 20
    xor bh, bh                                ; 30 ff
    sub bx, strict byte 00008h                ; 83 eb 08
    cmp bx, strict byte 00005h                ; 83 fb 05
    jnbe near 09e49h                          ; 0f 87 f5 00
    add bx, bx                                ; 01 db
    ...
    les bx, [bp-008h]                         ; c4 5e f8
    mov word [es:bx], ax                      ; 26 89 07
    jmp short 09e49h                          ; eb 2d
    mov bx, 00db2h                            ; bb b2 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01a2ah                               ; e8 03 7c
    mov ax, word [bp+014h]                    ; 8b 46 14
    push ax                                   ; 50
    mov ax, word [bp+020h]                    ; 8b 46 20
    push ax                                   ; 50
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci_find_classcode_:                         ; 0xf9e50 LB 0x2b
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci_read_config_byte_:                       ; 0xf9e7b LB 0x24
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push di                                   ; 57
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci_read_config_word_:                       ; 0xf9e9f LB 0x22
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push di                                   ; 57
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci_read_config_dword_:                      ; 0xf9ec1 LB 0x27
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push di                                   ; 57
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci_write_config_word_:                      ; 0xf9ee8 LB 0x1c
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push di                                   ; 57
    movzx di, bl                              ; 0f b6 fb
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
vds_is_present_:                             ; 0xf9f04 LB 0x1d
    push bx                                   ; 53
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    ...
    pop bx                                    ; 5b
    retn                                      ; c3
vds_real_to_lin_:                            ; 0xf9f21 LB 0x1e
    push bx                                   ; 53
    push cx                                   ; 51
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    ...
    pop bx                                    ; 5b
    retn                                      ; c3
vds_build_sg_list_:                          ; 0xf9f3f LB 0x79
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    call 09f04h                               ; e8 93 ff
    test ax, ax                               ; 85 c0
    je short 09f88h                           ; 74 13
    mov es, si                                ; 8e c6
    mov ax, 08105h                            ; b8 05 81
    mov dx, strict word 00000h                ; ba 00 00
    int 04bh                                  ; cd 4b
    jc near 09f85h                            ; 0f 82 02 00
    db  032h, 0c0h
    ; xor al, al                                ; 32 c0
    cbw                                       ; 98
    jmp short 09fafh                          ; eb 27
    mov es, si                                ; 8e c6
    ...
    pop bp                                    ; 5d
    retn 00004h                               ; c2 04 00
vds_free_sg_list_:                           ; 0xf9fb8 LB 0x38
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push di                                   ; 57
    mov bx, ax                                ; 89 c3
    call 09f04h                               ; e8 42 ff
    test ax, ax                               ; 85 c0
    je short 09fd9h                           ; 74 13
    mov di, bx                                ; 89 df
    mov es, dx                                ; 8e c2
    mov ax, 08106h                            ; b8 06 81
    mov dx, strict word 00000h                ; ba 00 00
    int 04bh                                  ; cd 4b
    jc near 09fd8h                            ; 0f 82 02 00
    db  032h, 0c0h
    ; xor al, al                                ; 32 c0
    cbw                                       ; 98
    mov es, dx                                ; 8e c2
...
__U8RS:                                      ; 0xfa070 LB 0x10
    ...
    retn                                      ; c3
__U8LS:                                      ; 0xfa080 LB 0x10
    test si, si                               ; 85 f6
    je short 0a08fh                           ; 74 0b
    sal dx, 1                                 ; d1 e2
    rcl cx, 1                                 ; d1 d1
    rcl bx, 1                                 ; d1 d3
    rcl ax, 1                                 ; d1 d0
    dec si                                    ; 4e
    jne short 0a084h                          ; 75 f5
    retn                                      ; c3
_fmemset_:                                   ; 0xfa090 LB 0x10
    push di                                   ; 57
    mov es, dx                                ; 8e c2
    db  08bh, 0f8h
    ; mov di, ax                                ; 8b f8
...
_fmemcpy_:                                   ; 0xfa0a0 LB 0x3a
    ...
    add byte [bx+si], al                      ; 00 00
    add byte [bx+si], al                      ; 00 00
    db  0f0h, 0a0h, 0f2h, 0a0h, 0f6h, 0a0h, 0f6h, 0a0h, 0f6h, 0a0h, 0f8h, 0a0h, 0f8h, 0a0h, 0fah, 0a0h
    db  0feh, 0a0h, 0feh, 0a0h, 000h, 0a1h, 005h, 0a1h, 007h, 0a1h
apm_worker:                                  ; 0xfa0da LB 0x3a
    sti                                       ; fb
    push ax                                   ; 50
    db  032h, 0e4h
    ; xor ah, ah                                ; 32 e4
    ...
    jnc short 0a110h                          ; 73 25
    jmp word [cs:bp-05f40h]                   ; 2e ff a6 c0 a0
    jmp short 0a10eh                          ; eb 1c
    sti                                       ; fb
    hlt                                       ; f4
    jmp short 0a10eh                          ; eb 18
    jmp short 0a10eh                          ; eb 16
    jmp short 0a110h                          ; eb 16
    mov AH, strict byte 080h                  ; b4 80
    jmp short 0a112h                          ; eb 14
    jmp short 0a110h                          ; eb 10
    mov ax, 00102h                            ; b8 02 01
    jmp short 0a10eh                          ; eb 09
    jmp short 0a10eh                          ; eb 07
    mov BL, strict byte 000h                  ; b3 00
    mov cx, strict word 00000h                ; b9 00 00
    jmp short 0a10eh                          ; eb 00
    clc                                       ; f8
    retn                                      ; c3
    mov AH, strict byte 009h                  ; b4 09
    stc                                       ; f9
    retn                                      ; c3
apm_pm16_entry:                              ; 0xfa114 LB 0x11
    ...
    mov ds, bp                                ; 8e dd
    call 0a0dah                               ; e8 b8 ff
    pop bp                                    ; 5d
    pop DS                                    ; 1f
    retf                                      ; cb

  ; Padding 0x38db bytes at 0xfa125
  times 14555 db 0
...
hard_drive_post:                             ; 0xfe2d2 LB 0xd0
    ...
    call 0991ah                               ; e8 d1 b5
    call 087feh                               ; e8 b2 a4
...
int13_disk:                                  ; 0xfecdc LB 0xd
    ...
    call 05bb1h                               ; e8 cd 6e
    jmp short 0ece9h                          ; eb 03
    call 05fffh                               ; e8 16 73
