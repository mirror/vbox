...
# VBOX end
  ...
  VBoxPkg/VBoxMimicryDxe/VBoxMimicryDxe.inf

[BuildOptions.common]
  GCC:*_*_*_CC_FLAGS = -DVBOX -DARCH_BITS=64 -DHC_ARCH_BITS=64
  GCC:*_*_*_DLINK_FLAGS = --image-base 0x1f000000
  INTEL:*_*_*_CC_FLAGS = -DVBOX -DARCH_BITS=64 -DHC_ARCH_BITS=64
  MSFT:*_*_*_CC_FLAGS = -DVBOX -DARCH_BITS=64 -DHC_ARCH_BITS=64
