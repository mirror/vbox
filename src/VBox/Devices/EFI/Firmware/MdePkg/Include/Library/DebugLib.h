...
#  define LogFlowFuncEnter() DEBUG((DEBUG_INFO, "ENTER:%a:%d\n", __FUNCTION__, __LINE__))
#  define LogFlowFuncLeave() DEBUG((DEBUG_INFO, "LEAVE:%a:%d\n", __FUNCTION__, __LINE__))
#  define LogFlowFuncLeaveRC(rc) DEBUG((DEBUG_INFO, "LEAVE:%a:%d rc(%r)\n", __FUNCTION__, __LINE__, (rc)))
#  define LogFlowFuncMark() DEBUG((DEBUG_INFO, "%a:%d\n", __FUNCTION__, __LINE__))
#  define LogFlowFuncMarkRC(rc) DEBUG((DEBUG_INFO, "%a:%d " #rc ":%r \n", __FUNCTION__, __LINE__, (rc)))
#  define LogFlowFuncMarkVar(var, var_printf_glag) DEBUG((DEBUG_INFO, "%a:%d " #var ": " var_printf_glag " \n", __FUNCTION__, __LINE__, (var)))
#  define LogFlowFuncMarkDP(dp) DEBUG((DEBUG_INFO, "%a:%d " #dp ": \n", __FUNCTION__, __LINE__, VBoxDebugDevicePath2Str(dp)))
#  define LogFlowFuncMarkHandleDP(dp) DEBUG((DEBUG_INFO, "%a:%d " #dp ": \n", __FUNCTION__, __LINE__, VBoxDebugHandleDevicePath2Str(dp)))
# else
#  define LogFlowFuncEnter() do {} while (0)
#  define LogFlowFuncLeave() do {} while (0)
#  define LogFlowFuncLeaveRC(rc) do {} while (0)
#  define LogFlowFuncMark() do {} while (0)
#  define LogFlowFuncMarkRC(rc) do {} while (0)
#  define LogFlowFuncMarkVar(var, var_printf_flag) do {} while (0)
#  define LogFlowFuncMarkDP(dp) do {} while (0)
#  define LogFlowFuncMarkHandleDP(dp) do {} while (0)
# endif
#endif
#endif
