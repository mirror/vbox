...
vga_read_char_attr:                          ; 0xc0ad2 LB 0x9f
    ...
    cmp byte [bx+0462fh], 000h                ; 80 bf 2f 46 00              ; 0xc0b33
...
vga_read_pixel:                              ; 0xc0bfc LB 0x143
    ...
    cmp byte [bx+0462fh], 000h                ; 80 bf 2f 46 00              ; 0xc0c27
    jne short 00c31h                          ; 75 03                       ; 0xc0c2c
    jmp near 00d38h                           ; e9 07 01                    ; 0xc0c2e vgabios.c:431
    mov bl, byte [bx+04630h]                  ; 8a 9f 30 46                 ; 0xc0c31 vgabios.c:434
    ...
    cmp byte [bx+04631h], 002h                ; 80 bf 31 46 02              ; 0xc0cd8
...
biosfn_set_active_page:                      ; 0xc0f34 LB 0xe5
    ...
    cmp byte [si+0462fh], 000h                ; 80 bc 2f 46 00              ; 0xc0f72
    ...
    mov bl, byte [bx+046aeh]                  ; 8a 9f ae 46                 ; 0xc0fc0 vgabios.c:610
...
biosfn_set_video_mode:                       ; 0xc1019 LB 0x3ea
    ...
    mov al, byte [bx+046aeh]                  ; 8a 87 ae 46                 ; 0xc1069
    ...
    mov al, byte [bx+046c2h]                  ; 8a 87 c2 46                 ; 0xc1078
    xor ah, ah                                ; 30 e4                       ; 0xc107c
    mov word [bp-016h], ax                    ; 89 46 ea                    ; 0xc107e
    mov al, byte [bx+046c3h]                  ; 8a 87 c3 46                 ; 0xc1081 vgabios.c:687
    mov word [bp-01ch], ax                    ; 89 46 e4                    ; 0xc1085
    mov al, byte [bx+046c4h]                  ; 8a 87 c4 46                 ; 0xc1088 vgabios.c:688
    ...
    mov al, byte [bx+04634h]                  ; 8a 87 34 46                 ; 0xc10b7
    ...
    mov bl, byte [bx+04635h]                  ; 8a 9f 35 46                 ; 0xc10c5 vgabios.c:711
    ...
    mov di, 04e42h                            ; bf 42 4e                    ; 0xc10df vgabios.c:713
    jmp short 010f1h                          ; eb 0d                       ; 0xc10e2 vgabios.c:714
    mov di, 04f02h                            ; bf 02 4f                    ; 0xc10e4 vgabios.c:716
    jmp short 010f1h                          ; eb 08                       ; 0xc10e7 vgabios.c:717
    mov di, 04fc2h                            ; bf c2 4f                    ; 0xc10e9 vgabios.c:719
    jmp short 010f1h                          ; eb 03                       ; 0xc10ec vgabios.c:720
    mov di, 05082h                            ; bf 82 50                    ; 0xc10ee vgabios.c:722
    ...
    mov al, byte [si+04635h]                  ; 8a 84 35 46                 ; 0xc1108
    mov si, ax                                ; 89 c6                       ; 0xc110c
    mov al, byte [si+046beh]                  ; 8a 84 be 46                 ; 0xc110e
    ...
    mov al, byte [si+046e5h]                  ; 8a 84 e5 46                 ; 0xc116b
    ...
    mov al, byte [si+046c6h]                  ; 8a 84 c6 46                 ; 0xc11a3
    ...
    mov al, byte [si+046f9h]                  ; 8a 84 f9 46                 ; 0xc11ca
    ...
    cmp byte [bx+04630h], 001h                ; 80 bf 30 46 01              ; 0xc11de
    ...
    cmp byte [bx+0462fh], 000h                ; 80 bf 2f 46 00              ; 0xc1240
    jne short 0125ah                          ; 75 13                       ; 0xc1245
    mov es, [bx+04632h]                       ; 8e 87 32 46                 ; 0xc1247 vgabios.c:791
    ...
    mov es, [bx+04632h]                       ; 8e 87 32 46                 ; 0xc1260 vgabios.c:797
    ...
    mov es, [bx+04632h]                       ; 8e 87 32 46                 ; 0xc1284 vgabios.c:804
    ...
    mov bx, word [bx+046c5h]                  ; 8b 9f c5 46                 ; 0xc12c3
    ...
    mov bx, 053d0h                            ; bb d0 53                    ; 0xc1339
    ...
    mov bl, byte [bx+07c5dh]                  ; 8a 9f 5d 7c                 ; 0xc134e
    ...
    cmp byte [bx+0462fh], 000h                ; 80 bf 2f 46 00              ; 0xc137f
    ...
    cmp byte [bx+0462fh], 000h                ; 80 bf 2f 46 00              ; 0xc13b2
    ...
    mov dx, 057ech                            ; ba ec 57                    ; 0xc13c9 vgabios.c:852
...
biosfn_scroll:                               ; 0xc1678 LB 0x576
    ...
    cmp byte [di+0462fh], 000h                ; 80 bd 2f 46 00              ; 0xc1732
    ...
    mov es, [di+04632h]                       ; 8e 85 32 46                 ; 0xc1778
    ...
    mov es, [si+04632h]                       ; 8e 84 32 46                 ; 0xc17e8
    ...
    mov ax, word [si+04632h]                  ; 8b 84 32 46                 ; 0xc1821
    ...
    mov si, word [si+04632h]                  ; 8b b4 32 46                 ; 0xc189f
    ...
    mov ax, word [si+04632h]                  ; 8b 84 32 46                 ; 0xc18e1
    ...
    mov al, byte [si+046aeh]                  ; 8a 84 ae 46                 ; 0xc191a vgabios.c:1004
    xor ah, ah                                ; 30 e4                       ; 0xc191e
    mov CL, strict byte 006h                  ; b1 06                       ; 0xc1920
    mov si, ax                                ; 89 c6                       ; 0xc1922
    sal si, CL                                ; d3 e6                       ; 0xc1924
    mov al, byte [si+046c4h]                  ; 8a 84 c4 46                 ; 0xc1926
    mov byte [bp-012h], al                    ; 88 46 ee                    ; 0xc192a
    mov al, byte [di+04630h]                  ; 8a 85 30 46                 ; 0xc192d vgabios.c:1005
    ...
    mov bx, word [bx+04632h]                  ; 8b 9f 32 46                 ; 0xc1992
    ...
    mov bl, byte [di+04631h]                  ; 8a 9d 31 46                 ; 0xc1aa8 vgabios.c:1039
    ...
    mov es, [di+04632h]                       ; 8e 85 32 46                 ; 0xc1ae0
...
write_gfx_char_pl4:                          ; 0xc1bee LB 0xf8
    ...
    mov di, 05bech                            ; bf ec 5b                    ; 0xc1c0d vgabios.c:1093
    jmp short 01c1ah                          ; eb 08                       ; 0xc1c10 vgabios.c:1094
    mov di, 069ech                            ; bf ec 69                    ; 0xc1c12 vgabios.c:1096
    jmp short 01c1ah                          ; eb 03                       ; 0xc1c15 vgabios.c:1097
    mov di, 053ech                            ; bf ec 53                    ; 0xc1c17 vgabios.c:1099
...
write_gfx_char_cga:                          ; 0xc1ce6 LB 0x13a
    ...
    mov si, 053ech                            ; be ec 53                    ; 0xc1cf4 vgabios.c:1144
...
write_gfx_char_lin:                          ; 0xc1e20 LB 0xac
    ...
    mov si, 053ech                            ; be ec 53                    ; 0xc1e33 vgabios.c:1221
...
biosfn_write_char_attr:                      ; 0xc1ecc LB 0x192
    ...
    cmp byte [di+0462fh], 000h                ; 80 bd 2f 46 00              ; 0xc1f3a
    ...
    mov es, [di+04632h]                       ; 8e 85 32 46                 ; 0xc1f7a
    ...
    mov al, byte [bx+046aeh]                  ; 8a 87 ae 46                 ; 0xc1f8c
    mov CL, strict byte 006h                  ; b1 06                       ; 0xc1f90
    mov bx, ax                                ; 89 c3                       ; 0xc1f92
    sal bx, CL                                ; d3 e3                       ; 0xc1f94
    mov al, byte [bx+046c4h]                  ; 8a 87 c4 46                 ; 0xc1f96
    mov byte [bp-010h], al                    ; 88 46 f0                    ; 0xc1f9a
    mov al, byte [di+04631h]                  ; 8a 85 31 46                 ; 0xc1f9d vgabios.c:1273
    ...
    mov al, byte [bx+04630h]                  ; 8a 87 30 46                 ; 0xc1fc0
...
biosfn_write_char_only:                      ; 0xc205e LB 0x193
    ...
    cmp byte [bx+0462fh], 000h                ; 80 bf 2f 46 00              ; 0xc20d0
    ...
    mov cx, word [bx+04632h]                  ; 8b 8f 32 46                 ; 0xc2114
    ...
    mov bl, byte [bx+04630h]                  ; 8a 9f 30 46                 ; 0xc215a
...
biosfn_write_pixel:                          ; 0xc21f1 LB 0x17f
    ...
    cmp byte [bx+0462fh], 000h                ; 80 bf 2f 46 00              ; 0xc221d
    je short 0223ch                           ; 74 18                       ; 0xc2222
    mov al, byte [bx+04630h]                  ; 8a 87 30 46                 ; 0xc2224 vgabios.c:1369
    ...
    cmp byte [bx+04631h], 002h                ; 80 bf 31 46 02              ; 0xc22b7
    ...
    cmp byte [si+04631h], 002h                ; 80 bc 31 46 02              ; 0xc22f0
...
biosfn_write_teletype:                       ; 0xc2370 LB 0x25f
    ...
    cmp byte [si+0462fh], 000h                ; 80 bc 2f 46 00              ; 0xc2422
    ...
    mov ax, word [si+04632h]                  ; 8b 84 32 46                 ; 0xc244f
    ...
    inc dx                                    ; 42                          ; 0xc2465
    mov ax, word [si+04632h]                  ; 8b 84 32 46                 ; 0xc2466
    call 031cch                               ; e8 5f 0d                    ; 0xc246a
    jmp short 024b5h                          ; eb 46                       ; 0xc246d vgabios.c:1486
    mov bl, byte [bx+046aeh]                  ; 8a 9f ae 46                 ; 0xc246f vgabios.c:1489
    mov CL, strict byte 006h                  ; b1 06                       ; 0xc2473
    sal bx, CL                                ; d3 e3                       ; 0xc2475
    mov bl, byte [bx+046c4h]                  ; 8a 9f c4 46                 ; 0xc2477
    mov ah, byte [si+04631h]                  ; 8a a4 31 46                 ; 0xc247b vgabios.c:1490
    mov al, byte [si+04630h]                  ; 8a 84 30 46                 ; 0xc247f vgabios.c:1491
    ...
    cmp byte [si+0462fh], 000h                ; 80 bc 2f 46 00              ; 0xc2534
    ...
    inc dx                                    ; 42                          ; 0xc2565
    mov ax, word [si+04632h]                  ; 8b 84 32 46                 ; 0xc2566
...
biosfn_load_text_8_14_pat:                   ; 0xc2787 LB 0x76
    ...
    mov si, 05bech                            ; be ec 5b                    ; 0xc27c9 vgabios.c:1621
...
biosfn_load_text_8_8_pat:                    ; 0xc27fd LB 0x74
    ...
    add si, 053ech                            ; 81 c6 ec 53                 ; 0xc283e vgabios.c:1640
...
biosfn_load_text_8_16_pat:                   ; 0xc2871 LB 0x74
    ...
    add si, 069ech                            ; 81 c6 ec 69                 ; 0xc28b2 vgabios.c:1660
...
biosfn_read_state_info:                      ; 0xc29a5 LB 0x102
    ...
    mov bx, 05382h                            ; bb 82 53                    ; 0xc29af
...
find_vga_entry:                              ; 0xc3193 LB 0x2b
    ...
    cmp dl, byte [bx+0462eh]                  ; 3a 97 2e 46                 ; 0xc31af
...
section CONST2 progbits vstart=0x7d26 align=1 ; size=0x0 class=DATA group=DGROUP
  ...
  ; Padding 0x2da bytes at 0xc7d26
    ...
    db  000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h
    db  000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h
    db  000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 0d5h
