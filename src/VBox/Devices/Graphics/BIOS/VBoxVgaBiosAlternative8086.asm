...
init_bios_area:                              ; 0xc0a28 LB 0x3e
    ...
    mov word [es:bx+000a8h], 05550h           ; 26 c7 87 a8 00 50 55        ; 0xc0a57 vgabios.c:242
...
vga_read_char_attr:                          ; 0xc0ded LB 0x147
    ...
    mov bl, byte [bx+047b0h]                  ; 8a 9f b0 47                 ; 0xc0e9f vgabios.c:562
...
vga_get_font_info:                           ; 0xc0f44 LB 0x83
    ...
    mov dx, 05d6ch                            ; ba 6c 5d                    ; 0xc0fa5 vgabios.c:601
    mov ax, ds                                ; 8c d8                       ; 0xc0fa8
    jmp short 00f69h                          ; eb bd                       ; 0xc0faa vgabios.c:602
    mov dx, 0556ch                            ; ba 6c 55                    ; 0xc0fac vgabios.c:604
    jmp short 00fa8h                          ; eb f7                       ; 0xc0faf
    mov dx, 0596ch                            ; ba 6c 59                    ; 0xc0fb1 vgabios.c:607
    jmp short 00fa8h                          ; eb f2                       ; 0xc0fb4
    mov dx, 07b6ch                            ; ba 6c 7b                    ; 0xc0fb6 vgabios.c:610
    jmp short 00fa8h                          ; eb ed                       ; 0xc0fb9
    mov dx, 06b6ch                            ; ba 6c 6b                    ; 0xc0fbb vgabios.c:613
    jmp short 00fa8h                          ; eb e8                       ; 0xc0fbe
    mov dx, 07c99h                            ; ba 99 7c                    ; 0xc0fc0 vgabios.c:616
...
vga_read_pixel:                              ; 0xc0fc7 LB 0x16d
    ...
    mov ch, byte [bx+047b0h]                  ; 8a af b0 47                 ; 0xc1003 vgabios.c:649
    ...
    mov al, byte [bx+047b1h]                  ; 8a 87 b1 47                 ; 0xc108f vgabios.c:664
...
biosfn_set_active_page:                      ; 0xc135c LB 0xd5
    ...
    mov bl, byte [bx+0482eh]                  ; 8a 9f 2e 48                 ; 0xc13e1 vgabios.c:862
...
find_vpti:                                   ; 0xc1431 LB 0x48
    ...
    mov al, byte [bx+07df5h]                  ; 8a 87 f5 7d                 ; 0xc1457 vgabios.c:924
    jmp short 0146bh                          ; eb 0e                       ; 0xc145b vgabios.c:925
    test AL, strict byte 080h                 ; a8 80                       ; 0xc145d
    je short 01467h                           ; 74 06                       ; 0xc145f
    mov al, byte [bx+07de5h]                  ; 8a 87 e5 7d                 ; 0xc1461 vgabios.c:926
    jmp short 0146bh                          ; eb 04                       ; 0xc1465 vgabios.c:927
    mov al, byte [bx+07dedh]                  ; 8a 87 ed 7d                 ; 0xc1467 vgabios.c:928
    cbw                                       ; 98                          ; 0xc146b
    jmp short 01474h                          ; eb 06                       ; 0xc146c vgabios.c:929
    mov al, byte [bx+0482eh]                  ; 8a 87 2e 48                 ; 0xc146e vgabios.c:930
...
biosfn_set_video_mode:                       ; 0xc1479 LB 0x4e4
    ...
    mov bx, 05d6ch                            ; bb 6c 5d                    ; 0xc1873
    ...
    mov dx, 07b6ch                            ; ba 6c 7b                    ; 0xc1887
    ...
    mov bx, 06b6ch                            ; bb 6c 6b                    ; 0xc18a3
    ...
    mov dx, 07c99h                            ; ba 99 7c                    ; 0xc18b1
    ...
    mov bx, 0596ch                            ; bb 6c 59                    ; 0xc191b vgabios.c:1199
    ...
    mov bx, 0556ch                            ; bb 6c 55                    ; 0xc193c vgabios.c:1203
    ...
    mov bx, 05d6ch                            ; bb 6c 5d                    ; 0xc1949 vgabios.c:1206
    jmp short 0193fh                          ; eb f1                       ; 0xc194c
    mov bx, 06b6ch                            ; bb 6c 6b                    ; 0xc194e vgabios.c:1209
...
biosfn_scroll:                               ; 0xc1c9f LB 0x6a3
    ...
    cmp byte [bx+047afh], 000h                ; 80 bf af 47 00              ; 0xc1d60
    ...
    mov es, [bx+047b2h]                       ; 8e 87 b2 47                 ; 0xc1da1
    ...
    mov es, [bx+047b2h]                       ; 8e 87 b2 47                 ; 0xc1e10
    ...
    mov bx, word [bx+047b2h]                  ; 8b 9f b2 47                 ; 0xc1e4a
    ...
    mov es, [di+047b2h]                       ; 8e 85 b2 47                 ; 0xc1ec9
    ...
    mov bx, word [bx+047b2h]                  ; 8b 9f b2 47                 ; 0xc1f0b
    ...
    mov bx, word [bx+047b2h]                  ; 8b 9f b2 47                 ; 0xc1fc6
    ...
    mov cl, byte [bx+047b1h]                  ; 8a 8f b1 47                 ; 0xc20c9 vgabios.c:1414
    ...
    mov bx, word [bx+047b2h]                  ; 8b 9f b2 47                 ; 0xc2102
    ...
    mov es, [bx+047b2h]                       ; 8e 87 b2 47                 ; 0xc2252
...
write_gfx_char_cga:                          ; 0xc2454 LB 0x112
    ...
    mov si, 0556ch                            ; be 6c 55                    ; 0xc2463 vgabios.c:1541
...
write_gfx_char_lin:                          ; 0xc2566 LB 0xa1
    ...
    mov di, 0556ch                            ; bf 6c 55                    ; 0xc2574 vgabios.c:1605
...
biosfn_write_char_attr:                      ; 0xc2607 LB 0x172
    ...
    cmp byte [di+047afh], 000h                ; 80 bd af 47 00              ; 0xc267f
    ...
    mov es, [di+047b2h]                       ; 8e 85 b2 47                 ; 0xc26b7
    ...
    mov bl, byte [bx+0482eh]                  ; 8a 9f 2e 48                 ; 0xc26c6 vgabios.c:1656
    mov CL, strict byte 006h                  ; b1 06                       ; 0xc26ca
    sal bx, CL                                ; d3 e3                       ; 0xc26cc
    mov al, byte [bx+04844h]                  ; 8a 87 44 48                 ; 0xc26ce
    mov byte [bp-010h], al                    ; 88 46 f0                    ; 0xc26d2
    mov al, byte [di+047b1h]                  ; 8a 85 b1 47                 ; 0xc26d5 vgabios.c:1657
    ...
    mov al, byte [bx+047b0h]                  ; 8a 87 b0 47                 ; 0xc26eb
...
biosfn_write_char_only:                      ; 0xc2779 LB 0x183
    ...
    cmp byte [bx+047afh], 000h                ; 80 bf af 47 00              ; 0xc27ec
    ...
    mov es, [di+047b2h]                       ; 8e 85 b2 47                 ; 0xc282a vgabios.c:50
    ...
    mov al, byte [di+0482eh]                  ; 8a 85 2e 48                 ; 0xc283a
    mov CL, strict byte 006h                  ; b1 06                       ; 0xc283e
    mov di, ax                                ; 89 c7                       ; 0xc2840
    sal di, CL                                ; d3 e7                       ; 0xc2842
    mov al, byte [di+04844h]                  ; 8a 85 44 48                 ; 0xc2844
    mov byte [bp-012h], al                    ; 88 46 ee                    ; 0xc2848
    mov al, byte [bx+047b1h]                  ; 8a 87 b1 47                 ; 0xc284b vgabios.c:1717
    ...
    mov bl, byte [bx+047b0h]                  ; 8a 9f b0 47                 ; 0xc2861
...
biosfn_write_pixel:                          ; 0xc28fc LB 0x17a
    ...
    cmp byte [bx+047afh], 000h                ; 80 bf af 47 00              ; 0xc292d
    je short 0294ch                           ; 74 18                       ; 0xc2932
    mov al, byte [bx+047b0h]                  ; 8a 87 b0 47                 ; 0xc2934 vgabios.c:1755
    ...
    cmp byte [bx+047b1h], 002h                ; 80 bf b1 47 02              ; 0xc29ce
    ...
    cmp byte [si+047b1h], 002h                ; 80 bc b1 47 02              ; 0xc2a00
...
biosfn_write_teletype:                       ; 0xc2a76 LB 0x263
    ...
    cmp byte [bx+047afh], 000h                ; 80 bf af 47 00              ; 0xc2b2b
    ...
    mov es, [bx+047b2h]                       ; 8e 87 b2 47                 ; 0xc2b5b vgabios.c:50
    ...
    mov es, [bx+047b2h]                       ; 8e 87 b2 47                 ; 0xc2b68 vgabios.c:50
    ...
    mov al, byte [si+0482eh]                  ; 8a 84 2e 48                 ; 0xc2b76
    mov CL, strict byte 006h                  ; b1 06                       ; 0xc2b7a
    mov si, ax                                ; 89 c6                       ; 0xc2b7c
    sal si, CL                                ; d3 e6                       ; 0xc2b7e
    mov dl, byte [si+04844h]                  ; 8a 94 44 48                 ; 0xc2b80
    mov al, byte [bx+047b1h]                  ; 8a 87 b1 47                 ; 0xc2b84 vgabios.c:1877
    mov bl, byte [bx+047b0h]                  ; 8a 9f b0 47                 ; 0xc2b88 vgabios.c:1878
    ...
    cmp byte [bx+047afh], 000h                ; 80 bf af 47 00              ; 0xc2c45
    ...
    mov es, [bx+047b2h]                       ; 8e 87 b2 47                 ; 0xc2c77 vgabios.c:45
...
set_gfx_font:                                ; 0xc2f26 LB 0x4d
    ...
    mov al, byte [bx+07dfdh]                  ; 8a 87 fd 7d                 ; 0xc2f4c
...
biosfn_load_gfx_8_14_chars:                  ; 0xc2f90 LB 0x22
    ...
    mov ax, 05d6ch                            ; b8 6c 5d                    ; 0xc2fa3
...
biosfn_load_gfx_8_8_dd_chars:                ; 0xc2fb2 LB 0x22
    ...
    mov ax, 0556ch                            ; b8 6c 55                    ; 0xc2fc5
...
biosfn_load_gfx_8_16_chars:                  ; 0xc2fd4 LB 0x22
    ...
    mov ax, 06b6ch                            ; b8 6c 6b                    ; 0xc2fe7
...
biosfn_read_state_info:                      ; 0xc30c6 LB 0x1f2
    ...
    mov word [es:bx], 05502h                  ; 26 c7 07 02 55              ; 0xc30ea
...
find_vga_entry:                              ; 0xc3888 LB 0x2b
    ...
    cmp dl, byte [bx+047aeh]                  ; 3a 97 ae 47                 ; 0xc38a4
...
int10_func:                                  ; 0xc394b LB 0x456
    ...
    mov bx, 05d6ch                            ; bb 6c 5d                    ; 0xc3b2d
    ...
    mov bx, 0556ch                            ; bb 6c 55                    ; 0xc3b4b
    ...
    mov bx, 06b6ch                            ; bb 6c 6b                    ; 0xc3b6e
