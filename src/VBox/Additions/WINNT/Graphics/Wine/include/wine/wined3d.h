/*** Autogenerated by WIDL 1.1.21 from ../../include/wine/wined3d.idl - Do not edit ***/
...
/*** IWineD3DResource methods ***/
#define IWineD3DBuffer_GetDevice(This,device) (This)->lpVtbl->GetDevice(This,device)
