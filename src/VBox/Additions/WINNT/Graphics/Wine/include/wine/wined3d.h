/*** Autogenerated by WIDL 1.1.10 from ../../../dlls/wined3d/../../include/wine/wined3d.idl - Do not edit ***/
#include <rpc.h>
#include <rpcndr.h>
...
#define WINED3DFVF_POSITION_MASK (0xe)
...
typedef struct _WINED3DVERTEXELEMENT *LPWINED3DVERTEXELEMENT;
...
typedef struct WineDirect3DVertexStridedData {
    union {
        struct {
            ...
            WineDirect3DStridedData position2;
            WineDirect3DStridedData normal2;
        ...
        WineDirect3DStridedData input[16];
    } u;
...
typedef HRESULT (STDMETHODCALLTYPE *D3DCB_CREATESURFACEFN)(IUnknown *pDevice,IUnknown *pSuperior,UINT Width,UINT Height,WINED3DFORMAT Format,DWORD Usage,WINED3DPOOL Pool,UINT Level,WINED3DCUBEMAP_FACES Face,IWineD3DSurface **ppSurface,HANDLE *pSharedHandle);
typedef HRESULT (STDMETHODCALLTYPE *D3DCB_CREATERENDERTARGETFN)(IUnknown *pDevice,IUnknown *pSuperior,UINT Width,UINT Height,WINED3DFORMAT Format,WINED3DMULTISAMPLE_TYPE MultiSample,DWORD MultisampleQuality,BOOL Lockable,IWineD3DSurface **ppSurface,HANDLE *pSharedHandle);
typedef HRESULT (STDMETHODCALLTYPE *D3DCB_CREATEDEPTHSTENCILSURFACEFN)(IUnknown *pDevice,IUnknown *pSuperior,UINT Width,UINT Height,WINED3DFORMAT Format,WINED3DMULTISAMPLE_TYPE MultiSample,DWORD MultisampleQuality,BOOL Discard,IWineD3DSurface **ppSurface,HANDLE *pSharedHandle);
typedef ULONG (STDMETHODCALLTYPE *D3DCB_DESTROYSURFACEFN)(IWineD3DSurface *pSurface);
typedef HRESULT (STDMETHODCALLTYPE *D3DCB_CREATEVOLUMEFN)(IUnknown *pDevice,IUnknown *pSuperior,UINT Width,UINT Height,UINT Depth,WINED3DFORMAT Format,WINED3DPOOL Pool,DWORD Usage,IWineD3DVolume **ppVolume,HANDLE *pSharedHandle);
typedef ULONG (STDMETHODCALLTYPE *D3DCB_DESTROYVOLUMEFN)(IWineD3DVolume *pVolume);
typedef HRESULT (STDMETHODCALLTYPE *D3DCB_CREATESWAPCHAIN)(IUnknown *pDevice,WINED3DPRESENT_PARAMETERS *pPresentationParameters,IWineD3DSwapChain **pSwapChain);
...
#define IWineD3D_EnumAdapterModes(This,adapter_idx,mode_idx,format,mode) (This)->lpVtbl->EnumAdapterModes(This,adapter_idx,mode_idx,format,mode)
...
#define IWineD3D_CreateDevice(This,adapter_idx,device_type,focus_window,behaviour_flags,device,parent) (This)->lpVtbl->CreateDevice(This,adapter_idx,device_type,focus_window,behaviour_flags,device,parent)
#endif
...
/*** IWineD3DResource methods ***/
#define IWineD3DResource_GetDevice(This,device) (This)->lpVtbl->GetDevice(This,device)
...
HRESULT STDMETHODCALLTYPE IWineD3DResource_GetDevice_Proxy(
    IWineD3DResource* This,
    IWineD3DDevice **device);
void __RPC_STUB IWineD3DResource_GetDevice_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
...
#ifndef __IWineD3DVertexBuffer_FWD_DEFINED__
#define __IWineD3DVertexBuffer_FWD_DEFINED__
typedef interface IWineD3DVertexBuffer IWineD3DVertexBuffer;
#endif

/*****************************************************************************
 * IWineD3DVertexBuffer interface
 */
#ifndef __IWineD3DVertexBuffer_INTERFACE_DEFINED__
#define __IWineD3DVertexBuffer_INTERFACE_DEFINED__

DEFINE_GUID(IID_IWineD3DVertexBuffer, 0x217f671e, 0x6f30, 0x11d9, 0xc6,0x87, 0x00,0x04,0x61,0x42,0xc1,0x4f);
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IWineD3DVertexBuffer : public IWineD3DResource
{
    ...
    virtual HRESULT STDMETHODCALLTYPE GetDesc(
        WINED3DVERTEXBUFFER_DESC *desc) = 0;

};
#else
typedef struct IWineD3DVertexBufferVtbl {
    BEGIN_INTERFACE

    /*** IUnknown methods ***/
    HRESULT (STDMETHODCALLTYPE *QueryInterface)(
        IWineD3DVertexBuffer* This,
        REFIID riid,
        void **ppvObject);
...
interface IWineD3DVertexBuffer {
    CONST_VTBL IWineD3DVertexBufferVtbl* lpVtbl;
};

#ifdef COBJMACROS
/*** IUnknown methods ***/
#define IWineD3DVertexBuffer_QueryInterface(This,riid,ppvObject) (This)->lpVtbl->QueryInterface(This,riid,ppvObject)
#define IWineD3DVertexBuffer_AddRef(This) (This)->lpVtbl->AddRef(This)
#define IWineD3DVertexBuffer_Release(This) (This)->lpVtbl->Release(This)
/*** IWineD3DBase methods ***/
#define IWineD3DVertexBuffer_GetParent(This,parent) (This)->lpVtbl->GetParent(This,parent)
/*** IWineD3DResource methods ***/
#define IWineD3DVertexBuffer_GetDevice(This,device) (This)->lpVtbl->GetDevice(This,device)
#define IWineD3DVertexBuffer_SetPrivateData(This,guid,data,data_size,flags) (This)->lpVtbl->SetPrivateData(This,guid,data,data_size,flags)
#define IWineD3DVertexBuffer_GetPrivateData(This,guid,data,data_size) (This)->lpVtbl->GetPrivateData(This,guid,data,data_size)
#define IWineD3DVertexBuffer_FreePrivateData(This,guid) (This)->lpVtbl->FreePrivateData(This,guid)
#define IWineD3DVertexBuffer_SetPriority(This,new_priority) (This)->lpVtbl->SetPriority(This,new_priority)
#define IWineD3DVertexBuffer_GetPriority(This) (This)->lpVtbl->GetPriority(This)
#define IWineD3DVertexBuffer_PreLoad(This) (This)->lpVtbl->PreLoad(This)
#define IWineD3DVertexBuffer_UnLoad(This) (This)->lpVtbl->UnLoad(This)
#define IWineD3DVertexBuffer_GetType(This) (This)->lpVtbl->GetType(This)
/*** IWineD3DVertexBuffer methods ***/
#define IWineD3DVertexBuffer_Lock(This,offset,size,data,flags) (This)->lpVtbl->Lock(This,offset,size,data,flags)
#define IWineD3DVertexBuffer_Unlock(This) (This)->lpVtbl->Unlock(This)
#define IWineD3DVertexBuffer_GetDesc(This,desc) (This)->lpVtbl->GetDesc(This,desc)
#endif

#endif

HRESULT STDMETHODCALLTYPE IWineD3DVertexBuffer_Lock_Proxy(
    IWineD3DVertexBuffer* This,
    UINT offset,
    UINT size,
    BYTE **data,
    DWORD flags);
void __RPC_STUB IWineD3DVertexBuffer_Lock_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IWineD3DVertexBuffer_Unlock_Proxy(
    IWineD3DVertexBuffer* This);
void __RPC_STUB IWineD3DVertexBuffer_Unlock_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IWineD3DVertexBuffer_GetDesc_Proxy(
    IWineD3DVertexBuffer* This,
    WINED3DVERTEXBUFFER_DESC *desc);
void __RPC_STUB IWineD3DVertexBuffer_GetDesc_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);

#endif  /* __IWineD3DVertexBuffer_INTERFACE_DEFINED__ */

#ifndef __IWineD3DIndexBuffer_FWD_DEFINED__
#define __IWineD3DIndexBuffer_FWD_DEFINED__
typedef interface IWineD3DIndexBuffer IWineD3DIndexBuffer;
#endif

/*****************************************************************************
 * IWineD3DIndexBuffer interface
 */
#ifndef __IWineD3DIndexBuffer_INTERFACE_DEFINED__
#define __IWineD3DIndexBuffer_INTERFACE_DEFINED__

DEFINE_GUID(IID_IWineD3DIndexBuffer, 0x3a02a54e, 0x6f30, 0x11d9, 0xc6,0x87, 0x00,0x04,0x61,0x42,0xc1,0x4f);
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IWineD3DIndexBuffer : public IWineD3DResource
{
    virtual HRESULT STDMETHODCALLTYPE Lock(
        UINT offset,
        UINT size,
    ...
    virtual HRESULT STDMETHODCALLTYPE GetDesc(
        WINED3DINDEXBUFFER_DESC *desc) = 0;

};
#else
typedef struct IWineD3DIndexBufferVtbl {
    BEGIN_INTERFACE

    /*** IUnknown methods ***/
    HRESULT (STDMETHODCALLTYPE *QueryInterface)(
        IWineD3DIndexBuffer* This,
        REFIID riid,
        void **ppvObject);
    ...
    HRESULT (STDMETHODCALLTYPE *GetDesc)(
        IWineD3DIndexBuffer* This,
        WINED3DINDEXBUFFER_DESC *desc);

    END_INTERFACE
} IWineD3DIndexBufferVtbl;
interface IWineD3DIndexBuffer {
    CONST_VTBL IWineD3DIndexBufferVtbl* lpVtbl;
};

#ifdef COBJMACROS
/*** IUnknown methods ***/
#define IWineD3DIndexBuffer_QueryInterface(This,riid,ppvObject) (This)->lpVtbl->QueryInterface(This,riid,ppvObject)
#define IWineD3DIndexBuffer_AddRef(This) (This)->lpVtbl->AddRef(This)
#define IWineD3DIndexBuffer_Release(This) (This)->lpVtbl->Release(This)
/*** IWineD3DBase methods ***/
#define IWineD3DIndexBuffer_GetParent(This,parent) (This)->lpVtbl->GetParent(This,parent)
/*** IWineD3DResource methods ***/
#define IWineD3DIndexBuffer_GetDevice(This,device) (This)->lpVtbl->GetDevice(This,device)
#define IWineD3DIndexBuffer_SetPrivateData(This,guid,data,data_size,flags) (This)->lpVtbl->SetPrivateData(This,guid,data,data_size,flags)
#define IWineD3DIndexBuffer_GetPrivateData(This,guid,data,data_size) (This)->lpVtbl->GetPrivateData(This,guid,data,data_size)
#define IWineD3DIndexBuffer_FreePrivateData(This,guid) (This)->lpVtbl->FreePrivateData(This,guid)
#define IWineD3DIndexBuffer_SetPriority(This,new_priority) (This)->lpVtbl->SetPriority(This,new_priority)
#define IWineD3DIndexBuffer_GetPriority(This) (This)->lpVtbl->GetPriority(This)
#define IWineD3DIndexBuffer_PreLoad(This) (This)->lpVtbl->PreLoad(This)
#define IWineD3DIndexBuffer_UnLoad(This) (This)->lpVtbl->UnLoad(This)
#define IWineD3DIndexBuffer_GetType(This) (This)->lpVtbl->GetType(This)
/*** IWineD3DIndexBuffer methods ***/
#define IWineD3DIndexBuffer_Lock(This,offset,size,data,flags) (This)->lpVtbl->Lock(This,offset,size,data,flags)
#define IWineD3DIndexBuffer_Unlock(This) (This)->lpVtbl->Unlock(This)
#define IWineD3DIndexBuffer_GetDesc(This,desc) (This)->lpVtbl->GetDesc(This,desc)
#endif

#endif

HRESULT STDMETHODCALLTYPE IWineD3DIndexBuffer_Lock_Proxy(
    IWineD3DIndexBuffer* This,
    UINT offset,
    UINT size,
    BYTE **data,
    DWORD flags);
void __RPC_STUB IWineD3DIndexBuffer_Lock_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IWineD3DIndexBuffer_Unlock_Proxy(
    IWineD3DIndexBuffer* This);
void __RPC_STUB IWineD3DIndexBuffer_Unlock_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IWineD3DIndexBuffer_GetDesc_Proxy(
    IWineD3DIndexBuffer* This,
    WINED3DINDEXBUFFER_DESC *desc);
void __RPC_STUB IWineD3DIndexBuffer_GetDesc_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);

#endif  /* __IWineD3DIndexBuffer_INTERFACE_DEFINED__ */
...
interface IWineD3DSurface : public IWineD3DResource
{
    ...
    virtual void STDMETHODCALLTYPE GetGlDesc(
        glDescriptor **desc) = 0;
...
typedef struct IWineD3DSurfaceVtbl {
    ...
    void (STDMETHODCALLTYPE *GetGlDesc)(
        IWineD3DSurface* This,
        glDescriptor **desc);
...
/*** IWineD3DResource methods ***/
#define IWineD3DSurface_GetDevice(This,device) (This)->lpVtbl->GetDevice(This,device)
...
#define IWineD3DSurface_AddDirtyRect(This,dirty_rect) (This)->lpVtbl->AddDirtyRect(This,dirty_rect)
#define IWineD3DSurface_LoadTexture(This,srgb_mode) (This)->lpVtbl->LoadTexture(This,srgb_mode)
#define IWineD3DSurface_BindTexture(This) (This)->lpVtbl->BindTexture(This)
...
#define IWineD3DSurface_GetGlDesc(This,desc) (This)->lpVtbl->GetGlDesc(This,desc)
...
void __RPC_STUB IWineD3DSurface_GetClipper_Stub(
    ...
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IWineD3DSurface_AddDirtyRect_Proxy(
    IWineD3DSurface* This,
    const RECT *dirty_rect);
void __RPC_STUB IWineD3DSurface_AddDirtyRect_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
...
void __RPC_STUB IWineD3DSurface_SetContainer_Stub(
    ...
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
void STDMETHODCALLTYPE IWineD3DSurface_GetGlDesc_Proxy(
    IWineD3DSurface* This,
    glDescriptor **desc);
void __RPC_STUB IWineD3DSurface_GetGlDesc_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
...
interface IWineD3DVolume : public IWineD3DResource
{
    ...
    virtual HRESULT STDMETHODCALLTYPE CleanDirtyBox(
        ) = 0;
...
typedef struct IWineD3DVolumeVtbl {
    ...
    HRESULT (STDMETHODCALLTYPE *CleanDirtyBox)(
        IWineD3DVolume* This);
...
/*** IWineD3DResource methods ***/
#define IWineD3DVolume_GetDevice(This,device) (This)->lpVtbl->GetDevice(This,device)
...
#define IWineD3DVolume_AddDirtyBox(This,dirty_box) (This)->lpVtbl->AddDirtyBox(This,dirty_box)
#define IWineD3DVolume_CleanDirtyBox(This) (This)->lpVtbl->CleanDirtyBox(This)
...
void __RPC_STUB IWineD3DVolume_UnlockBox_Stub(
    ...
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IWineD3DVolume_AddDirtyBox_Proxy(
    IWineD3DVolume* This,
    const WINED3DBOX *dirty_box);
void __RPC_STUB IWineD3DVolume_AddDirtyBox_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IWineD3DVolume_CleanDirtyBox_Proxy(
    IWineD3DVolume* This);
void __RPC_STUB IWineD3DVolume_CleanDirtyBox_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
...
interface IWineD3DBaseTexture : public IWineD3DResource
{
    ...
    virtual void STDMETHODCALLTYPE ApplyStateChanges(
        const DWORD texture_states[33],
        const DWORD sampler_states[14]) = 0;
...
typedef struct IWineD3DBaseTextureVtbl {
    ...
    void (STDMETHODCALLTYPE *ApplyStateChanges)(
        IWineD3DBaseTexture* This,
        const DWORD texture_states[33],
        const DWORD sampler_states[14]);
...
/*** IWineD3DResource methods ***/
#define IWineD3DBaseTexture_GetDevice(This,device) (This)->lpVtbl->GetDevice(This,device)
...
#define IWineD3DBaseTexture_BindTexture(This) (This)->lpVtbl->BindTexture(This)
...
#define IWineD3DBaseTexture_ApplyStateChanges(This,texture_states,sampler_states) (This)->lpVtbl->ApplyStateChanges(This,texture_states,sampler_states)
#endif
...
void __RPC_STUB IWineD3DBaseTexture_IsCondNP2_Stub(
    ...
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
void STDMETHODCALLTYPE IWineD3DBaseTexture_ApplyStateChanges_Proxy(
    IWineD3DBaseTexture* This,
    const DWORD texture_states[33],
    const DWORD sampler_states[14]);
void __RPC_STUB IWineD3DBaseTexture_ApplyStateChanges_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
...
/*** IWineD3DResource methods ***/
#define IWineD3DTexture_GetDevice(This,device) (This)->lpVtbl->GetDevice(This,device)
...
#define IWineD3DTexture_BindTexture(This) (This)->lpVtbl->BindTexture(This)
...
#define IWineD3DTexture_ApplyStateChanges(This,texture_states,sampler_states) (This)->lpVtbl->ApplyStateChanges(This,texture_states,sampler_states)
/*** IWineD3DTexture methods ***/
...
/*** IWineD3DResource methods ***/
#define IWineD3DCubeTexture_GetDevice(This,device) (This)->lpVtbl->GetDevice(This,device)
...
#define IWineD3DCubeTexture_BindTexture(This) (This)->lpVtbl->BindTexture(This)
...
#define IWineD3DCubeTexture_ApplyStateChanges(This,texture_states,sampler_states) (This)->lpVtbl->ApplyStateChanges(This,texture_states,sampler_states)
/*** IWineD3DCubeTexture methods ***/
...
/*** IWineD3DResource methods ***/
#define IWineD3DVolumeTexture_GetDevice(This,device) (This)->lpVtbl->GetDevice(This,device)
...
#define IWineD3DVolumeTexture_BindTexture(This) (This)->lpVtbl->BindTexture(This)
...
#define IWineD3DVolumeTexture_ApplyStateChanges(This,texture_states,sampler_states) (This)->lpVtbl->ApplyStateChanges(This,texture_states,sampler_states)
/*** IWineD3DVolumeTexture methods ***/
...
interface IWineD3DVertexDeclaration : public IWineD3DBase
{
    ...
    virtual HRESULT STDMETHODCALLTYPE SetDeclaration(
...
typedef struct IWineD3DVertexDeclarationVtbl {
    ...
    HRESULT (STDMETHODCALLTYPE *SetDeclaration)(
        IWineD3DVertexDeclaration* This,
        const WINED3DVERTEXELEMENT *elements,
        UINT element_count);
...
/*** IWineD3DVertexDeclaration methods ***/
#define IWineD3DVertexDeclaration_GetDevice(This,device) (This)->lpVtbl->GetDevice(This,device)
#define IWineD3DVertexDeclaration_GetDeclaration(This,elements,element_count) (This)->lpVtbl->GetDeclaration(This,elements,element_count)
#define IWineD3DVertexDeclaration_SetDeclaration(This,elements,element_count) (This)->lpVtbl->SetDeclaration(This,elements,element_count)
#endif

#endif

HRESULT STDMETHODCALLTYPE IWineD3DVertexDeclaration_GetDevice_Proxy(
    IWineD3DVertexDeclaration* This,
    IWineD3DDevice **device);
void __RPC_STUB IWineD3DVertexDeclaration_GetDevice_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IWineD3DVertexDeclaration_GetDeclaration_Proxy(
    IWineD3DVertexDeclaration* This,
    WINED3DVERTEXELEMENT *elements,
    UINT *element_count);
void __RPC_STUB IWineD3DVertexDeclaration_GetDeclaration_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IWineD3DVertexDeclaration_SetDeclaration_Proxy(
    IWineD3DVertexDeclaration* This,
    const WINED3DVERTEXELEMENT *elements,
    UINT element_count);
void __RPC_STUB IWineD3DVertexDeclaration_SetDeclaration_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
...
#if defined(__cplusplus) && !defined(CINTERFACE)
interface IWineD3DStateBlock : public IWineD3DBase
{
    virtual HRESULT STDMETHODCALLTYPE GetDevice(
        IWineD3DDevice **device) = 0;
...
/*** IWineD3DBase methods ***/
#define IWineD3DStateBlock_GetParent(This,parent) (This)->lpVtbl->GetParent(This,parent)
/*** IWineD3DStateBlock methods ***/
#define IWineD3DStateBlock_GetDevice(This,device) (This)->lpVtbl->GetDevice(This,device)
...
HRESULT STDMETHODCALLTYPE IWineD3DStateBlock_GetDevice_Proxy(
    IWineD3DStateBlock* This,
    IWineD3DDevice **device);
void __RPC_STUB IWineD3DStateBlock_GetDevice_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
...
/*** IWineD3DQuery methods ***/
#define IWineD3DQuery_GetDevice(This,device) (This)->lpVtbl->GetDevice(This,device)
...
HRESULT STDMETHODCALLTYPE IWineD3DQuery_GetDevice_Proxy(
    IWineD3DQuery* This,
    IWineD3DDevice **device);
void __RPC_STUB IWineD3DQuery_GetDevice_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
...
/*** IWineD3DBaseShader methods ***/
#define IWineD3DBaseShader_SetFunction(This,function) (This)->lpVtbl->SetFunction(This,function)
#endif
...
interface IWineD3DVertexShader : public IWineD3DBaseShader
{
    ...
    virtual void STDMETHODCALLTYPE FakeSemantics(
        IWineD3DVertexDeclaration *vertex_declaration) = 0;
...
typedef struct IWineD3DVertexShaderVtbl {
    ...
    void (STDMETHODCALLTYPE *FakeSemantics)(
        IWineD3DVertexShader* This,
        IWineD3DVertexDeclaration *vertex_declaration);
...
/*** IWineD3DBaseShader methods ***/
#define IWineD3DVertexShader_SetFunction(This,function) (This)->lpVtbl->SetFunction(This,function)
/*** IWineD3DVertexShader methods ***/
...
#define IWineD3DVertexShader_FakeSemantics(This,vertex_declaration) (This)->lpVtbl->FakeSemantics(This,vertex_declaration)
...
void __RPC_STUB IWineD3DVertexShader_GetFunction_Stub(
    ...
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
void STDMETHODCALLTYPE IWineD3DVertexShader_FakeSemantics_Proxy(
    IWineD3DVertexShader* This,
    IWineD3DVertexDeclaration *vertex_declaration);
void __RPC_STUB IWineD3DVertexShader_FakeSemantics_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
...
{
    virtual HRESULT STDMETHODCALLTYPE UpdateSamplers(
        ) = 0;
...
typedef struct IWineD3DPixelShaderVtbl {
    ...
    HRESULT (STDMETHODCALLTYPE *UpdateSamplers)(
        IWineD3DPixelShader* This);
...
/*** IWineD3DBaseShader methods ***/
#define IWineD3DPixelShader_SetFunction(This,function) (This)->lpVtbl->SetFunction(This,function)
/*** IWineD3DPixelShader methods ***/
#define IWineD3DPixelShader_UpdateSamplers(This) (This)->lpVtbl->UpdateSamplers(This)
...
HRESULT STDMETHODCALLTYPE IWineD3DPixelShader_UpdateSamplers_Proxy(
    IWineD3DPixelShader* This);
void __RPC_STUB IWineD3DPixelShader_UpdateSamplers_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
...
interface IWineD3DDevice : public IWineD3DBase
{
    virtual HRESULT STDMETHODCALLTYPE CreateVertexBuffer(
        ...
        DWORD fvf,
        WINED3DPOOL pool,
        IWineD3DVertexBuffer **vertex_buffer,
    ...
    virtual HRESULT STDMETHODCALLTYPE CreateIndexBuffer(
        ...
        WINED3DFORMAT format,
        WINED3DPOOL pool,
        IWineD3DIndexBuffer **index_buffer,
        HANDLE *shared_handle,
        IUnknown *parent) = 0;
    ...
    virtual HRESULT STDMETHODCALLTYPE CreateTexture(
        ...
        HANDLE *shared_handle,
        IUnknown *parent,
        HRESULT (STDMETHODCALLTYPE * create_surface_callback)(IUnknown *pDevice,IUnknown *pSuperior,UINT Width,UINT Height,WINED3DFORMAT Format,DWORD Usage,WINED3DPOOL Pool,UINT Level,WINED3DCUBEMAP_FACES Face,IWineD3DSurface **ppSurface,HANDLE *pSharedHandle)) = 0;
    ...
    virtual HRESULT STDMETHODCALLTYPE CreateVolumeTexture(
        ...
        HANDLE *shared_handle,
        IUnknown *parent,
        HRESULT (STDMETHODCALLTYPE * create_volume_callback)(IUnknown *pDevice,IUnknown *pSuperior,UINT Width,UINT Height,UINT Depth,WINED3DFORMAT Format,WINED3DPOOL Pool,DWORD Usage,IWineD3DVolume **ppVolume,HANDLE *pSharedHandle)) = 0;
    ...
    virtual HRESULT STDMETHODCALLTYPE CreateSwapChain(
        ...
        IUnknown *parent,
        HRESULT (STDMETHODCALLTYPE * create_render_target_callback)(IUnknown *pDevice,IUnknown *pSuperior,UINT Width,UINT Height,WINED3DFORMAT Format,WINED3DMULTISAMPLE_TYPE MultiSample,DWORD MultisampleQuality,BOOL Lockable,IWineD3DSurface **ppSurface,HANDLE *pSharedHandle),
        HRESULT (STDMETHODCALLTYPE * create_depth_stencil_callback)(IUnknown *pDevice,IUnknown *pSuperior,UINT Width,UINT Height,WINED3DFORMAT Format,WINED3DMULTISAMPLE_TYPE MultiSample,DWORD MultisampleQuality,BOOL Discard,IWineD3DSurface **ppSurface,HANDLE *pSharedHandle),
        WINED3DSURFTYPE surface_type) = 0;
    ...
    virtual HRESULT STDMETHODCALLTYPE Init3D(
        WINED3DPRESENT_PARAMETERS *present_parameters,
        HRESULT (STDMETHODCALLTYPE * create_swapchain_callback)(IUnknown *pDevice,WINED3DPRESENT_PARAMETERS *pPresentationParameters,IWineD3DSwapChain **pSwapChain)) = 0;
    ...
    virtual HRESULT STDMETHODCALLTYPE SetFVF(
        DWORD fvf) = 0;

    virtual HRESULT STDMETHODCALLTYPE GetFVF(
        DWORD *fvf) = 0;
    ...
    virtual HRESULT STDMETHODCALLTYPE SetIndices(
        IWineD3DIndexBuffer *index_buffer) = 0;
    ...
    virtual HRESULT STDMETHODCALLTYPE ProcessVertices(
        ...
        UINT dst_idx,
        UINT vertex_count,
        IWineD3DVertexBuffer *dest_buffer,
        IWineD3DVertexDeclaration *declaration,
        DWORD flags) = 0;
    ...
    virtual void STDMETHODCALLTYPE ResourceReleased(
...
typedef struct IWineD3DDeviceVtbl {
    ...
    HRESULT (STDMETHODCALLTYPE *CreateTexture)(
        ...
        HANDLE *shared_handle,
        IUnknown *parent,
        HRESULT (STDMETHODCALLTYPE * create_surface_callback)(IUnknown *pDevice,IUnknown *pSuperior,UINT Width,UINT Height,WINED3DFORMAT Format,DWORD Usage,WINED3DPOOL Pool,UINT Level,WINED3DCUBEMAP_FACES Face,IWineD3DSurface **ppSurface,HANDLE *pSharedHandle));
    ...
    HRESULT (STDMETHODCALLTYPE *CreateVolumeTexture)(
        ...
        HANDLE *shared_handle,
        IUnknown *parent,
        HRESULT (STDMETHODCALLTYPE * create_volume_callback)(IUnknown *pDevice,IUnknown *pSuperior,UINT Width,UINT Height,UINT Depth,WINED3DFORMAT Format,WINED3DPOOL Pool,DWORD Usage,IWineD3DVolume **ppVolume,HANDLE *pSharedHandle));
    ...
    HRESULT (STDMETHODCALLTYPE *Init3D)(
        IWineD3DDevice* This,
        WINED3DPRESENT_PARAMETERS *present_parameters,
        HRESULT (STDMETHODCALLTYPE * create_swapchain_callback)(IUnknown *pDevice,WINED3DPRESENT_PARAMETERS *pPresentationParameters,IWineD3DSwapChain **pSwapChain));
    ...
    void (STDMETHODCALLTYPE *ResourceReleased)(
        IWineD3DDevice* This,
...
/*** IWineD3DDevice methods ***/
#define IWineD3DDevice_CreateVertexBuffer(This,length,usage,fvf,pool,vertex_buffer,shared_handle,parent) (This)->lpVtbl->CreateVertexBuffer(This,length,usage,fvf,pool,vertex_buffer,shared_handle,parent)
#define IWineD3DDevice_CreateIndexBuffer(This,length,usage,format,pool,index_buffer,shared_handle,parent) (This)->lpVtbl->CreateIndexBuffer(This,length,usage,format,pool,index_buffer,shared_handle,parent)
...
#define IWineD3DDevice_CreateSurface(This,width,height,format,lockable,discard,level,surface,resource_type,usage,pool,multisample_type,multisample_quality,shared_handle,surface_type,parent) (This)->lpVtbl->CreateSurface(This,width,height,format,lockable,discard,level,surface,resource_type,usage,pool,multisample_type,multisample_quality,shared_handle,surface_type,parent)
#define IWineD3DDevice_CreateTexture(This,width,height,levels,usage,format,pool,texture,shared_handle,parent,create_surface_callback) (This)->lpVtbl->CreateTexture(This,width,height,levels,usage,format,pool,texture,shared_handle,parent,create_surface_callback)
#define IWineD3DDevice_CreateVolumeTexture(This,width,height,depth,levels,usage,format,pool,texture,shared_handle,parent,create_volume_callback) (This)->lpVtbl->CreateVolumeTexture(This,width,height,depth,levels,usage,format,pool,texture,shared_handle,parent,create_volume_callback)
#define IWineD3DDevice_CreateVolume(This,width,height,depth,usage,format,pool,volume,shared_handle,parent) (This)->lpVtbl->CreateVolume(This,width,height,depth,usage,format,pool,volume,shared_handle,parent)
#define IWineD3DDevice_CreateCubeTexture(This,edge_length,levels,usage,format,pool,texture,shared_handle,parent,create_surface_callback) (This)->lpVtbl->CreateCubeTexture(This,edge_length,levels,usage,format,pool,texture,shared_handle,parent,create_surface_callback)
#define IWineD3DDevice_CreateQuery(This,type,query,parent) (This)->lpVtbl->CreateQuery(This,type,query,parent)
#define IWineD3DDevice_CreateSwapChain(This,present_parameters,swapchain,parent,create_render_target_callback,create_depth_stencil_callback,surface_type) (This)->lpVtbl->CreateSwapChain(This,present_parameters,swapchain,parent,create_render_target_callback,create_depth_stencil_callback,surface_type)
...
#define IWineD3DDevice_CreateVertexShader(This,declaration,function,shader,parent) (This)->lpVtbl->CreateVertexShader(This,declaration,function,shader,parent)
#define IWineD3DDevice_CreatePixelShader(This,function,shader,parent) (This)->lpVtbl->CreatePixelShader(This,function,shader,parent)
...
#define IWineD3DDevice_Init3D(This,present_parameters,create_swapchain_callback) (This)->lpVtbl->Init3D(This,present_parameters,create_swapchain_callback)
#define IWineD3DDevice_InitGDI(This,present_parameters,create_swapchain_callback) (This)->lpVtbl->InitGDI(This,present_parameters,create_swapchain_callback)
...
#define IWineD3DDevice_TestCooperativeLevel(This) (This)->lpVtbl->TestCooperativeLevel(This)
...
#define IWineD3DDevice_SetFVF(This,fvf) (This)->lpVtbl->SetFVF(This,fvf)
#define IWineD3DDevice_GetFVF(This,fvf) (This)->lpVtbl->GetFVF(This,fvf)
...
#define IWineD3DDevice_SetIndices(This,index_buffer) (This)->lpVtbl->SetIndices(This,index_buffer)
...
#define IWineD3DDevice_SetRenderTarget(This,render_target_idx,render_target) (This)->lpVtbl->SetRenderTarget(This,render_target_idx,render_target)
...
#define IWineD3DDevice_SetStreamSource(This,stream_idx,vertex_buffer,offset,stride) (This)->lpVtbl->SetStreamSource(This,stream_idx,vertex_buffer,offset,stride)
#define IWineD3DDevice_GetStreamSource(This,stream_idx,vertex_buffer,offset,stride) (This)->lpVtbl->GetStreamSource(This,stream_idx,vertex_buffer,offset,stride)
...
#define IWineD3DDevice_ProcessVertices(This,src_start_idx,dst_idx,vertex_count,dest_buffer,declaration,flags) (This)->lpVtbl->ProcessVertices(This,src_start_idx,dst_idx,vertex_count,dest_buffer,declaration,flags)
...
#define IWineD3DDevice_DrawPrimitive(This,primitive_type,start_vertex,primitive_count) (This)->lpVtbl->DrawPrimitive(This,primitive_type,start_vertex,primitive_count)
#define IWineD3DDevice_DrawIndexedPrimitive(This,primitive_type,min_vertex_idx,vertex_count,start_idx,primitive_count) (This)->lpVtbl->DrawIndexedPrimitive(This,primitive_type,min_vertex_idx,vertex_count,start_idx,primitive_count)
#define IWineD3DDevice_DrawPrimitiveUP(This,primitive_type,primitive_count,stream_data,stream_stride) (This)->lpVtbl->DrawPrimitiveUP(This,primitive_type,primitive_count,stream_data,stream_stride)
#define IWineD3DDevice_DrawIndexedPrimitiveUP(This,primitive_type,min_vertex_idx,vertex_count,primitive_count,index_data,index_data_format,stream_data,stream_stride) (This)->lpVtbl->DrawIndexedPrimitiveUP(This,primitive_type,min_vertex_idx,vertex_count,primitive_count,index_data,index_data_format,stream_data,stream_stride)
#define IWineD3DDevice_DrawPrimitiveStrided(This,primitive_type,primitive_count,strided_data) (This)->lpVtbl->DrawPrimitiveStrided(This,primitive_type,primitive_count,strided_data)
#define IWineD3DDevice_DrawIndexedPrimitiveStrided(This,primitive_type,primitive_count,strided_data,vertex_count,index_data,index_data_format) (This)->lpVtbl->DrawIndexedPrimitiveStrided(This,primitive_type,primitive_count,strided_data,vertex_count,index_data,index_data_format)
...
#define IWineD3DDevice_ResourceReleased(This,resource) (This)->lpVtbl->ResourceReleased(This,resource)
...
void __RPC_STUB IWineD3DDevice_ShowCursor_Stub(
    ...
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IWineD3DDevice_TestCooperativeLevel_Proxy(
    IWineD3DDevice* This);
void __RPC_STUB IWineD3DDevice_TestCooperativeLevel_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
...
void __RPC_STUB IWineD3DDevice_GetDepthStencilSurface_Stub(
    ...
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IWineD3DDevice_SetFVF_Proxy(
    IWineD3DDevice* This,
    DWORD fvf);
void __RPC_STUB IWineD3DDevice_SetFVF_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IWineD3DDevice_GetFVF_Proxy(
    IWineD3DDevice* This,
    DWORD *fvf);
void __RPC_STUB IWineD3DDevice_GetFVF_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
...
void __RPC_STUB IWineD3DDevice_GetFrontBufferData_Stub(
    ...
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
void STDMETHODCALLTYPE IWineD3DDevice_ResourceReleased_Proxy(
    IWineD3DDevice* This,
    IWineD3DResource *resource);
void __RPC_STUB IWineD3DDevice_ResourceReleased_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
