/*** Autogenerated by WIDL 1.1.10 from ../../../dlls/wined3d/../../include/objidl.idl - Do not edit ***/
#include <rpc.h>
#include <rpcndr.h>
...
interface IContext : public IUnknown
{
    ...
    virtual HRESULT STDMETHODCALLTYPE RemovePropert(
        REFGUID policyId) = 0;
...
typedef struct IContextVtbl {
    ...
    HRESULT (STDMETHODCALLTYPE *RemovePropert)(
        IContext* This,
        REFGUID policyId);
...
#define IContext_RemovePropert(This,policyId) (This)->lpVtbl->RemovePropert(This,policyId)
...
void __RPC_STUB IContext_SetProperty_Stub(
    ...
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IContext_RemovePropert_Proxy(
    IContext* This,
    REFGUID policyId);
void __RPC_STUB IContext_RemovePropert_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
