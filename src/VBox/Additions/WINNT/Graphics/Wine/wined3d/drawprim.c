...
HRESULT tesselate_rectpatch(IWineD3DDeviceImpl *This,
     ...
     */
    num_quads = ceil(patch->numSegs[0]) * ceil(patch->numSegs[1]);
    ...
    glMapGrid2f(ceil(patch->numSegs[0]), 0.0, 1.0, ceil(patch->numSegs[1]), 0.0, 1.0);
    ...
    glEvalMesh2(GL_FILL, 0, ceil(patch->numSegs[0]), 0, ceil(patch->numSegs[1]));
