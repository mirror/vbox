...
#ifndef ___VBoxGuestR0LibInternal_h___
#define ___VBoxGuestR0LibInternal_h___
...
int VBOXCALL vbglR0IdcNativeCall(PVBGLIDCHANDLE pHandle, uintptr_t uReq, PVBGLREQHDR pReq);
RT_C_DECLS_END
