...
#define SUPEXP_STK_OKAY(a_cArgs, a_Name)        { #a_Name,              0,          (void *)(uintptr_t)a_Name }
#ifdef RT_OS_DARWIN
# define SUPEXP_STK_BACK(a_cArgs, a_Name)       { "StkBack_" #a_Name,   0,          (void *)(uintptr_t)a_Name }
#else
# define SUPEXP_STK_BACK(a_cArgs, a_Name)       { #a_Name,              0,          (void *)(uintptr_t)a_Name }
#endif
/** @} */
...
/* SED: START */
    ...
    SUPEXP_STK_BACK(22, SUPGetTscDeltaSlow),
    SUPEXP_STK_BACK(22, SUPGetCpuHzFromGipForAsyncMode),
    SUPEXP_STK_OKAY(0,  SUPIsTscFreqCompatible),
    SUPEXP_STK_OKAY(0,  SUPIsTscFreqCompatibleEx),
    SUPEXP_STK_BACK(22, SUPR0BadContext),
    SUPEXP_STK_BACK(22, SUPR0ComponentDeregisterFactory),
    SUPEXP_STK_BACK(22, SUPR0ComponentQueryFactory),
    SUPEXP_STK_BACK(22, SUPR0ComponentRegisterFactory),
    SUPEXP_STK_BACK(22, SUPR0ContAlloc),
    SUPEXP_STK_BACK(22, SUPR0ContFree),
    SUPEXP_STK_BACK(22, SUPR0ChangeCR4),
    SUPEXP_STK_BACK(22, SUPR0EnableVTx),
    SUPEXP_STK_BACK(22, SUPR0SuspendVTxOnCpu),
    SUPEXP_STK_BACK(22, SUPR0ResumeVTxOnCpu),
    SUPEXP_STK_OKAY(0,  SUPR0GetCurrentGdtRw),
    SUPEXP_STK_OKAY(0,  SUPR0GetKernelFeatures),
    SUPEXP_STK_BACK(22, SUPR0GetHwvirtMsrs),
    SUPEXP_STK_BACK(22, SUPR0GetPagingMode),
    SUPEXP_STK_BACK(22, SUPR0GetSvmUsability),
    SUPEXP_STK_BACK(22, SUPR0GetVTSupport),
    SUPEXP_STK_BACK(22, SUPR0GetVmxUsability),
    SUPEXP_STK_BACK(22, SUPR0LdrIsLockOwnerByMod),
    SUPEXP_STK_BACK(22, SUPR0LdrLock),
    SUPEXP_STK_BACK(22, SUPR0LdrUnlock),
    SUPEXP_STK_BACK(22, SUPR0LdrModByName),
    SUPEXP_STK_BACK(22, SUPR0LdrModRelease),
    SUPEXP_STK_BACK(22, SUPR0LdrModRetain),
    SUPEXP_STK_BACK(22, SUPR0LockMem),
    SUPEXP_STK_BACK(22, SUPR0LowAlloc),
    SUPEXP_STK_BACK(22, SUPR0LowFree),
    SUPEXP_STK_BACK(22, SUPR0MemAlloc),
    SUPEXP_STK_BACK(22, SUPR0MemFree),
    SUPEXP_STK_BACK(22, SUPR0MemGetPhys),
    SUPEXP_STK_BACK(22, SUPR0ObjAddRef),
    SUPEXP_STK_BACK(22, SUPR0ObjAddRefEx),
    SUPEXP_STK_BACK(22, SUPR0ObjRegister),
    SUPEXP_STK_BACK(22, SUPR0ObjRelease),
    SUPEXP_STK_BACK(22, SUPR0ObjVerifyAccess),
    SUPEXP_STK_BACK(22, SUPR0PageAllocEx),
    SUPEXP_STK_BACK(22, SUPR0PageFree),
    SUPEXP_STK_BACK(22, SUPR0PageMapKernel),
    SUPEXP_STK_BACK(22, SUPR0PageProtect),
#if defined(RT_OS_LINUX) || defined(RT_OS_SOLARIS) || defined(RT_OS_FREEBSD)
    SUPEXP_STK_OKAY(0,  SUPR0HCPhysToVirt),         /* only-linux, only-solaris, only-freebsd */
#endif
    SUPEXP_STK_BACK(22, SUPR0PrintfV),
    SUPEXP_STK_BACK(22, SUPR0GetSessionGVM),
    SUPEXP_STK_BACK(22, SUPR0GetSessionVM),
    SUPEXP_STK_BACK(22, SUPR0SetSessionVM),
    SUPEXP_STK_BACK(22, SUPR0TscDeltaMeasureBySetIndex),
    SUPEXP_STK_BACK(22, SUPR0TracerDeregisterDrv),
    SUPEXP_STK_BACK(22, SUPR0TracerDeregisterImpl),
    SUPEXP_STK_BACK(22, SUPR0TracerFireProbe),
    SUPEXP_STK_BACK(22, SUPR0TracerRegisterDrv),
    SUPEXP_STK_BACK(22, SUPR0TracerRegisterImpl),
    SUPEXP_STK_BACK(22, SUPR0TracerRegisterModule),
    SUPEXP_STK_BACK(22, SUPR0TracerUmodProbeFire),
    SUPEXP_STK_BACK(22, SUPR0UnlockMem),
#ifdef RT_OS_WINDOWS
    SUPEXP_STK_BACK(22, SUPR0IoCtlSetupForHandle),  /* only-windows */
    SUPEXP_STK_BACK(22, SUPR0IoCtlPerform),         /* only-windows */
    SUPEXP_STK_BACK(22, SUPR0IoCtlCleanup),         /* only-windows */
#endif
    SUPEXP_STK_BACK(22, SUPSemEventClose),
    SUPEXP_STK_BACK(22, SUPSemEventCreate),
    SUPEXP_STK_BACK(22, SUPSemEventGetResolution),
    SUPEXP_STK_BACK(22, SUPSemEventMultiClose),
    SUPEXP_STK_BACK(22, SUPSemEventMultiCreate),
    SUPEXP_STK_BACK(22, SUPSemEventMultiGetResolution),
    SUPEXP_STK_BACK(22, SUPSemEventMultiReset),
    SUPEXP_STK_BACK(22, SUPSemEventMultiSignal),
    SUPEXP_STK_BACK(22, SUPSemEventMultiWait),
    SUPEXP_STK_BACK(22, SUPSemEventMultiWaitNoResume),
    SUPEXP_STK_BACK(22, SUPSemEventMultiWaitNsAbsIntr),
    SUPEXP_STK_BACK(22, SUPSemEventMultiWaitNsRelIntr),
    SUPEXP_STK_BACK(22, SUPSemEventSignal),
    SUPEXP_STK_BACK(22, SUPSemEventWait),
    SUPEXP_STK_BACK(22, SUPSemEventWaitNoResume),
    SUPEXP_STK_BACK(22, SUPSemEventWaitNsAbsIntr),
    SUPEXP_STK_BACK(22, SUPSemEventWaitNsRelIntr),

    SUPEXP_STK_BACK(22, RTAssertAreQuiet),
    SUPEXP_STK_BACK(22, RTAssertMayPanic),
    SUPEXP_STK_BACK(22, RTAssertMsg1),
    SUPEXP_STK_BACK(22, RTAssertMsg2AddV),
    SUPEXP_STK_BACK(22, RTAssertMsg2V),
    SUPEXP_STK_BACK(22, RTAssertSetMayPanic),
    SUPEXP_STK_BACK(22, RTAssertSetQuiet),
    SUPEXP_STK_OKAY(0,  RTCrc32),
    SUPEXP_STK_OKAY(0,  RTCrc32Finish),
    SUPEXP_STK_OKAY(0,  RTCrc32Process),
    SUPEXP_STK_OKAY(0,  RTCrc32Start),
    SUPEXP_STK_OKAY(0,  RTErrConvertFromErrno),
    SUPEXP_STK_OKAY(0,  RTErrConvertToErrno),
    SUPEXP_STK_BACK(22, RTHandleTableAllocWithCtx),
    SUPEXP_STK_BACK(22, RTHandleTableCreate),
    SUPEXP_STK_BACK(22, RTHandleTableCreateEx),
    SUPEXP_STK_BACK(22, RTHandleTableDestroy),
    SUPEXP_STK_BACK(22, RTHandleTableFreeWithCtx),
    SUPEXP_STK_BACK(22, RTHandleTableLookupWithCtx),
    SUPEXP_STK_BACK(22, RTLogBulkUpdate),
    SUPEXP_STK_BACK(22, RTLogCheckGroupFlags),
    SUPEXP_STK_BACK(22, RTLogCreateExV),
    SUPEXP_STK_BACK(22, RTLogDestroy),
    SUPEXP_STK_BACK(22, RTLogDefaultInstance),
    SUPEXP_STK_BACK(22, RTLogDefaultInstanceEx),
    SUPEXP_STK_BACK(22, SUPR0DefaultLogInstanceEx),
    SUPEXP_STK_BACK(22, RTLogGetDefaultInstance),
    SUPEXP_STK_BACK(22, RTLogGetDefaultInstanceEx),
    SUPEXP_STK_BACK(22, SUPR0GetDefaultLogInstanceEx),
    SUPEXP_STK_BACK(22, RTLogLoggerExV),
    SUPEXP_STK_BACK(22, RTLogPrintfV),
    SUPEXP_STK_BACK(22, RTLogRelGetDefaultInstance),
    SUPEXP_STK_BACK(22, RTLogRelGetDefaultInstanceEx),
    SUPEXP_STK_BACK(22, SUPR0GetDefaultLogRelInstanceEx),
    SUPEXP_STK_BACK(22, RTLogSetDefaultInstanceThread),
    SUPEXP_STK_BACK(22, RTLogSetFlushCallback),
    SUPEXP_STK_BACK(22, RTLogSetR0ProgramStart),
    SUPEXP_STK_BACK(22, RTLogSetR0ThreadNameV),
    SUPEXP_STK_BACK(22, RTMemAllocExTag),
    SUPEXP_STK_BACK(22, RTMemAllocTag),
    SUPEXP_STK_BACK(22, RTMemAllocVarTag),
    SUPEXP_STK_BACK(22, RTMemAllocZTag),
    SUPEXP_STK_BACK(22, RTMemAllocZVarTag),
    SUPEXP_STK_BACK(22, RTMemDupExTag),
    SUPEXP_STK_BACK(22, RTMemDupTag),
    SUPEXP_STK_BACK(22, RTMemFree),
    SUPEXP_STK_BACK(22, RTMemFreeEx),
    SUPEXP_STK_BACK(22, RTMemReallocTag),
    SUPEXP_STK_BACK(22, RTMpCpuId),
    SUPEXP_STK_BACK(22, RTMpCpuIdFromSetIndex),
    SUPEXP_STK_BACK(22, RTMpCpuIdToSetIndex),
    SUPEXP_STK_BACK(22, RTMpCurSetIndex),
    SUPEXP_STK_BACK(22, RTMpCurSetIndexAndId),
    SUPEXP_STK_BACK(22, RTMpGetArraySize),
    SUPEXP_STK_BACK(22, RTMpGetCount),
    SUPEXP_STK_BACK(22, RTMpGetMaxCpuId),
    SUPEXP_STK_BACK(22, RTMpGetOnlineCount),
    SUPEXP_STK_BACK(22, RTMpGetOnlineSet),
    SUPEXP_STK_BACK(22, RTMpGetSet),
    SUPEXP_STK_BACK(22, RTMpIsCpuOnline),
    SUPEXP_STK_BACK(22, RTMpIsCpuPossible),
    SUPEXP_STK_BACK(22, RTMpIsCpuWorkPending),
    SUPEXP_STK_BACK(22, RTMpNotificationDeregister),
    SUPEXP_STK_BACK(22, RTMpNotificationRegister),
    SUPEXP_STK_BACK(22, RTMpOnAll),
    SUPEXP_STK_BACK(22, RTMpOnOthers),
    SUPEXP_STK_BACK(22, RTMpOnSpecific),
    SUPEXP_STK_BACK(22, RTMpPokeCpu),
    SUPEXP_STK_OKAY(0,  RTNetIPv4AddDataChecksum),
    SUPEXP_STK_OKAY(0,  RTNetIPv4AddTCPChecksum),
    SUPEXP_STK_OKAY(0,  RTNetIPv4AddUDPChecksum),
    SUPEXP_STK_OKAY(0,  RTNetIPv4FinalizeChecksum),
    SUPEXP_STK_OKAY(0,  RTNetIPv4HdrChecksum),
    SUPEXP_STK_OKAY(0,  RTNetIPv4IsDHCPValid),
    SUPEXP_STK_OKAY(0,  RTNetIPv4IsHdrValid),
    SUPEXP_STK_OKAY(0,  RTNetIPv4IsTCPSizeValid),
    SUPEXP_STK_OKAY(0,  RTNetIPv4IsTCPValid),
    SUPEXP_STK_OKAY(0,  RTNetIPv4IsUDPSizeValid),
    SUPEXP_STK_OKAY(0,  RTNetIPv4IsUDPValid),
    SUPEXP_STK_OKAY(0,  RTNetIPv4PseudoChecksum),
    SUPEXP_STK_OKAY(0,  RTNetIPv4PseudoChecksumBits),
    SUPEXP_STK_OKAY(0,  RTNetIPv4TCPChecksum),
    SUPEXP_STK_OKAY(0,  RTNetIPv4UDPChecksum),
    SUPEXP_STK_OKAY(0,  RTNetIPv6PseudoChecksum),
    SUPEXP_STK_OKAY(0,  RTNetIPv6PseudoChecksumBits),
    SUPEXP_STK_OKAY(0,  RTNetIPv6PseudoChecksumEx),
    SUPEXP_STK_OKAY(0,  RTNetTCPChecksum),
    SUPEXP_STK_OKAY(0,  RTNetUDPChecksum),
    SUPEXP_STK_BACK(22, RTPowerNotificationDeregister),
    SUPEXP_STK_BACK(22, RTPowerNotificationRegister),
    SUPEXP_STK_BACK(22, RTProcSelf),
    SUPEXP_STK_BACK(22, RTR0AssertPanicSystem),
#if defined(RT_OS_DARWIN) || defined(RT_OS_SOLARIS) || defined(RT_OS_WINDOWS)
    SUPEXP_STK_BACK(22, RTR0DbgKrnlInfoOpen),          /* only-darwin, only-solaris, only-windows */
    SUPEXP_STK_BACK(22, RTR0DbgKrnlInfoQueryMember),   /* only-darwin, only-solaris, only-windows */
# if defined(RT_OS_SOLARIS)
    SUPEXP_STK_BACK(22, RTR0DbgKrnlInfoQuerySize),     /* only-solaris */
# endif
    SUPEXP_STK_BACK(22, RTR0DbgKrnlInfoQuerySymbol),   /* only-darwin, only-solaris, only-windows */
    SUPEXP_STK_BACK(22, RTR0DbgKrnlInfoRelease),       /* only-darwin, only-solaris, only-windows */
    SUPEXP_STK_BACK(22, RTR0DbgKrnlInfoRetain),        /* only-darwin, only-solaris, only-windows */
#endif
    SUPEXP_STK_BACK(22, RTR0MemAreKrnlAndUsrDifferent),
    SUPEXP_STK_BACK(22, RTR0MemKernelIsValidAddr),
    SUPEXP_STK_BACK(22, RTR0MemKernelCopyFrom),
    SUPEXP_STK_BACK(22, RTR0MemKernelCopyTo),
    SUPEXP_STK_OKAY(0,  RTR0MemObjAddress),
    SUPEXP_STK_OKAY(0,  RTR0MemObjAddressR3),
    SUPEXP_STK_BACK(22, RTR0MemObjAllocContTag),
    SUPEXP_STK_BACK(22, RTR0MemObjAllocLargeTag),
    SUPEXP_STK_BACK(22, RTR0MemObjAllocLowTag),
    SUPEXP_STK_BACK(22, RTR0MemObjAllocPageTag),
    SUPEXP_STK_BACK(22, RTR0MemObjAllocPhysExTag),
    SUPEXP_STK_BACK(22, RTR0MemObjAllocPhysNCTag),
    SUPEXP_STK_BACK(22, RTR0MemObjAllocPhysTag),
    SUPEXP_STK_BACK(22, RTR0MemObjEnterPhysTag),
    SUPEXP_STK_BACK(22, RTR0MemObjFree),
    SUPEXP_STK_BACK(22, RTR0MemObjGetPagePhysAddr),
    SUPEXP_STK_OKAY(0,  RTR0MemObjIsMapping),
    SUPEXP_STK_BACK(22, RTR0MemObjLockUserTag),
    SUPEXP_STK_BACK(22, RTR0MemObjLockKernelTag),
    SUPEXP_STK_BACK(22, RTR0MemObjMapKernelExTag),
    SUPEXP_STK_BACK(22, RTR0MemObjMapKernelTag),
    SUPEXP_STK_BACK(22, RTR0MemObjMapUserTag),
    SUPEXP_STK_BACK(22, RTR0MemObjMapUserExTag),
    SUPEXP_STK_BACK(22, RTR0MemObjProtect),
    SUPEXP_STK_OKAY(0,  RTR0MemObjSize),
    SUPEXP_STK_BACK(22, RTR0MemUserCopyFrom),
    SUPEXP_STK_BACK(22, RTR0MemUserCopyTo),
    SUPEXP_STK_BACK(22, RTR0MemUserIsValidAddr),
    SUPEXP_STK_BACK(22, RTR0ProcHandleSelf),
    SUPEXP_STK_BACK(22, RTSemEventCreate),
    SUPEXP_STK_BACK(22, RTSemEventDestroy),
    SUPEXP_STK_BACK(22, RTSemEventGetResolution),
    SUPEXP_STK_BACK(22, RTSemEventIsSignalSafe),
    SUPEXP_STK_BACK(22, RTSemEventMultiCreate),
    SUPEXP_STK_BACK(22, RTSemEventMultiDestroy),
    SUPEXP_STK_BACK(22, RTSemEventMultiGetResolution),
    SUPEXP_STK_BACK(22, RTSemEventMultiIsSignalSafe),
    SUPEXP_STK_BACK(22, RTSemEventMultiReset),
    SUPEXP_STK_BACK(22, RTSemEventMultiSignal),
    SUPEXP_STK_BACK(22, RTSemEventMultiWait),
    SUPEXP_STK_BACK(22, RTSemEventMultiWaitEx),
    SUPEXP_STK_BACK(22, RTSemEventMultiWaitExDebug),
    SUPEXP_STK_BACK(22, RTSemEventMultiWaitNoResume),
    SUPEXP_STK_BACK(22, RTSemEventSignal),
    SUPEXP_STK_BACK(22, RTSemEventWait),
    SUPEXP_STK_BACK(22, RTSemEventWaitEx),
    SUPEXP_STK_BACK(22, RTSemEventWaitExDebug),
    SUPEXP_STK_BACK(22, RTSemEventWaitNoResume),
    SUPEXP_STK_BACK(22, RTSemFastMutexCreate),
    SUPEXP_STK_BACK(22, RTSemFastMutexDestroy),
    SUPEXP_STK_BACK(22, RTSemFastMutexRelease),
    SUPEXP_STK_BACK(22, RTSemFastMutexRequest),
    SUPEXP_STK_BACK(22, RTSemMutexCreate),
    SUPEXP_STK_BACK(22, RTSemMutexDestroy),
    SUPEXP_STK_BACK(22, RTSemMutexRelease),
    SUPEXP_STK_BACK(22, RTSemMutexRequest),
    SUPEXP_STK_BACK(22, RTSemMutexRequestDebug),
    SUPEXP_STK_BACK(22, RTSemMutexRequestNoResume),
    SUPEXP_STK_BACK(22, RTSemMutexRequestNoResumeDebug),
    SUPEXP_STK_BACK(22, RTSpinlockAcquire),
    SUPEXP_STK_BACK(22, RTSpinlockCreate),
    SUPEXP_STK_BACK(22, RTSpinlockDestroy),
    SUPEXP_STK_BACK(22, RTSpinlockRelease),
    SUPEXP_STK_OKAY(0,  RTStrCopy),
    SUPEXP_STK_BACK(22, RTStrDupTag),
    SUPEXP_STK_BACK(22, RTStrFormatNumber),
    SUPEXP_STK_BACK(22, RTStrFormatTypeDeregister),
    SUPEXP_STK_BACK(22, RTStrFormatTypeRegister),
    SUPEXP_STK_BACK(22, RTStrFormatTypeSetUser),
    SUPEXP_STK_BACK(22, RTStrFormatV),
    SUPEXP_STK_BACK(22, RTStrFree),
    SUPEXP_STK_OKAY(0,  RTStrNCmp),
    SUPEXP_STK_BACK(22, RTStrPrintfExV),
    SUPEXP_STK_BACK(22, RTStrPrintfV),
    SUPEXP_STK_BACK(22, RTStrPrintf2ExV),
    SUPEXP_STK_BACK(22, RTStrPrintf2V),
    SUPEXP_STK_BACK(22, RTThreadCreate),
    SUPEXP_STK_BACK(22, RTThreadCtxHookIsEnabled),
    SUPEXP_STK_BACK(22, RTThreadCtxHookCreate),
    SUPEXP_STK_BACK(22, RTThreadCtxHookDestroy),
    SUPEXP_STK_BACK(22, RTThreadCtxHookDisable),
    SUPEXP_STK_BACK(22, RTThreadCtxHookEnable),
    SUPEXP_STK_BACK(22, RTThreadGetName),
    SUPEXP_STK_BACK(22, RTThreadGetNative),
    SUPEXP_STK_BACK(22, RTThreadGetType),
    SUPEXP_STK_BACK(22, RTThreadIsInInterrupt),
    SUPEXP_STK_BACK(22, RTThreadNativeSelf),
    SUPEXP_STK_BACK(22, RTThreadPreemptDisable),
    SUPEXP_STK_BACK(22, RTThreadPreemptIsEnabled),
    SUPEXP_STK_BACK(22, RTThreadPreemptIsPending),
    SUPEXP_STK_BACK(22, RTThreadPreemptIsPendingTrusty),
    SUPEXP_STK_BACK(22, RTThreadPreemptIsPossible),
    SUPEXP_STK_BACK(22, RTThreadPreemptRestore),
    SUPEXP_STK_BACK(22, RTThreadQueryTerminationStatus),
    SUPEXP_STK_BACK(22, RTThreadSelf),
    SUPEXP_STK_BACK(22, RTThreadSelfName),
    SUPEXP_STK_BACK(22, RTThreadSleep),
    SUPEXP_STK_BACK(22, RTThreadUserReset),
    SUPEXP_STK_BACK(22, RTThreadUserSignal),
    SUPEXP_STK_BACK(22, RTThreadUserWait),
    SUPEXP_STK_BACK(22, RTThreadUserWaitNoResume),
    SUPEXP_STK_BACK(22, RTThreadWait),
    SUPEXP_STK_BACK(22, RTThreadWaitNoResume),
    SUPEXP_STK_BACK(22, RTThreadYield),
    SUPEXP_STK_BACK(22, RTTimeNow),
    SUPEXP_STK_BACK(22, RTTimerCanDoHighResolution),
    SUPEXP_STK_BACK(22, RTTimerChangeInterval),
    SUPEXP_STK_BACK(22, RTTimerCreate),
    SUPEXP_STK_BACK(22, RTTimerCreateEx),
    SUPEXP_STK_BACK(22, RTTimerDestroy),
    SUPEXP_STK_BACK(22, RTTimerGetSystemGranularity),
    SUPEXP_STK_BACK(22, RTTimerReleaseSystemGranularity),
    SUPEXP_STK_BACK(22, RTTimerRequestSystemGranularity),
    SUPEXP_STK_BACK(22, RTTimerStart),
    SUPEXP_STK_BACK(22, RTTimerStop),
    SUPEXP_STK_BACK(22, RTTimeSystemMilliTS),
    SUPEXP_STK_BACK(22, RTTimeSystemNanoTS),
    SUPEXP_STK_OKAY(0,  RTUuidCompare),
    SUPEXP_STK_OKAY(0,  RTUuidCompareStr),
    SUPEXP_STK_OKAY(0,  RTUuidFromStr),
/* SED: END */
};
