...
void InitAutoLockSystem()
{
    ...
    } aClasses[] =
    {
        ...
        { LOCKCLASS_MACHINELIST,      "6-MACHINELIST" },
        { LOCKCLASS_SNAPSHOTOBJECT,   "7-SNAPSHOTOBJECT" },
        { LOCKCLASS_OTHEROBJECT,      "8-OTHEROBJECT" },
        { LOCKCLASS_USBLIST,          "9-USBLIST" },
        { LOCKCLASS_PROGRESSLIST,     "10-PROGRESSLIST" },
        { LOCKCLASS_OBJECTSTATE,      "11-OBJECTSTATE" }
    };
