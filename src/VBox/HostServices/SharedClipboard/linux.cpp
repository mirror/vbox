 ...
 */
static int vboxClipboardUtf16GetWinSize(PRTUTF16 pu16Src, size_t cwSrc, size_t *pcwDest)
{
    size_t cwDest, i;
 ...
 */
static int vboxClipboardUtf16LinToWin(PRTUTF16 pu16Src, size_t cwSrc, PRTUTF16 pu16Dest,
                                      size_t cwDest)
{
    size_t i, j;
    LogFlowFunc(("pu16Src=%.*ls, cwSrc=%u\n", cwSrc, pu16Src, cwSrc));
 ...
 * @retval  pcwDest  The length of the destination string in 16 bit words
 */
static int vboxClipboardUtf16GetLinSize(PRTUTF16 pu16Src, size_t cwSrc, size_t *pcwDest)
{
    size_t cwDest;
                                        ...
                                        unsigned long *pcLenReturn, int *piFormatReturn)
{
    ...
    case CTEXT:
        return vboxClipboardConvertCText(atomTypeReturn, pValReturn, pcLenReturn,
                                         piFormatReturn);
    case LATIN1:
        return vboxClipboardConvertLatin1(atomTypeReturn, pValReturn, pcLenReturn,
                                          piFormatReturn);
    default:
