...
# else
/*
 * Our g++ for the linux.x86 is too old to allow passing an empty macro as an
 * argument for other macros throwing:
 *     error: invoking macro DECLARE_ASN1_ENCODE_FUNCTIONS_attr argument 1:
 *     empty macro arguments are undefined in ISO C90 and ISO C++98
 * This definition works around this for now without doing any harm.
 * @bugref{10128}
 */
#  ifdef VBOX
#   define OSSL_DEPRECATEDIN_3_0                extern
#   define OSSL_DEPRECATEDIN_3_0_FOR(msg)       extern
#  else
