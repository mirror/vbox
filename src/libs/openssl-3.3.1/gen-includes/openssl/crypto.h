...
# ifndef VBOX /* we have our own thread locking functions */
...
#  include <iprt/once.h>
typedef RTONCE CRYPTO_ONCE;
typedef RTTLS CRYPTO_THREAD_LOCAL;
typedef RTTHREAD CRYPTO_THREAD_ID;
#  define CRYPTO_ONCE_STATIC_INIT RTONCE_INITIALIZER
# endif /* VBOX */
