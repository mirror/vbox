...
#  define tsan_counter(ptr) (sizeof(*(ptr)) == 8 ? _InterlockedExchangeAdd64((__int64 volatile *)(ptr), 1) \
                                                 : _InterlockedExchangeAdd((long volatile *)(ptr), 1))
#  define tsan_decr(ptr) (sizeof(*(ptr)) == 8 ? _InterlockedExchangeAdd64((__int64 volatile *)(ptr), -1) \
                                                 : _InterlockedExchangeAdd((long volatile *)(ptr), -1))
# else
